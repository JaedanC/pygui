...
def accept_drag_drop_payload(type: str, flags: int=0):
...
#? custom_return_type = [Auto]
# @pyi.returns(Any)
def arrow_button(str_id: str, dir: int):
...
#? custom_return_type = [Auto]
# @pyi.returns(Any)
def begin_child_frame(id: int, size: tuple, flags: int=0):
...
#? custom_return_type = [Auto]
# @pyi.returns(Any)
def begin_child_id(id: int, size: tuple=(0, 0), border: Any=False, flags: int=0):
    """"""
...
#? custom_return_type = [Auto]
# @pyi.returns(None)
def columns(count: int=1, id: str=None, border: Any=True):
    """"""
...
#? custom_return_type = [Auto]
# @pyi.returns(Any)
def combo_str_arr(label: str, current_item: int, items_: Any, items_count: int, popup_max_height_in_items: int=-1):
    """"""
...
#? custom_return_type = [Auto]
# @pyi.returns(int)
def dock_space(id: int, size: tuple=(0, 0), flags: int=0, window_class: _ImGuiWindowClass=None):
    """"""
...
def find_viewport_by_id(id: int):
...
#? custom_return_type = [Auto]
# @pyi.returns(Any)
def list_box_str_arr(label: str, current_item: int, items_: Any, items_count: int, height_in_items: int=-1):
    """"""
...
#? custom_return_type = [Auto]
# @pyi.returns(None)
def open_popup_id(id: int, popup_flags: int=0):
...
#? custom_return_type = [Auto]
# @pyi.returns(None)
def plot_histogram_float_ptr(label: str, values_: float, values_count: int, values_offset: int=0, overlay_text: str=None, scale_min: float=FLT_MAX, scale_max: float=FLT_MAX, graph_size: tuple=(0, 0), stride: int=sizeof(float)):
    """"""
...
#? custom_return_type = [Auto]
# @pyi.returns(None)
def plot_lines_float_ptr(label: str, values_: float, values_count: int, values_offset: int=0, overlay_text: str=None, scale_min: float=FLT_MAX, scale_max: float=FLT_MAX, graph_size: tuple=(0, 0), stride: int=sizeof(float)):
    """"""
...
#? custom_return_type = [Auto]
# @pyi.returns(Any)
def set_drag_drop_payload(type: str, data: Any, sz: Any, cond: int=0):
...
cdef class _ImGuiPayload:
    ...
    #? custom_return_type = [Auto]
    # @pyi.returns(Any)
    def is_data_type(self: _ImGuiPayload, type: str):
        """"""
...
cdef class _ImGuiStoragePair:
    ...
    # @pyi.returns(_ImGuiStoragePair)
    @staticmethod
    def float(_key: int, _val_f: float):
        """"""
...
cdef class _ImVec4:
    ...
    # @pyi.returns(_ImVec4)
    @staticmethod
    def float(_x: float, _y: float, _z: float, _w: float):
        """"""
...
cdef class _ImColor:
    ...
    @staticmethod
    def float(r: float, g: float, b: float, a: float=1.0):
        """"""
    ...
    # @pyi.returns(_ImColor)
    @staticmethod
    def int(r: int, g: int, b: int, a: int=255):
        """"""
...
cdef class _ImDrawListSplitter:
    ...
    #? custom_return_type = [Auto]
    # @pyi.returns(None)
    def clear_(self: _ImDrawListSplitter):
...
cdef class _ImFontAtlas:
    ...
    #? custom_return_type = [Auto]
    # @pyi.returns(int)
    def add_custom_rect_font_glyph(self: _ImFontAtlas, font: _ImFont, id: int, width: int, height: int, advance_x: float, offset: tuple=(0, 0)):
        """"""
    ...
    #? custom_return_type = [Auto]
    # @pyi.returns(None)
    def set_tex_id(self: _ImFontAtlas, id: Any):
        """"""
...
cdef class _ImFontGlyphRangesBuilder:
    ...
    #? custom_return_type = [Auto]
    # @pyi.returns(None)
    def clear_(self: _ImFontGlyphRangesBuilder):
        """"""
...
cdef class _ImGuiIO:
    ...
    #? custom_return_type = [Auto]
    # @pyi.returns(None)
    def add_input_characters_utf8(self: _ImGuiIO, str: str):
    ...
    #? custom_return_type = [Auto]
    # @pyi.returns(None)
    def add_mouse_viewport_event(self: _ImGuiIO, id: int):
...
cdef class _ImGuiTextBuffer:
    ...
    #? custom_return_type = [Auto]
    # @pyi.returns(None)
    def append(self: _ImGuiTextBuffer, str: str, str_end: str=None):
        """"""
    ...
    #? custom_return_type = [Auto]
    # @pyi.returns(None)
    def clear_(self: _ImGuiTextBuffer):
        """"""
...
cdef class _ImGuiTextFilter:
    ...
    #? custom_return_type = [Auto]
    # @pyi.returns(None)
    def clear_(self: _ImGuiTextFilter):
        """"""
