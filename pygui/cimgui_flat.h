...
typedef enum{ImGuiActivateFlags_None,ImGuiActivateFlags_PreferInput,ImGuiActivateFlags_PreferTweak,ImGuiActivateFlags_TryToPreserveState,}ImGuiActivateFlags_;
typedef enum{ImGuiAxis_None,ImGuiAxis_X,ImGuiAxis_Y}ImGuiAxis;
...
typedef enum{ImGuiButtonFlags_PressedOnClick,ImGuiButtonFlags_PressedOnClickRelease,ImGuiButtonFlags_PressedOnClickReleaseAnywhere,ImGuiButtonFlags_PressedOnRelease,ImGuiButtonFlags_PressedOnDoubleClick,ImGuiButtonFlags_PressedOnDragDropHold,ImGuiButtonFlags_Repeat,ImGuiButtonFlags_FlattenChildren,ImGuiButtonFlags_AllowItemOverlap,ImGuiButtonFlags_DontClosePopups,ImGuiButtonFlags_AlignTextBaseLine,ImGuiButtonFlags_NoKeyModifiers,ImGuiButtonFlags_NoHoldingActiveId,ImGuiButtonFlags_NoNavFocus,ImGuiButtonFlags_NoHoveredOnFocus,ImGuiButtonFlags_NoSetKeyOwner,ImGuiButtonFlags_NoTestKeyOwner,ImGuiButtonFlags_PressedOnMask_,ImGuiButtonFlags_PressedOnDefault_,}ImGuiButtonFlagsPrivate_;
...
typedef enum{ImGuiComboFlags_CustomPreview,}ImGuiComboFlagsPrivate_;
...
typedef enum{ImGuiDataType_String,ImGuiDataType_Pointer,ImGuiDataType_ID,}ImGuiDataTypePrivate_;
typedef enum{ImGuiDebugLogFlags_None,ImGuiDebugLogFlags_EventActiveId,ImGuiDebugLogFlags_EventFocus,ImGuiDebugLogFlags_EventPopup,ImGuiDebugLogFlags_EventNav,ImGuiDebugLogFlags_EventClipper,ImGuiDebugLogFlags_EventIO,ImGuiDebugLogFlags_EventDocking,ImGuiDebugLogFlags_EventViewport,ImGuiDebugLogFlags_EventMask_,ImGuiDebugLogFlags_OutputToTTY,}ImGuiDebugLogFlags_;
typedef enum{ImGuiDir_None,ImGuiDir_Left,ImGuiDir_Right,ImGuiDir_Up,ImGuiDir_Down,ImGuiDir_COUNT}ImGuiDir_;
typedef enum{ImGuiDockNodeFlags_DockSpace,ImGuiDockNodeFlags_CentralNode,ImGuiDockNodeFlags_NoTabBar,ImGuiDockNodeFlags_HiddenTabBar,ImGuiDockNodeFlags_NoWindowMenuButton,ImGuiDockNodeFlags_NoCloseButton,ImGuiDockNodeFlags_NoDocking,ImGuiDockNodeFlags_NoDockingSplitMe,ImGuiDockNodeFlags_NoDockingSplitOther,ImGuiDockNodeFlags_NoDockingOverMe,ImGuiDockNodeFlags_NoDockingOverOther,ImGuiDockNodeFlags_NoDockingOverEmpty,ImGuiDockNodeFlags_NoResizeX,ImGuiDockNodeFlags_NoResizeY,ImGuiDockNodeFlags_SharedFlagsInheritMask_,ImGuiDockNodeFlags_NoResizeFlagsMask_,ImGuiDockNodeFlags_LocalFlagsMask_,ImGuiDockNodeFlags_LocalFlagsTransferMask_,ImGuiDockNodeFlags_SavedFlagsMask_}ImGuiDockNodeFlagsPrivate_;
...
typedef enum{ImGuiInputEventType_None,ImGuiInputEventType_MousePos,ImGuiInputEventType_MouseWheel,ImGuiInputEventType_MouseButton,ImGuiInputEventType_MouseViewport,ImGuiInputEventType_Key,ImGuiInputEventType_Text,ImGuiInputEventType_Focus,ImGuiInputEventType_COUNT}ImGuiInputEventType;
typedef enum{ImGuiInputFlags_None,ImGuiInputFlags_Repeat,ImGuiInputFlags_RepeatRateDefault,ImGuiInputFlags_RepeatRateNavMove,ImGuiInputFlags_RepeatRateNavTweak,ImGuiInputFlags_RepeatRateMask_,ImGuiInputFlags_CondHovered,ImGuiInputFlags_CondActive,ImGuiInputFlags_CondDefault_,ImGuiInputFlags_CondMask_,ImGuiInputFlags_LockThisFrame,ImGuiInputFlags_LockUntilRelease,ImGuiInputFlags_RouteFocused,ImGuiInputFlags_RouteGlobalLow,ImGuiInputFlags_RouteGlobal,ImGuiInputFlags_RouteGlobalHigh,ImGuiInputFlags_RouteMask_,ImGuiInputFlags_RouteAlways,ImGuiInputFlags_RouteUnlessBgFocused,ImGuiInputFlags_RouteExtraMask_,ImGuiInputFlags_SupportedByIsKeyPressed,ImGuiInputFlags_SupportedByShortcut,ImGuiInputFlags_SupportedBySetKeyOwner,ImGuiInputFlags_SupportedBySetItemKeyOwner,}ImGuiInputFlags_;
typedef enum{ImGuiInputSource_None,ImGuiInputSource_Mouse,ImGuiInputSource_Keyboard,ImGuiInputSource_Gamepad,ImGuiInputSource_Clipboard,ImGuiInputSource_Nav,ImGuiInputSource_COUNT}ImGuiInputSource;
typedef enum{ImGuiInputTextFlags_Multiline,ImGuiInputTextFlags_NoMarkEdited,ImGuiInputTextFlags_MergedItem,}ImGuiInputTextFlagsPrivate_;
...
typedef enum{ImGuiItemFlags_None,ImGuiItemFlags_NoTabStop,ImGuiItemFlags_ButtonRepeat,ImGuiItemFlags_Disabled,ImGuiItemFlags_NoNav,ImGuiItemFlags_NoNavDefaultFocus,ImGuiItemFlags_SelectableDontClosePopup,ImGuiItemFlags_MixedValue,ImGuiItemFlags_ReadOnly,ImGuiItemFlags_NoWindowHoverableCheck,ImGuiItemFlags_Inputable,}ImGuiItemFlags_;
typedef enum{ImGuiItemStatusFlags_None,ImGuiItemStatusFlags_HoveredRect,ImGuiItemStatusFlags_HasDisplayRect,ImGuiItemStatusFlags_Edited,ImGuiItemStatusFlags_ToggledSelection,ImGuiItemStatusFlags_ToggledOpen,ImGuiItemStatusFlags_HasDeactivated,ImGuiItemStatusFlags_Deactivated,ImGuiItemStatusFlags_HoveredWindow,ImGuiItemStatusFlags_FocusedByTabbing,ImGuiItemStatusFlags_Visible,}ImGuiItemStatusFlags_;
...
typedef enum{ImGuiLayoutType_Horizontal,ImGuiLayoutType_Vertical}ImGuiLayoutType_;
typedef enum{ImGuiLocKey_TableSizeOne,ImGuiLocKey_TableSizeAllFit,ImGuiLocKey_TableSizeAllDefault,ImGuiLocKey_TableResetOrder,ImGuiLocKey_WindowingMainMenuBar,ImGuiLocKey_WindowingPopup,ImGuiLocKey_WindowingUntitled,ImGuiLocKey_DockingHideTabBar,ImGuiLocKey_COUNT,}ImGuiLocKey;
typedef enum{ImGuiLogType_None,ImGuiLogType_TTY,ImGuiLogType_File,ImGuiLogType_Buffer,ImGuiLogType_Clipboard,}ImGuiLogType;
...
typedef enum{ImGuiNavHighlightFlags_None,ImGuiNavHighlightFlags_TypeDefault,ImGuiNavHighlightFlags_TypeThin,ImGuiNavHighlightFlags_AlwaysDraw,ImGuiNavHighlightFlags_NoRounding,}ImGuiNavHighlightFlags_;
...
typedef enum{ImGuiNavLayer_Main,ImGuiNavLayer_Menu,ImGuiNavLayer_COUNT}ImGuiNavLayer;
typedef enum{ImGuiNavMoveFlags_None,ImGuiNavMoveFlags_LoopX,ImGuiNavMoveFlags_LoopY,ImGuiNavMoveFlags_WrapX,ImGuiNavMoveFlags_WrapY,ImGuiNavMoveFlags_AllowCurrentNavId,ImGuiNavMoveFlags_AlsoScoreVisibleSet,ImGuiNavMoveFlags_ScrollToEdgeY,ImGuiNavMoveFlags_Forwarded,ImGuiNavMoveFlags_DebugNoResult,ImGuiNavMoveFlags_FocusApi,ImGuiNavMoveFlags_Tabbing,ImGuiNavMoveFlags_Activate,ImGuiNavMoveFlags_DontSetNavHighlight,}ImGuiNavMoveFlags_;
typedef enum{ImGuiNextItemDataFlags_None,ImGuiNextItemDataFlags_HasWidth,ImGuiNextItemDataFlags_HasOpen,}ImGuiNextItemDataFlags_;
typedef enum{ImGuiNextWindowDataFlags_None,ImGuiNextWindowDataFlags_HasPos,ImGuiNextWindowDataFlags_HasSize,ImGuiNextWindowDataFlags_HasContentSize,ImGuiNextWindowDataFlags_HasCollapsed,ImGuiNextWindowDataFlags_HasSizeConstraint,ImGuiNextWindowDataFlags_HasFocus,ImGuiNextWindowDataFlags_HasBgAlpha,ImGuiNextWindowDataFlags_HasScroll,ImGuiNextWindowDataFlags_HasViewport,ImGuiNextWindowDataFlags_HasDock,ImGuiNextWindowDataFlags_HasWindowClass,}ImGuiNextWindowDataFlags_;
typedef enum{ImGuiOldColumnFlags_None,ImGuiOldColumnFlags_NoBorder,ImGuiOldColumnFlags_NoResize,ImGuiOldColumnFlags_NoPreserveWidths,ImGuiOldColumnFlags_NoForceWithinWindow,ImGuiOldColumnFlags_GrowParentContentsSize,}ImGuiOldColumnFlags_;
...
typedef enum{ImGuiScrollFlags_None,ImGuiScrollFlags_KeepVisibleEdgeX,ImGuiScrollFlags_KeepVisibleEdgeY,ImGuiScrollFlags_KeepVisibleCenterX,ImGuiScrollFlags_KeepVisibleCenterY,ImGuiScrollFlags_AlwaysCenterX,ImGuiScrollFlags_AlwaysCenterY,ImGuiScrollFlags_NoScrollParent,ImGuiScrollFlags_MaskX_,ImGuiScrollFlags_MaskY_,}ImGuiScrollFlags_;
typedef enum{ImGuiSelectableFlags_NoHoldingActiveID,ImGuiSelectableFlags_SelectOnNav,ImGuiSelectableFlags_SelectOnClick,ImGuiSelectableFlags_SelectOnRelease,ImGuiSelectableFlags_SpanAvailWidth,ImGuiSelectableFlags_SetNavIdOnHover,ImGuiSelectableFlags_NoPadWithHalfSpacing,ImGuiSelectableFlags_NoSetKeyOwner,}ImGuiSelectableFlagsPrivate_;
...
typedef enum{ImGuiSeparatorFlags_None,ImGuiSeparatorFlags_Horizontal,ImGuiSeparatorFlags_Vertical,ImGuiSeparatorFlags_SpanAllColumns,}ImGuiSeparatorFlags_;
...
typedef enum{ImGuiSliderFlags_Vertical,ImGuiSliderFlags_ReadOnly,}ImGuiSliderFlagsPrivate_;
...
typedef enum{ImGuiTabBarFlags_DockNode,ImGuiTabBarFlags_IsFocused,ImGuiTabBarFlags_SaveSettings,}ImGuiTabBarFlagsPrivate_;
...
typedef enum{ImGuiTabItemFlags_SectionMask_,ImGuiTabItemFlags_NoCloseButton,ImGuiTabItemFlags_Button,ImGuiTabItemFlags_Unsorted,ImGuiTabItemFlags_Preview,}ImGuiTabItemFlagsPrivate_;
...
typedef enum{ImGuiTextFlags_None,ImGuiTextFlags_NoWidthForLargeClippedText,}ImGuiTextFlags_;
typedef enum{ImGuiTooltipFlags_None,ImGuiTooltipFlags_OverridePreviousTooltip,}ImGuiTooltipFlags_;
typedef enum{ImGuiTreeNodeFlags_ClipLabelForTrailingButton,}ImGuiTreeNodeFlagsPrivate_;
...
typedef struct ImBitArray_ImGuiKey_NamedKey_COUNT__lessImGuiKey_NamedKey_BEGIN{ImU32 Storage;}ImBitArray_ImGuiKey_NamedKey_COUNT__lessImGuiKey_NamedKey_BEGIN;
...
struct ImDrawDataBuilder{ImVector_ImDrawListPtr Layers;};
...
struct ImDrawListSharedData;
struct ImDrawListSharedData{ImVec2 TexUvWhitePixel; ImFont* Font; float FontSize; float CurveTessellationTol; float CircleSegmentMaxError; ImVec4 ClipRectFullscreen; ImDrawListFlags InitialFlags; ImVector_ImVec2 TempBuffer; ImVec2 ArcFastVtx; float ArcFastRadiusCutoff; ImU8 CircleSegmentCounts; const ImVec4* TexUvLines;};
...
struct ImFontBuilderIO{bool (*FontBuilder_Build)(ImFontAtlas* atlas);};
struct ImFontConfig;
...
struct ImGuiInputEvent{ImGuiInputEventType Type; ImGuiInputSource Source; ImGuiInputEventMousePos MousePos; ImGuiInputEventMouseWheel MouseWheel; ImGuiInputEventMouseButton MouseButton; ImGuiInputEventMouseViewport MouseViewport; ImGuiInputEventKey Key; ImGuiInputEventText Text; ImGuiInputEventAppFocused AppFocused; bool AddedByTestEngine;};
...
struct ImGuiInputTextState{ImGuiContext* Ctx; ImGuiID ID; int CurLenW,CurLenA; ImVector_ImWchar TextW; ImVector_char TextA; ImVector_char InitialTextA; bool TextAIsValid; int BufCapacityA; float ScrollX; STB_TexteditState Stb; float CursorAnim; bool CursorFollow; bool SelectedAllMouseLock; bool Edited; ImGuiInputTextFlags Flags;};
struct ImGuiKeyData;
struct ImGuiKeyData{bool Down; float DownDuration; float DownDurationPrev; float AnalogValue;};
struct ImGuiKeyOwnerData{ImGuiID OwnerCurr; ImGuiID OwnerNext; bool LockThisFrame; bool LockUntilRelease;};
struct ImGuiKeyRoutingData{ImGuiKeyRoutingIndex NextEntryIndex; ImU16 Mods; ImU8 RoutingNextScore; ImGuiID RoutingCurr; ImGuiID RoutingNext;};
struct ImGuiKeyRoutingTable{ImGuiKeyRoutingIndex Index; ImVector_ImGuiKeyRoutingData Entries; ImVector_ImGuiKeyRoutingData EntriesNext;};
struct ImGuiLastItemData;
struct ImGuiLastItemData{ImGuiID ID; ImGuiItemFlags InFlags; ImGuiItemStatusFlags StatusFlags; ImRect Rect; ImRect NavRect; ImRect DisplayRect;};
struct ImGuiListClipper;
struct ImGuiListClipperData{ImGuiListClipper* ListClipper; float LossynessOffset; int StepNo; int ItemsFrozen; ImVector_ImGuiListClipperRange Ranges;};
...
struct ImGuiLocEntry{ImGuiLocKey Key; const char* Text;};
struct ImGuiMenuColumns;
struct ImGuiMenuColumns{ImU32 TotalWidth; ImU32 NextTotalWidth; ImU16 Spacing; ImU16 OffsetIcon; ImU16 OffsetLabel; ImU16 OffsetShortcut; ImU16 OffsetMark; ImU16 Widths;};
struct ImGuiMetricsConfig;
struct ImGuiMetricsConfig{bool ShowDebugLog; bool ShowStackTool; bool ShowWindowsRects; bool ShowWindowsBeginOrder; bool ShowTablesRects; bool ShowDrawCmdMesh; bool ShowDrawCmdBoundingBoxes; bool ShowAtlasTintedWithTextColor; bool ShowDockingNodes; int ShowWindowsRectsType; int ShowTablesRectsType;};
struct ImGuiNavItemData;
struct ImGuiNavItemData{ImGuiWindow* Window; ImGuiID ID; ImGuiID FocusScopeId; ImRect RectRel; ImGuiItemFlags InFlags; float DistBox; float DistCenter; float DistAxial;};
struct ImGuiNextItemData;
struct ImGuiNextItemData{ImGuiNextItemDataFlags Flags; float Width; ImGuiID FocusScopeId; ImGuiCond OpenCond; bool OpenVal;};
struct ImGuiNextWindowData;
struct ImGuiNextWindowData{ImGuiNextWindowDataFlags Flags; ImGuiCond PosCond; ImGuiCond SizeCond; ImGuiCond CollapsedCond; ImGuiCond DockCond; ImVec2 PosVal; ImVec2 PosPivotVal; ImVec2 SizeVal; ImVec2 ContentSizeVal; ImVec2 ScrollVal; bool PosUndock; bool CollapsedVal; ImRect SizeConstraintRect; ImGuiSizeCallback SizeCallback; void* SizeCallbackUserData; float BgAlphaVal; ImGuiID ViewportId; ImGuiID DockId; ImGuiWindowClass WindowClass; ImVec2 MenuBarOffsetMinVal;};
struct ImGuiOldColumnData;
struct ImGuiOldColumnData{float OffsetNorm; float OffsetNormBeforeResize; ImGuiOldColumnFlags Flags; ImRect ClipRect;};
...
struct ImGuiPopupData{ImGuiID PopupId; ImGuiWindow* Window; ImGuiWindow* BackupNavWindow; int ParentNavLayer; int OpenFrameCount; ImGuiID OpenParentId; ImVec2 OpenPopupPos; ImVec2 OpenMousePos;};
struct ImGuiPtrOrIndex{void* Ptr; int Index;};
struct ImGuiSettingsHandler;
struct ImGuiSettingsHandler{const char* TypeName; ImGuiID TypeHash; void (*ClearAllFn)(ImGuiContext* ctx,ImGuiSettingsHandler* handler); void (*ReadInitFn)(ImGuiContext* ctx,ImGuiSettingsHandler* handler); void* (*ReadOpenFn)(ImGuiContext* ctx,ImGuiSettingsHandler* handler,const char* name); void (*ReadLineFn)(ImGuiContext* ctx,ImGuiSettingsHandler* handler,void* entry,const char* line); void (*ApplyAllFn)(ImGuiContext* ctx,ImGuiSettingsHandler* handler); void (*WriteAllFn)(ImGuiContext* ctx,ImGuiSettingsHandler* handler,ImGuiTextBuffer* out_buf); void* UserData;};
struct ImGuiShrinkWidthItem{int Index; float Width; float InitialWidth;};
struct ImGuiSizeCallbackData;
struct ImGuiSizeCallbackData{void* UserData; ImVec2 Pos; ImVec2 CurrentSize; ImVec2 DesiredSize;};
struct ImGuiStackLevelInfo{ImGuiID ID; ImS8 QueryFrameCount; bool QuerySuccess; ImGuiDataType DataType; char Desc;};
struct ImGuiStackSizes;
struct ImGuiStackSizes{short SizeOfIDStack; short SizeOfColorStack; short SizeOfStyleVarStack; short SizeOfFontStack; short SizeOfFocusScopeStack; short SizeOfGroupStack; short SizeOfItemFlagsStack; short SizeOfBeginPopupStack; short SizeOfDisabledStack;};
struct ImGuiStackTool{int LastActiveFrame; int StackLevel; ImGuiID QueryId; ImVector_ImGuiStackLevelInfo Results; bool CopyToClipboardOnCtrlC; float CopyToClipboardLastTime;};
struct ImGuiStorage;
...
struct ImGuiStyleMod{ImGuiStyleVar VarIdx; int BackupInt; float BackupFloat;};
...
struct ImGuiTabBar;
struct ImGuiTabBar{ImVector_ImGuiTabItem Tabs; ImGuiTabBarFlags Flags; ImGuiID ID; ImGuiID SelectedTabId; ImGuiID NextSelectedTabId; ImGuiID VisibleTabId; int CurrFrameVisible; int PrevFrameVisible; ImRect BarRect; float CurrTabsContentsHeight; float PrevTabsContentsHeight; float WidthAllTabs; float WidthAllTabsIdeal; float ScrollingAnim; float ScrollingTarget; float ScrollingTargetDistToVisibility; float ScrollingSpeed; float ScrollingRectMinX; float ScrollingRectMaxX; ImGuiID ReorderRequestTabId; ImS16 ReorderRequestOffset; ImS8 BeginCount; bool WantLayout; bool VisibleTabWasSubmitted; bool TabsAddedNew; ImS16 TabsActiveCount; ImS16 LastTabItemIdx; float ItemSpacingY; ImVec2 FramePadding; ImVec2 BackupCursorPos; ImGuiTextBuffer TabsNames;};
struct ImGuiTabItem;
struct ImGuiTabItem{ImGuiID ID; ImGuiTabItemFlags Flags; ImGuiWindow* Window; int LastFrameVisible; int LastFrameSelected; float Offset; float Width; float ContentWidth; float RequestedWidth; ImS32 NameOffset; ImS16 BeginOrder; ImS16 IndexDuringLayout; bool WantClose;};
struct ImGuiTable;
struct ImGuiTableCellData{ImU32 BgColor; ImGuiTableColumnIdx Column;};
struct ImGuiTableColumn;
struct ImGuiTableColumnSettings{float WidthOrWeight; ImGuiID UserID; ImGuiTableColumnIdx Index; ImGuiTableColumnIdx DisplayOrder; ImGuiTableColumnIdx SortOrder; ImU8 SortDirection; ImU8 IsEnabled; ImU8 IsStretch;};
...
struct ImGuiTableInstanceData{ImGuiID TableInstanceID; float LastOuterHeight; float LastFirstRowHeight; float LastFrozenHeight;};
struct ImGuiTableSettings;
struct ImGuiTableSettings{ImGuiID ID; ImGuiTableFlags SaveFlags; float RefScale; ImGuiTableColumnIdx ColumnsCount; ImGuiTableColumnIdx ColumnsCountMax; bool WantApply;};
