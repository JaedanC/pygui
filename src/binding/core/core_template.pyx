...
cdef class ImDrawList:
    ...
    # ?custom_comment_only(False)
    # ?returns(None)
    def add_image(self: ImDrawList, tex_ref: int, p_min: Tuple[float, float], p_max: Tuple[float, float], uv_min: tuple=(0, 0), uv_max: tuple=(1, 1), col: int=IM_COL32_WHITE):
        """
        Image primitives
    ...
    # ?custom_comment_only(False)
    # ?returns(None)
    def add_image_quad(self: ImDrawList, tex_ref: int, p1: Tuple[float, float], p2: Tuple[float, float], p3: Tuple[float, float], p4: Tuple[float, float], uv1: tuple=(0, 0), uv2: tuple=(1, 0), uv3: tuple=(1, 1), uv4: tuple=(0, 1), col: int=IM_COL32_WHITE):
        cdef dcimgui.ImTextureRef t_ref
        t_ref._TexID = tex_ref
        t_ref._TexData = NULL
    ...
    # ?custom_comment_only(False)
    # ?returns(None)
    def add_image_rounded(self: ImDrawList, tex_ref: int, p_min: Tuple[float, float], p_max: Tuple[float, float], uv_min: Tuple[float, float], uv_max: Tuple[float, float], col: int, rounding: float, flags: int=0):
        cdef dcimgui.ImTextureRef t_ref
        t_ref._TexID = tex_ref
        t_ref._TexData = NULL
