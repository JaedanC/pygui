...
POPUP_FLAGS_MOUSE_BUTTON_SHIFT = dcimgui.ImGuiPopupFlags_MouseButtonShift_
POPUP_FLAGS_MOUSE_BUTTON_MASK = dcimgui.ImGuiPopupFlags_MouseButtonMask_
POPUP_FLAGS_INVALID_MASK = dcimgui.ImGuiPopupFlags_InvalidMask_
...
STYLE_VAR_IMAGE_ROUNDING = dcimgui.ImGuiStyleVar_ImageRounding
...
COLOR_EDIT_FLAGS_NO_COLOR_MARKERS = dcimgui.ImGuiColorEditFlags_NoColorMarkers
...
SLIDER_FLAGS_COLOR_MARKERS = dcimgui.ImGuiSliderFlags_ColorMarkers
...
def show_id_stack_tool_window():
    ...
    Implied p_open = null
    """
    dcimgui.ImGui_ShowIDStackToolWindow()
# [End Function]
...
def set_next_window_pos(pos: Tuple[float, float], cond: int=0):
    ...
    """
    dcimgui.ImGui_SetNextWindowPos(
...
def get_color_u32(idx: int):
    ...
    """
    cdef dcimgui.ImU32 res = dcimgui.ImGui_GetColorU32(
        idx
    )
    return res
# [End Function]
...
def get_style_color_vec4(idx: int):
    ...
    """
    cdef dcimgui.ImVec4* res = dcimgui.ImGui_GetStyleColorVec4(
        idx
    )
...
def button(label: str):
    ...
    """
    cdef bool res = dcimgui.ImGui_Button(
        _bytes(label)
    )
    return res
# [End Function]
...
def combo(label: str, current_item: Int, items_separated_by_zeros: str):
    ...
    Implied popup_max_height_in_items = -1
    """
    cdef bool res = dcimgui.ImGui_Combo(
        _bytes(label),
        &current_item.value,
...
def combo_callback(label: str, current_item: Int, getter: Callable, user_data: Any, items_count: int):
    ...
    Implied popup_max_height_in_items = -1
    """
    cdef bool res = dcimgui.ImGui_ComboCallback(
        _bytes(label),
        &current_item.value,
        getter,
        user_data,
...
def drag_float(label: str, v: Float):
    ...
    """
    cdef bool res = dcimgui.ImGui_DragFloat(
        _bytes(label),
        &v.value
    )
    return res
...
def drag_float2(label: str, v: Sequence[Float]):
    ...
    Implied v_speed = 1.0f, v_min = 0.0f, v_max = 0.0f, format = '%.3f', flags = 0
    """
    cdef bool res = dcimgui.ImGui_DragFloat2(
        _bytes(label),
        &v.value
    )
    return res
...
def drag_float3(label: str, v: Sequence[Float]):
    ...
    Implied v_speed = 1.0f, v_min = 0.0f, v_max = 0.0f, format = '%.3f', flags = 0
    """
    cdef bool res = dcimgui.ImGui_DragFloat3(
        _bytes(label),
        &v.value
    )
    return res
...
def drag_float4(label: str, v: Sequence[Float]):
    ...
    Implied v_speed = 1.0f, v_min = 0.0f, v_max = 0.0f, format = '%.3f', flags = 0
    """
    cdef bool res = dcimgui.ImGui_DragFloat4(
        _bytes(label),
        &v.value
    )
    return res
...
def drag_float_range2(label: str, v_current_min: Float, v_current_max: Float):
    ...
    """
    cdef bool res = dcimgui.ImGui_DragFloatRange2(
        _bytes(label),
        &v_current_min.value,
        &v_current_max.value
    )
...
def drag_int(label: str, v: Int):
    ...
    """
    cdef bool res = dcimgui.ImGui_DragInt(
        _bytes(label),
        &v.value
    )
    return res
...
def drag_int2(label: str, v: Sequence[Int]):
    ...
    Implied v_speed = 1.0f, v_min = 0, v_max = 0, format = '%d', flags = 0
    """
    cdef bool res = dcimgui.ImGui_DragInt2(
        _bytes(label),
        &v.value
    )
    return res
...
def drag_int3(label: str, v: Sequence[Int]):
    ...
    Implied v_speed = 1.0f, v_min = 0, v_max = 0, format = '%d', flags = 0
    """
    cdef bool res = dcimgui.ImGui_DragInt3(
        _bytes(label),
        &v.value
    )
    return res
...
def drag_int4(label: str, v: Sequence[Int]):
    ...
    Implied v_speed = 1.0f, v_min = 0, v_max = 0, format = '%d', flags = 0
    """
    cdef bool res = dcimgui.ImGui_DragInt4(
        _bytes(label),
        &v.value
    )
    return res
...
def drag_int_range2(label: str, v_current_min: Int, v_current_max: Int):
    ...
    """
    cdef bool res = dcimgui.ImGui_DragIntRange2(
        _bytes(label),
        &v_current_min.value,
        &v_current_max.value
    )
...
def drag_scalar(label: str, data_type: int, p_data: Any):
    ...
    """
    cdef bool res = dcimgui.ImGui_DragScalar(
        _bytes(label),
        data_type,
        p_data
    )
...
def drag_scalar_n(label: str, data_type: int, p_data: Any, components: int):
    ...
    Implied v_speed = 1.0f, p_min = null, p_max = null, format = null, flags = 0
    """
    cdef bool res = dcimgui.ImGui_DragScalarN(
        _bytes(label),
        data_type,
        p_data,
        components
...
def slider_float(label: str, v: Float, v_min: float, v_max: float):
    ...
    """
    cdef bool res = dcimgui.ImGui_SliderFloat(
        _bytes(label),
        &v.value,
        v_min,
        v_max
...
def slider_float2(label: str, v: Sequence[Float], v_min: float, v_max: float):
    ...
    Implied format = '%.3f', flags = 0
    """
    cdef bool res = dcimgui.ImGui_SliderFloat2(
        _bytes(label),
        &v.value,
        v_min,
        v_max
...
def slider_float3(label: str, v: Sequence[Float], v_min: float, v_max: float):
    ...
    Implied format = '%.3f', flags = 0
    """
    cdef bool res = dcimgui.ImGui_SliderFloat3(
        _bytes(label),
        &v.value,
        v_min,
        v_max
...
def slider_float4(label: str, v: Sequence[Float], v_min: float, v_max: float):
    ...
    Implied format = '%.3f', flags = 0
    """
    cdef bool res = dcimgui.ImGui_SliderFloat4(
        _bytes(label),
        &v.value,
        v_min,
        v_max
...
def slider_angle(label: str, v_rad: Float):
    ...
    """
    cdef bool res = dcimgui.ImGui_SliderAngle(
        _bytes(label),
        &v_rad.value
    )
    return res
...
def slider_int(label: str, v: Int, v_min: int, v_max: int):
    ...
    """
    cdef bool res = dcimgui.ImGui_SliderInt(
        _bytes(label),
        &v.value,
        v_min,
        v_max
...
def slider_int2(label: str, v: Sequence[Int], v_min: int, v_max: int):
    ...
    Implied format = '%d', flags = 0
    """
    cdef bool res = dcimgui.ImGui_SliderInt2(
        _bytes(label),
        &v.value,
        v_min,
        v_max
...
def slider_int3(label: str, v: Sequence[Int], v_min: int, v_max: int):
    ...
    Implied format = '%d', flags = 0
    """
    cdef bool res = dcimgui.ImGui_SliderInt3(
        _bytes(label),
        &v.value,
        v_min,
        v_max
...
def slider_int4(label: str, v: Sequence[Int], v_min: int, v_max: int):
    ...
    Implied format = '%d', flags = 0
    """
    cdef bool res = dcimgui.ImGui_SliderInt4(
        _bytes(label),
        &v.value,
        v_min,
        v_max
...
def slider_scalar(label: str, data_type: int, p_data: Any, p_min: Any, p_max: Any):
    ...
    """
    cdef bool res = dcimgui.ImGui_SliderScalar(
        _bytes(label),
        data_type,
        p_data,
        p_min,
...
def slider_scalar_n(label: str, data_type: int, p_data: Any, components: int, p_min: Any, p_max: Any):
    ...
    Implied format = null, flags = 0
    """
    cdef bool res = dcimgui.ImGui_SliderScalarN(
        _bytes(label),
        data_type,
        p_data,
        components,
...
def vslider_float(label: str, size: Tuple[float, float], v: Float, v_min: float, v_max: float):
    ...
    Implied format = '%.3f', flags = 0
    """
    cdef bool res = dcimgui.ImGui_VSliderFloat(
        _bytes(label),
        _cast_tuple_ImVec2(size),
        &v.value,
        v_min,
...
def vslider_int(label: str, size: Tuple[float, float], v: Int, v_min: int, v_max: int):
    ...
    Implied format = '%d', flags = 0
    """
    cdef bool res = dcimgui.ImGui_VSliderInt(
        _bytes(label),
        _cast_tuple_ImVec2(size),
        &v.value,
        v_min,
...
def vslider_scalar(label: str, size: Tuple[float, float], data_type: int, p_data: Any, p_min: Any, p_max: Any):
    ...
    Implied format = null, flags = 0
    """
    cdef bool res = dcimgui.ImGui_VSliderScalar(
        _bytes(label),
        _cast_tuple_ImVec2(size),
        data_type,
        p_data,
...
def input_text(label: str, buf: str, buf_size: int, flags: int=0):
    ...
    """
    cdef bool res = dcimgui.ImGui_InputText(
        _bytes(label),
        _bytes(buf),
        buf_size,
        flags
...
def input_text_multiline(label: str, buf: str, buf_size: int):
    ...
    """
    cdef bool res = dcimgui.ImGui_InputTextMultiline(
        _bytes(label),
        _bytes(buf),
        buf_size
    )
...
def input_text_with_hint(label: str, hint: str, buf: str, buf_size: int, flags: int=0):
    ...
    Implied callback = null, user_data = null
    """
    cdef bool res = dcimgui.ImGui_InputTextWithHint(
        _bytes(label),
        _bytes(hint),
        _bytes(buf),
        buf_size,
...
def input_float(label: str, v: Float):
    ...
    """
    cdef bool res = dcimgui.ImGui_InputFloat(
        _bytes(label),
        &v.value
    )
    return res
...
def input_float2(label: str, v: Sequence[Float]):
    ...
    Implied format = '%.3f', flags = 0
    """
    cdef bool res = dcimgui.ImGui_InputFloat2(
        _bytes(label),
        &v.value
    )
    return res
...
def input_float3(label: str, v: Sequence[Float]):
    ...
    Implied format = '%.3f', flags = 0
    """
    cdef bool res = dcimgui.ImGui_InputFloat3(
        _bytes(label),
        &v.value
    )
    return res
...
def input_float4(label: str, v: Sequence[Float]):
    ...
    Implied format = '%.3f', flags = 0
    """
    cdef bool res = dcimgui.ImGui_InputFloat4(
        _bytes(label),
        &v.value
    )
    return res
...
def input_double(label: str, v: Double):
    ...
    """
    cdef bool res = dcimgui.ImGui_InputDouble(
        _bytes(label),
        &v.value
    )
    return res
...
def input_scalar(label: str, data_type: int, p_data: Any):
    ...
    """
    cdef bool res = dcimgui.ImGui_InputScalar(
        _bytes(label),
        data_type,
        p_data
    )
...
def input_scalar_n(label: str, data_type: int, p_data: Any, components: int):
    ...
    Implied p_step = null, p_step_fast = null, format = null, flags = 0
    """
    cdef bool res = dcimgui.ImGui_InputScalarN(
        _bytes(label),
        data_type,
        p_data,
        components
...
def color_picker4(label: str, col: Sequence[Float], flags: int=0, ref_col: Float=None):
    cdef bool res = dcimgui.ImGui_ColorPicker4(
        _bytes(label),
        &col.value,
        flags,
        Float.ptr(ref_col)
...
def color_button(desc_id: str, col: Tuple[float, float, float, float], flags: int=0):
    ...
    Implied size = imvec2(0, 0)
    """
    cdef bool res = dcimgui.ImGui_ColorButton(
        _bytes(desc_id),
        _cast_tuple_ImVec4(col),
        flags
    )
...
def tree_node(label: str):
    ...
    """
    cdef bool res = dcimgui.ImGui_TreeNode(
        _bytes(label)
    )
    return res
# [End Function]
...
def selectable(label: str):
    ...
    """
    cdef bool res = dcimgui.ImGui_Selectable(
        _bytes(label)
    )
    return res
# [End Function]
...
def selectable_bool_ptr(label: str, p_selected: Bool, flags: int=0):
    ...
    Implied size = imvec2(0, 0)
    """
    cdef bool res = dcimgui.ImGui_SelectableBoolPtr(
        _bytes(label),
        &p_selected.value,
        flags
    )
...
def begin_multi_select(flags: int):
    ...
    """
    cdef dcimgui.ImGuiMultiSelectIO* res = dcimgui.ImGui_BeginMultiSelect(
        flags
    )
...
def list_box_callback(label: str, current_item: Int, getter: Callable, user_data: Any, items_count: int):
    ...
    """
    cdef bool res = dcimgui.ImGui_ListBoxCallback(
        _bytes(label),
        &current_item.value,
        getter,
        user_data,
...
def plot_lines_callback(label: str, values_getter: Callable, data: Any, values_count: int):
    ...
    """
    dcimgui.ImGui_PlotLinesCallback(
        _bytes(label),
        values_getter,
        data,
        values_count
...
def plot_histogram_callback(label: str, values_getter: Callable, data: Any, values_count: int):
    ...
    Implied values_offset = 0, overlay_text = null, scale_min = flt_max, scale_max = flt_max, graph_size = imvec2(0, 0)
    """
    dcimgui.ImGui_PlotHistogramCallback(
        _bytes(label),
        values_getter,
        data,
        values_count
...
def begin_menu(label: str):
    ...
    """
    cdef bool res = dcimgui.ImGui_BeginMenu(
        _bytes(label)
    )
    return res
# [End Function]
...
def menu_item(label: str):
    ...
    """
    cdef bool res = dcimgui.ImGui_MenuItem(
        _bytes(label)
    )
    return res
# [End Function]
...
def begin_popup_context_item():
    ...
    """
    cdef bool res = dcimgui.ImGui_BeginPopupContextItem()
    return res
# [End Function]
...
# ?custom_comment_only(False)
# ?returns(bool)
def begin_popup_context_item_ex(str_id: str=None, popup_flags: int=0):
    """
...
def begin_popup_context_window():
    ...
    Implied str_id = null, popup_flags = 0
    """
    cdef bool res = dcimgui.ImGui_BeginPopupContextWindow()
    return res
# [End Function]
...
# ?custom_comment_only(False)
# ?returns(bool)
def begin_popup_context_window_ex(str_id: str=None, popup_flags: int=0):
    """
...
def begin_popup_context_void():
    ...
    Implied str_id = null, popup_flags = 0
    """
    cdef bool res = dcimgui.ImGui_BeginPopupContextVoid()
    return res
# [End Function]
...
# ?custom_comment_only(False)
# ?returns(bool)
def begin_popup_context_void_ex(str_id: str=None, popup_flags: int=0):
    """
...
# ?custom_comment_only(False)
# ?returns(bool)
def begin_table(str_id: str, columns: int, flags: int=0):
    """
    Tables
    ...
    """
    cdef bool res = dcimgui.ImGui_BeginTable(
        _bytes(str_id),
        columns,
        flags
    )
...
def dock_space_over_viewport():
    ...
    """
    cdef dcimgui.ImGuiID res = dcimgui.ImGui_DockSpaceOverViewport()
    return res
# [End Function]
...
def accept_drag_drop_payload(type_: str, flags: int=0):
    ...
    """
    cdef dcimgui.ImGuiPayload* res = dcimgui.ImGui_AcceptDragDropPayload(
        _bytes(type_),
        flags
    )
...
def get_drag_drop_payload():
    ...
    """
    cdef dcimgui.ImGuiPayload* res = dcimgui.ImGui_GetDragDropPayload()
    return ImGuiPayload.from_ptr(res)
# [End Function]
...
def set_keyboard_focus_here():
    ...
    Implied offset = 0
    """
    dcimgui.ImGui_SetKeyboardFocusHere()
# [End Function]
...
def is_item_clicked():
    ...
    """
    cdef bool res = dcimgui.ImGui_IsItemClicked()
    return res
# [End Function]
...
def get_item_flags():
    ...
    """
    cdef dcimgui.ImGuiItemFlags res = dcimgui.ImGui_GetItemFlags()
    return res
# [End Function]
...
def get_foreground_draw_list():
    ...
    Implied viewport = null
    """
    cdef dcimgui.ImDrawList* res = dcimgui.ImGui_GetForegroundDrawList()
    return ImDrawList.from_ptr(res)
# [End Function]
...
def calc_text_size(text: str):
    ...
    """
    cdef dcimgui.ImVec2 res = dcimgui.ImGui_CalcTextSize(
        _bytes(text)
    )
    return _cast_ImVec2_tuple(res)
# [End Function]
...
def is_key_pressed(key: int):
    ...
    Implied repeat = true
    """
    cdef bool res = dcimgui.ImGui_IsKeyPressed(
        key
    )
    return res
# [End Function]
...
def is_mouse_clicked(button: int):
    ...
    """
    cdef bool res = dcimgui.ImGui_IsMouseClicked(
        button
    )
    return res
# [End Function]
...
def is_mouse_hovering_rect(r_min: Tuple[float, float], r_max: Tuple[float, float]):
    ...
    Implied clip = true
    """
    cdef bool res = dcimgui.ImGui_IsMouseHoveringRect(
...
def is_mouse_pos_valid(mouse_pos: ImVec2=None):
    ...
    """
    cdef bool res = dcimgui.ImGui_IsMousePosValid(
        <dcimgui.ImVec2*>(NULL if mouse_pos is None else mouse_pos._ptr)
    )
    return res
# [End Function]
...
def render_platform_windows_default():
    ...
    """
    dcimgui.ImGui_RenderPlatformWindowsDefault()
# [End Function]
...
cdef class ImGuiTableSortSpecs:
    ...
    def specs(self):
        ...
        """
        cdef dcimgui.ImGuiTableColumnSortSpecs* res = dereference(self._ptr).Specs
...
cdef class ImGuiTableColumnSortSpecs:
    ...
    """
    cdef dcimgui.ImGuiTableColumnSortSpecs* _ptr
    cdef bool dynamically_allocated
    
    @staticmethod
    cdef ImGuiTableColumnSortSpecs from_ptr(dcimgui.ImGuiTableColumnSortSpecs* _ptr):
        if _ptr == NULL:
            return None
...
cdef class ImVector_ImDrawIdx:
    ...
    @property
    def data(self):
        cdef dcimgui.ImDrawIdx* res = dereference(self._ptr).Data
        return res
    @data.setter
...
cdef class ImVector_ImDrawVert:
    ...
    @property
    def data(self):
        cdef dcimgui.ImDrawVert* res = dereference(self._ptr).Data
...
cdef class ImVector_float:
    ...
    """
    cdef dcimgui.ImVector_float* _ptr
    cdef bool dynamically_allocated
    
    @staticmethod
    cdef ImVector_float from_ptr(dcimgui.ImVector_float* _ptr):
        if _ptr == NULL:
            return None
...
cdef class ImVector_ImFontGlyph:
    ...
    """
    cdef dcimgui.ImVector_ImFontGlyph* _ptr
    cdef bool dynamically_allocated
    
    @staticmethod
    cdef ImVector_ImFontGlyph from_ptr(dcimgui.ImVector_ImFontGlyph* _ptr):
        if _ptr == NULL:
            return None
...
cdef class ImGuiStyle:
    ...
    # ?returns(float)
    @property
    def image_rounding(self):
        """
        Rounding of image() calls.
        """
        cdef float res = dereference(self._ptr).ImageRounding
        return res
    @image_rounding.setter
    def image_rounding(self, value: float):
        # dereference(self._ptr).ImageRounding = value
        raise NotImplementedError
    # [End Field]
    ...
    # ?returns(float)
    @property
    def color_marker_size(self):
        """
        Size of r/g/b/a color markers for coloredit4() and for drags/sliders when using imguisliderflags_colormarkers.
        """
        cdef float res = dereference(self._ptr).ColorMarkerSize
        return res
    @color_marker_size.setter
    def color_marker_size(self, value: float):
        # dereference(self._ptr).ColorMarkerSize = value
        raise NotImplementedError
    # [End Field]
...
cdef class ImGuiInputTextCallbackData:
    ...
    def event_activated(self):
        ...
        """
        cdef bool res = dereference(self._ptr).EventActivated
        return res
    @event_activated.setter
    def event_activated(self, value: bool):
        # dereference(self._ptr).EventActivated = value
        raise NotImplementedError
    # [End Field]
    ...
    # ?custom_comment_only(False)
    # ?returns(None)
    def set_selection(self: ImGuiInputTextCallbackData, s: int, e: int):
        dcimgui.ImGuiInputTextCallbackData_SetSelection(
            self._ptr,
            s,
            e
        )
...
cdef class ImGuiPayload:
    ...
    """
    cdef dcimgui.ImGuiPayload* _ptr
    cdef bool dynamically_allocated
    
    @staticmethod
    cdef ImGuiPayload from_ptr(dcimgui.ImGuiPayload* _ptr):
        if _ptr == NULL:
            return None
...
cdef class ImDrawList:
    ...
    def add_rect_filled(self: ImDrawList, p_min: Tuple[float, float], p_max: Tuple[float, float], col: int):
        ...
        """
        dcimgui.ImDrawList_AddRectFilled(
            self._ptr,
            _cast_tuple_ImVec2(p_min),
            _cast_tuple_ImVec2(p_max),
            col
    ...
    def add_triangle(self: ImDrawList, p1: Tuple[float, float], p2: Tuple[float, float], p3: Tuple[float, float], col: int):
        ...
        Implied thickness = 1.0f
        """
        dcimgui.ImDrawList_AddTriangle(
            self._ptr,
            _cast_tuple_ImVec2(p1),
            _cast_tuple_ImVec2(p2),
            _cast_tuple_ImVec2(p3),
    ...
    # ?custom_comment_only(False)
    # ?returns(None)
    def add_ellipse(self: ImDrawList, center: Tuple[float, float], radius: Tuple[float, float], col: int):
        """
        Implied rot = 0.0f, num_segments = 0, thickness = 1.0f
        """
        dcimgui.ImDrawList_AddEllipse(
            self._ptr,
            _cast_tuple_ImVec2(center),
    ...
    # ?custom_comment_only(False)
    # ?returns(None)
    def add_ellipse_filled(self: ImDrawList, center: Tuple[float, float], radius: Tuple[float, float], col: int):
        """
        Implied rot = 0.0f, num_segments = 0
        """
        dcimgui.ImDrawList_AddEllipseFilled(
            self._ptr,
            _cast_tuple_ImVec2(center),
            _cast_tuple_ImVec2(radius),
            col
    ...
    # ?custom_comment_only(False)
    # ?returns(None)
    def add_polyline(self: ImDrawList, points: ImVec2, num_points: int, col: int, thickness: float, flags: int=0):
        """
        General polygon
    ...
    # ?custom_comment_only(False)
    # ?returns(None)
    def add_concave_poly_filled(self: ImDrawList, points: ImVec2, num_points: int, col: int):
...
cdef class ImDrawData:
    ...
    def cmd_lists(self):
        ...
        """
        cdef dcimgui.ImVector_ImDrawListPtr res = dereference(self._ptr).CmdLists
...
cdef class ImFontConfig:
    ...
    # ?returns(float)
    @property
    def extra_size_scale(self):
        """
        1.0f     // extra rasterizer scale over sizepixels.
        """
        cdef float res = dereference(self._ptr).ExtraSizeScale
        return res
    @extra_size_scale.setter
    def extra_size_scale(self, value: float):
        # dereference(self._ptr).ExtraSizeScale = value
        raise NotImplementedError
    # [End Field]
...
cdef class ImFontGlyph:
    ...
    @staticmethod
    cdef ImFontGlyph from_ptr(dcimgui.ImFontGlyph* _ptr):
        if _ptr == NULL:
            return None
...
cdef class ImFontAtlas:
    ...
    # ?custom_comment_only(False)
    # ?returns(ImFont)
    def add_font_default_vector(self: ImFontAtlas, font_cfg: ImFontConfig=None):
        """
        Embedded scalable font. recommended at any higher size.
        """
        cdef dcimgui.ImFont* res = dcimgui.ImFontAtlas_AddFontDefaultVector(
            self._ptr,
            <dcimgui.ImFontConfig*>(NULL if font_cfg is None else font_cfg._ptr)
        )
        return ImFont.from_ptr(res)
    ...
    # ?custom_comment_only(False)
    # ?returns(ImFont)
    def add_font_default_bitmap(self: ImFontAtlas, font_cfg: ImFontConfig=None):
        """
        Embedded classic pixel-clean font. recommended at size 13px with no scaling.
        """
        cdef dcimgui.ImFont* res = dcimgui.ImFontAtlas_AddFontDefaultBitmap(
            self._ptr,
            <dcimgui.ImFontConfig*>(NULL if font_cfg is None else font_cfg._ptr)
        )
        return ImFont.from_ptr(res)
...
cdef class ImGuiPlatformIO:
    ...
    def monitors(self):
        ...
        """
        cdef dcimgui.ImVector_ImGuiPlatformMonitor res = dereference(self._ptr).Monitors
    ...
    def viewports(self):
        ...
        """
        cdef dcimgui.ImVector_ImGuiViewportPtr res = dereference(self._ptr).Viewports
...
# ?custom_comment_only(False)
# ?returns(bool)
def c_impl_glfw_init_for_open_gl(window: GLFWwindow, install_callbacks: bool):
    """
...
# ?custom_comment_only(False)
# ?returns(bool)
def c_impl_open_gl3_init():
    """
    Follow "Getting Started" link and check examples/ folder to learn about using backends!
    Implied glsl_version = nullptr
    """
    cdef bool res = dcimgui.cImGui_ImplOpenGL3_Init()
    return res
# [End Function]
