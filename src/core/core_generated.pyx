...
def begin(name: str, p_open: BoolPtr=None, flags: int=0):
    cdef bool res = ccimgui.igBegin(_bytes(name), p_open, flags)
    return res
# [End Function]
...
def checkbox(label: str, value: BoolPtr):
    cdef bool res = ccimgui.igCheckbox(_bytes(label), value)
    return res
# [End Function]
...
def color_button(desc_id: str, col: tuple, flags: int=0, size: tuple=(0, 0)):
    ...
    when pressed.
    """
    cdef bool res = ccimgui.igColorButton(_bytes(desc_id), _cast_tuple_ImVec4(col), flags, _cast_tuple_ImVec2(size))
    return res
# [End Function]
...
def color_edit3(label: str, col0: float, col1: float, col2: float, flags: int=0):
    ...
    cdef bool res = ccimgui.igColorEdit3(_bytes(label), <float*>&io_float_col, flags)
    return res
# [End Function]
...
def color_edit4(label: str, col0: float, col1: float, col2: float, col3: float, flags: int=0):
    ...
    cdef bool res = ccimgui.igColorEdit4(_bytes(label), <float*>&io_float_col, flags)
    return res
# [End Function]
...
def color_picker3(label: str, col0: float, col1: float, col2: float, flags: int=0):
    cdef float[3] io_float_col = [col0, col1, col2]
    cdef bool res = ccimgui.igColorPicker3(_bytes(label), <float*>&io_float_col, flags)
    return res
# [End Function]
...
def color_picker4(label: str, col0: float, col1: float, col2: float, col3: float, flags: int=0, ref_col: float=None):
    cdef float[4] io_float_col = [col0, col1, col2, col3]
    cdef bool res = ccimgui.igColorPicker4(_bytes(label), <float*>&io_float_col, flags, ref_col)
    return res
# [End Function]
...
def impl_glfw_init_for_open_gl(window: GLFWwindow, install_callbacks: bool):
    cdef bool res = ccimgui.ImGui_ImplGlfw_InitForOpenGL(window._ptr, install_callbacks)
    return res
# [End Function]
...
def impl_open_gl3_init(glsl_version: str=nullptr):
    cdef bool res = ccimgui.ImGui_ImplOpenGL3_Init(_bytes(glsl_version))
    return res
# [End Function]
...
def input_float2(label: str, value0: float, value1: float, format_: str="%.3", flags: int=0):
    cdef float[2] io_float_value = [value0, value1]
    cdef bool res = ccimgui.igInputFloat2(_bytes(label), <float*>&io_float_value, _bytes(format_), flags)
    return res
# [End Function]
...
def input_float3(label: str, value0: float, value1: float, value2: float, format_: str="%.3", flags: int=0):
    cdef float[3] io_float_value = [value0, value1, value2]
    cdef bool res = ccimgui.igInputFloat3(_bytes(label), <float*>&io_float_value, _bytes(format_), flags)
    return res
# [End Function]
...
def input_float4(label: str, value0: float, value1: float, value2: float, value3: float, format_: str="%.3", flags: int=0):
    cdef float[4] io_float_value = [value0, value1, value2, value3]
    cdef bool res = ccimgui.igInputFloat4(_bytes(label), <float*>&io_float_value, _bytes(format_), flags)
    return res
# [End Function]
...
def input_int(label: str, value: int, step: int=1, step_fast: int=100, flags: int=0):
    cdef bool res = ccimgui.igInputInt(_bytes(label), value, step, step_fast, flags)
    return res
# [End Function]
...
def input_int2(label: str, value0: int, value1: int, flags: int=0):
    cdef int[2] io_int_value = [value0, value1]
    cdef bool res = ccimgui.igInputInt2(_bytes(label), <int*>&io_int_value, flags)
    return res
# [End Function]
...
def input_int3(label: str, value0: int, value1: int, value2: int, flags: int=0):
    cdef int[3] io_int_value = [value0, value1, value2]
    cdef bool res = ccimgui.igInputInt3(_bytes(label), <int*>&io_int_value, flags)
    return res
# [End Function]
...
def input_int4(label: str, value0: int, value1: int, value2: int, value3: int, flags: int=0):
    cdef int[4] io_int_value = [value0, value1, value2, value3]
    cdef bool res = ccimgui.igInputInt4(_bytes(label), <int*>&io_int_value, flags)
    return res
# [End Function]
...
# ?active(False)
# ?returns(bool)
def input_text(label: str, buf: str, buf_size: Any, flags: int=0, callback: Callable=None, user_data: Any=None):
...
# ?active(False)
# ?returns(bool)
def input_text_with_hint(label: str, hint: str, buf: str, buf_size: Any, flags: int=0, callback: Callable=None, user_data: Any=None):
...
def selectable_bool_ptr(label: str, p_selected: BoolPtr, flags: int=0, size: tuple=(0, 0)):
    ...
    a convenient helper.
    """
    cdef bool res = ccimgui.igSelectable_BoolPtr(_bytes(label), p_selected, flags, _cast_tuple_ImVec2(size))
    return res
# [End Function]
...
def set_drag_drop_payload(type_: str, data: Any, sz: Any, cond: int=0):
    ...
    been accepted.
    """
    cdef bool res = ccimgui.igSetDragDropPayload(_bytes(type_), data, sz, cond)
    return res
# [End Function]
...
cdef class ImFontAtlas:
    ...
    # ?active(False)
    # ?returns(None)
    def get_tex_data_as_rgba32(self: ImFontAtlas, out_pixels: Any, out_width: int, out_height: int, out_bytes_per_pixel: int=None):
        """
        4 bytes-per-pixel
        """
...
cdef class ImGuiIO:
    ...
    @property
    def keys_down(self):
        cdef bool res = dereference(self._ptr).KeysDown
        return res
    @keys_down.setter
    def keys_down(self, value: bool):
    ...
    # ?active(False)
    # ?returns(None)
    def add_key_event(self: ImGuiIO, key: Any, down: bool):
        """
...
cdef class ImGuiInputTextCallbackData:
    ...
    @property
    def event_key(self):
        cdef Any res = dereference(self._ptr).EventKey
        return res
    @event_key.setter
    def event_key(self, value: Any):
    ...
    @property
    def buf(self):
        cdef str res = dereference(self._ptr).Buf
        return res
    @buf.setter
    ...
    # ?use_template(False)
    # ?active(False)
    # ?returns(ImGuiInputTextCallbackData)
    @staticmethod
    def input_text_callback_data():
        cdef ccimgui.ImGuiInputTextCallbackData* _ptr = ccimgui.ImGuiInputTextCallbackData_ImGuiInputTextCallbackData()
        if _ptr is NULL:
            raise MemoryError
        return ImGuiInputTextCallbackData.from_ptr(_ptr)
    # [End Method]
    ...
    # ?active(False)
    # ?returns(None)
    def destroy(self: ImGuiInputTextCallbackData):
        ccimgui.ImGuiInputTextCallbackData_destroy(self._ptr)
    # [End Method]
    ...
    def clear_selection(self: ImGuiInputTextCallbackData):
        ccimgui.ImGuiInputTextCallbackData_ClearSelection(self._ptr)
    # [End Method]
    ...
    def delete_chars(self: ImGuiInputTextCallbackData, pos: int, bytes_count: int):
        ccimgui.ImGuiInputTextCallbackData_DeleteChars(self._ptr, pos, bytes_count)
    # [End Method]
    ...
    def insert_chars(self: ImGuiInputTextCallbackData, pos: int, text: str, text_end: str=None):
        ccimgui.ImGuiInputTextCallbackData_InsertChars(self._ptr, pos, _bytes(text), _bytes(text_end))
    # [End Method]
    ...
    def select_all(self: ImGuiInputTextCallbackData):
        ccimgui.ImGuiInputTextCallbackData_SelectAll(self._ptr)
    # [End Method]
# [End Class]
