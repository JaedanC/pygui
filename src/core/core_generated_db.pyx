...
def accept_drag_drop_payload(type_: str, flags: int=0):
    ...
    """
    cdef ccimgui_db.ImGuiPayload* res = ccimgui_db.ImGui_AcceptDragDropPayload(
        _bytes(type_),
        flags
    )
...
def align_text_to_frame_padding():
    ...
    """
    ccimgui_db.ImGui_AlignTextToFramePadding()
# [End Function]
...
def arrow_button(str_id: str, dir_: int):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_ArrowButton(
        _bytes(str_id),
        dir_
    )
    return res
...
def begin_child(str_id: str, size: tuple=(0, 0), border: bool=False, flags: int=0):
    ...
    returned true. Begin and BeginChild are the only odd ones out. Will be fixed in a future update.]
    """
    cdef bool res = ccimgui_db.ImGui_BeginChild(
        _bytes(str_id),
...
def begin_child_frame(id_: int, size: tuple, flags: int=0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_BeginChildFrame(
        id_,
        _cast_tuple_ImVec2(size),
        flags
    )
...
def begin_child_id(id_: int, size: tuple=(0, 0), border: bool=False, flags: int=0):
    cdef bool res = ccimgui_db.ImGui_BeginChildID(
        id_,
        _cast_tuple_ImVec2(size),
        border,
        flags
...
def begin_combo(label: str, preview_value: str, flags: int=0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_BeginCombo(
        _bytes(label),
...
def begin_disabled(disabled: bool=True):
    ...
    """
    ccimgui_db.ImGui_BeginDisabled(
        disabled
    )
# [End Function]
...
def begin_drag_drop_source(flags: int=0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_BeginDragDropSource(
        flags
    )
    return res
# [End Function]
...
def begin_drag_drop_target():
    ...
    """
    cdef bool res = ccimgui_db.ImGui_BeginDragDropTarget()
    return res
# [End Function]
...
def begin_list_box(label: str, size: tuple=(0, 0)):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_BeginListBox(
        _bytes(label),
        _cast_tuple_ImVec2(size)
    )
    return res
...
def begin_main_menu_bar():
    ...
    """
    cdef bool res = ccimgui_db.ImGui_BeginMainMenuBar()
    return res
# [End Function]
...
def begin_menu(label: str):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_BeginMenu(
        _bytes(label)
    )
    return res
# [End Function]
...
def begin_menu_bar():
    ...
    """
    cdef bool res = ccimgui_db.ImGui_BeginMenuBar()
    return res
# [End Function]
...
def begin_menu_ex(label: str, enabled: bool=True):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_BeginMenuEx(
        _bytes(label),
        enabled
    )
    return res
...
def begin_popup(str_id: str, flags: int=0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_BeginPopup(
        _bytes(str_id),
        flags
    )
    return res
...
def begin_popup_context_item():
    ...
    """
    cdef bool res = ccimgui_db.ImGui_BeginPopupContextItem()
    return res
# [End Function]
...
def begin_popup_context_item_ex(str_id: str=None, popup_flags: int=1):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_BeginPopupContextItemEx(
        _bytes(str_id),
        popup_flags
    )
    return res
...
def begin_popup_context_void():
    ...
    Implied str_id = null, popup_flags = 1
    """
    cdef bool res = ccimgui_db.ImGui_BeginPopupContextVoid()
    return res
# [End Function]
...
def begin_popup_context_void_ex(str_id: str=None, popup_flags: int=1):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_BeginPopupContextVoidEx(
        _bytes(str_id),
        popup_flags
    )
    return res
...
def begin_popup_context_window():
    ...
    Implied str_id = null, popup_flags = 1
    """
    cdef bool res = ccimgui_db.ImGui_BeginPopupContextWindow()
    return res
# [End Function]
...
def begin_popup_context_window_ex(str_id: str=None, popup_flags: int=1):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_BeginPopupContextWindowEx(
        _bytes(str_id),
        popup_flags
    )
    return res
...
def begin_popup_modal(name: str, p_open: BoolPtr=None, flags: int=0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_BeginPopupModal(
        _bytes(name),
        &p_open.value,
        flags
    )
...
def begin_tab_bar(str_id: str, flags: int=0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_BeginTabBar(
        _bytes(str_id),
        flags
    )
    return res
...
def begin_tab_item(label: str, p_open: BoolPtr=None, flags: int=0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_BeginTabItem(
        _bytes(label),
        &p_open.value,
        flags
    )
...
def begin_table(str_id: str, column: int, flags: int=0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_BeginTable(
        _bytes(str_id),
        column,
        flags
    )
...
def begin_table_ex(str_id: str, column: int, flags: int=0, outer_size: tuple=(0.0, 0.0), inner_width: float=0.0):
    cdef bool res = ccimgui_db.ImGui_BeginTableEx(
        _bytes(str_id),
        column,
        flags,
...
def begin_tooltip():
    ...
    """
    cdef bool res = ccimgui_db.ImGui_BeginTooltip()
    return res
# [End Function]
...
def button(label: str):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_Button(
        _bytes(label)
    )
    return res
# [End Function]
...
def button_ex(label: str, size: tuple=(0, 0)):
    ...
    Button
    """
    cdef bool res = ccimgui_db.ImGui_ButtonEx(
        _bytes(label),
        _cast_tuple_ImVec2(size)
    )
    return res
...
def calc_item_width():
    ...
    """
    cdef float res = ccimgui_db.ImGui_CalcItemWidth()
    return res
# [End Function]
...
def calc_text_size(text: str):
    ...
    """
    cdef ccimgui_db.ImVec2 res = ccimgui_db.ImGui_CalcTextSize(
        _bytes(text)
    )
...
def calc_text_size_ex(text: str, text_end: str=None, hide_text_after_double_hash: bool=False, wrap_width: float=-1.0):
    cdef ccimgui_db.ImVec2 res = ccimgui_db.ImGui_CalcTextSizeEx(
        _bytes(text),
        _bytes(text_end),
...
def checkbox(label: str, v: BoolPtr):
    cdef bool res = ccimgui_db.ImGui_Checkbox(
        _bytes(label),
        &v.value
    )
    return res
...
def checkbox_flags_int_ptr(label: str, flags: IntPtr, flags_value: int):
    cdef bool res = ccimgui_db.ImGui_CheckboxFlagsIntPtr(
        _bytes(label),
        &flags.value,
        flags_value
    )
...
def checkbox_flags_uint_ptr(label: str, flags: IntPtr, flags_value: int):
    cdef bool res = ccimgui_db.ImGui_CheckboxFlagsUintPtr(
        _bytes(label),
        flags,
        flags_value
    )
...
def close_current_popup():
    ...
    """
    ccimgui_db.ImGui_CloseCurrentPopup()
# [End Function]
...
def collapsing_header(label: str, flags: int=0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_CollapsingHeader(
        _bytes(label),
        flags
    )
    return res
...
def collapsing_header_bool_ptr(label: str, p_visible: BoolPtr, flags: int=0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_CollapsingHeaderBoolPtr(
        _bytes(label),
        &p_visible.value,
        flags
    )
...
def color_button(desc_id: str, col: tuple, flags: int=0):
    ...
    Implied size = imvec2(0, 0)
    """
    cdef bool res = ccimgui_db.ImGui_ColorButton(
        _bytes(desc_id),
...
def color_button_ex(desc_id: str, col: tuple, flags: int=0, size: tuple=(0, 0)):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_ColorButtonEx(
        _bytes(desc_id),
        _cast_tuple_ImVec4(col),
        flags,
        _cast_tuple_ImVec2(size)
...
def color_convert_float4_to_u32(in_: tuple):
    cdef ccimgui_db.ImU32 res = ccimgui_db.ImGui_ColorConvertFloat4ToU32(
...
def color_convert_hsv_to_rgb(h: float, s: float, v: float, out_r: FloatPtr, out_g: FloatPtr, out_b: FloatPtr):
    ccimgui_db.ImGui_ColorConvertHSVtoRGB(
        h,
        s,
        v,
        &out_r.value,
...
def color_convert_rgb_to_hsv(r: float, g: float, b: float, out_h: FloatPtr, out_s: FloatPtr, out_v: FloatPtr):
    ccimgui_db.ImGui_ColorConvertRGBtoHSV(
        r,
        g,
        b,
        &out_h.value,
...
def color_convert_u32_to_float4(in_: int):
    ...
    Color Utilities
    """
    cdef ccimgui_db.ImVec4 res = ccimgui_db.ImGui_ColorConvertU32ToFloat4(
        in_
    )
...
def color_edit3(label: str, col: Sequence[FloatPtr], flags: int=0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_ColorEdit3(
        _bytes(label),
        &col.value,
        flags
    )
...
def color_edit4(label: str, col: Sequence[FloatPtr], flags: int=0):
    cdef bool res = ccimgui_db.ImGui_ColorEdit4(
        _bytes(label),
        &col.value,
        flags
    )
...
def color_picker3(label: str, col: Sequence[FloatPtr], flags: int=0):
    cdef bool res = ccimgui_db.ImGui_ColorPicker3(
        _bytes(label),
        &col.value,
        flags
    )
...
def color_picker4(label: str, col: Sequence[FloatPtr], flags: int=0, ref_col: FloatPtr=None):
    cdef bool res = ccimgui_db.ImGui_ColorPicker4(
        _bytes(label),
        &col.value,
        flags,
        &ref_col.value
...
def combo(label: str, current_item: IntPtr, items_separated_by_zeros: str):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_Combo(
        _bytes(label),
        &current_item.value,
...
def combo_callback(label: str, current_item: IntPtr, items_getter: Callable, data: Any, items_count: int):
    ...
    Implied popup_max_height_in_items = -1
    """
    cdef bool res = ccimgui_db.ImGui_ComboCallback(
        _bytes(label),
        &current_item.value,
        items_getter,
        data,
...
def combo_callback_ex(label: str, current_item: IntPtr, items_getter: Callable, data: Any, items_count: int, popup_max_height_in_items: int=-1):
    cdef bool res = ccimgui_db.ImGui_ComboCallbackEx(
        _bytes(label),
        &current_item.value,
        items_getter,
        data,
...
def combo_char(label: str, current_item: IntPtr, items: str, items_count: int):
    ...
    Implied popup_max_height_in_items = -1
    """
    cdef bool res = ccimgui_db.ImGui_ComboChar(
        _bytes(label),
        &current_item.value,
        _bytes(items),
        items_count
...
def combo_char_ex(label: str, current_item: IntPtr, items: str, items_count: int, popup_max_height_in_items: int=-1):
    cdef bool res = ccimgui_db.ImGui_ComboCharEx(
        _bytes(label),
        &current_item.value,
        _bytes(items),
        items_count,
...
def combo_ex(label: str, current_item: IntPtr, items_separated_by_zeros: str, popup_max_height_in_items: int=-1):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_ComboEx(
        _bytes(label),
        &current_item.value,
        _bytes(items_separated_by_zeros),
        popup_max_height_in_items
...
def debug_check_version_and_data_layout(version_str: str, sz_io: Any, sz_style: Any, sz_vec2: Any, sz_vec4: Any, sz_drawvert: Any, sz_drawidx: Any):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_DebugCheckVersionAndDataLayout(
        _bytes(version_str),
        sz_io,
        sz_style,
        sz_vec2,
...
def debug_text_encoding(text: str):
    ...
    Debug Utilities
    """
    ccimgui_db.ImGui_DebugTextEncoding(
        _bytes(text)
    )
# [End Function]
...
def destroy_platform_windows():
    ...
    """
    ccimgui_db.ImGui_DestroyPlatformWindows()
# [End Function]
...
def dock_space(id_: int):
    ...
    """
    cdef ccimgui_db.ImGuiID res = ccimgui_db.ImGui_DockSpace(
        id_
    )
    return res
# [End Function]
...
def dock_space_ex(id_: int, size: tuple=(0, 0), flags: int=0, window_class: ImGuiWindowClass=None):
    cdef ccimgui_db.ImGuiID res = ccimgui_db.ImGui_DockSpaceEx(
        id_,
        _cast_tuple_ImVec2(size),
        flags,
        window_class._ptr
...
def dock_space_over_viewport():
    ...
    """
    cdef ccimgui_db.ImGuiID res = ccimgui_db.ImGui_DockSpaceOverViewport()
    return res
# [End Function]
...
def drag_float(label: str, v: FloatPtr):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_DragFloat(
        _bytes(label),
        &v.value
    )
    return res
...
def drag_float2(label: str, v: Sequence[FloatPtr]):
    ...
    Implied v_speed = 1.0f, v_min = 0.0f, v_max = 0.0f, format = '%.3f', flags = 0
    """
    cdef bool res = ccimgui_db.ImGui_DragFloat2(
        _bytes(label),
        &v.value
    )
    return res
...
def drag_float2_ex(label: str, v: Sequence[FloatPtr], v_speed: float=1.0, v_min: float=0.0, v_max: float=0.0, format_: str="%.3f", flags: int=0):
    cdef bool res = ccimgui_db.ImGui_DragFloat2Ex(
        _bytes(label),
        &v.value,
        v_speed,
        v_min,
...
def drag_float3(label: str, v: Sequence[FloatPtr]):
    ...
    Implied v_speed = 1.0f, v_min = 0.0f, v_max = 0.0f, format = '%.3f', flags = 0
    """
    cdef bool res = ccimgui_db.ImGui_DragFloat3(
        _bytes(label),
        &v.value
    )
    return res
...
def drag_float3_ex(label: str, v: Sequence[FloatPtr], v_speed: float=1.0, v_min: float=0.0, v_max: float=0.0, format_: str="%.3f", flags: int=0):
    cdef bool res = ccimgui_db.ImGui_DragFloat3Ex(
        _bytes(label),
        &v.value,
        v_speed,
        v_min,
...
def drag_float4(label: str, v: Sequence[FloatPtr]):
    ...
    Implied v_speed = 1.0f, v_min = 0.0f, v_max = 0.0f, format = '%.3f', flags = 0
    """
    cdef bool res = ccimgui_db.ImGui_DragFloat4(
        _bytes(label),
        &v.value
    )
    return res
...
def drag_float4_ex(label: str, v: Sequence[FloatPtr], v_speed: float=1.0, v_min: float=0.0, v_max: float=0.0, format_: str="%.3f", flags: int=0):
    cdef bool res = ccimgui_db.ImGui_DragFloat4Ex(
        _bytes(label),
        &v.value,
        v_speed,
        v_min,
...
def drag_float_ex(label: str, v: FloatPtr, v_speed: float=1.0, v_min: float=0.0, v_max: float=0.0, format_: str="%.3f", flags: int=0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_DragFloatEx(
        _bytes(label),
        &v.value,
        v_speed,
        v_min,
...
def drag_float_range2(label: str, v_current_min: FloatPtr, v_current_max: FloatPtr):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_DragFloatRange2(
        _bytes(label),
        &v_current_min.value,
        &v_current_max.value
    )
...
def drag_float_range2_ex(label: str, v_current_min: FloatPtr, v_current_max: FloatPtr, v_speed: float=1.0, v_min: float=0.0, v_max: float=0.0, format_: str="%.3f", format_max: str=None, flags: int=0):
    cdef bool res = ccimgui_db.ImGui_DragFloatRange2Ex(
        _bytes(label),
        &v_current_min.value,
        &v_current_max.value,
        v_speed,
...
def drag_int(label: str, v: IntPtr):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_DragInt(
        _bytes(label),
        &v.value
    )
    return res
...
def drag_int2(label: str, v: Sequence[IntPtr]):
    ...
    Implied v_speed = 1.0f, v_min = 0, v_max = 0, format = '%d', flags = 0
    """
    cdef bool res = ccimgui_db.ImGui_DragInt2(
        _bytes(label),
        &v.value
    )
    return res
...
def drag_int2_ex(label: str, v: Sequence[IntPtr], v_speed: float=1.0, v_min: int=0, v_max: int=0, format_: str="%d", flags: int=0):
    cdef bool res = ccimgui_db.ImGui_DragInt2Ex(
        _bytes(label),
        &v.value,
        v_speed,
        v_min,
...
def drag_int3(label: str, v: Sequence[IntPtr]):
    ...
    Implied v_speed = 1.0f, v_min = 0, v_max = 0, format = '%d', flags = 0
    """
    cdef bool res = ccimgui_db.ImGui_DragInt3(
        _bytes(label),
        &v.value
    )
    return res
...
def drag_int3_ex(label: str, v: Sequence[IntPtr], v_speed: float=1.0, v_min: int=0, v_max: int=0, format_: str="%d", flags: int=0):
    cdef bool res = ccimgui_db.ImGui_DragInt3Ex(
        _bytes(label),
        &v.value,
        v_speed,
        v_min,
...
def drag_int4(label: str, v: Sequence[IntPtr]):
    ...
    Implied v_speed = 1.0f, v_min = 0, v_max = 0, format = '%d', flags = 0
    """
    cdef bool res = ccimgui_db.ImGui_DragInt4(
        _bytes(label),
        &v.value
    )
    return res
...
def drag_int4_ex(label: str, v: Sequence[IntPtr], v_speed: float=1.0, v_min: int=0, v_max: int=0, format_: str="%d", flags: int=0):
    cdef bool res = ccimgui_db.ImGui_DragInt4Ex(
        _bytes(label),
        &v.value,
        v_speed,
        v_min,
...
def drag_int_ex(label: str, v: IntPtr, v_speed: float=1.0, v_min: int=0, v_max: int=0, format_: str="%d", flags: int=0):
    ...
    If v_min >= v_max we have no bound
    """
    cdef bool res = ccimgui_db.ImGui_DragIntEx(
        _bytes(label),
        &v.value,
        v_speed,
        v_min,
...
def drag_int_range2(label: str, v_current_min: IntPtr, v_current_max: IntPtr):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_DragIntRange2(
        _bytes(label),
        &v_current_min.value,
        &v_current_max.value
    )
...
def drag_int_range2_ex(label: str, v_current_min: IntPtr, v_current_max: IntPtr, v_speed: float=1.0, v_min: int=0, v_max: int=0, format_: str="%d", format_max: str=None, flags: int=0):
    cdef bool res = ccimgui_db.ImGui_DragIntRange2Ex(
        _bytes(label),
        &v_current_min.value,
        &v_current_max.value,
        v_speed,
...
def drag_scalar(label: str, data_type: int, p_data: Any):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_DragScalar(
        _bytes(label),
        data_type,
        p_data
    )
...
def drag_scalar_ex(label: str, data_type: int, p_data: Any, v_speed: float=1.0, p_min: Any=None, p_max: Any=None, format_: str=None, flags: int=0):
    cdef bool res = ccimgui_db.ImGui_DragScalarEx(
        _bytes(label),
        data_type,
        p_data,
        v_speed,
...
def drag_scalar_n(label: str, data_type: int, p_data: Any, components: int):
    ...
    Implied v_speed = 1.0f, p_min = null, p_max = null, format = null, flags = 0
    """
    cdef bool res = ccimgui_db.ImGui_DragScalarN(
        _bytes(label),
        data_type,
        p_data,
        components
...
def drag_scalar_ne_x(label: str, data_type: int, p_data: Any, components: int, v_speed: float=1.0, p_min: Any=None, p_max: Any=None, format_: str=None, flags: int=0):
    cdef bool res = ccimgui_db.ImGui_DragScalarNEx(
        _bytes(label),
        data_type,
        p_data,
        components,
...
def end_child_frame():
    ...
    """
    ccimgui_db.ImGui_EndChildFrame()
# [End Function]
...
def end_drag_drop_source():
    ...
    """
    ccimgui_db.ImGui_EndDragDropSource()
# [End Function]
...
def end_drag_drop_target():
    ...
    """
    ccimgui_db.ImGui_EndDragDropTarget()
# [End Function]
...
def end_main_menu_bar():
    ...
    """
    ccimgui_db.ImGui_EndMainMenuBar()
# [End Function]
...
def find_viewport_by_id(id_: int):
    ...
    """
    cdef ccimgui_db.ImGuiViewport* res = ccimgui_db.ImGui_FindViewportByID(
        id_
    )
...
def find_viewport_by_platform_handle(platform_handle: Any):
    ...
    """
    cdef ccimgui_db.ImGuiViewport* res = ccimgui_db.ImGui_FindViewportByPlatformHandle(
        platform_handle
    )
    return ImGuiViewport.from_ptr(res)
# [End Function]
...
def get_allocator_functions(p_alloc_func: Callable, p_free_func: Callable, p_user_data: Any):
    ccimgui_db.ImGui_GetAllocatorFunctions(
        p_alloc_func,
        p_free_func,
        p_user_data
    )
...
def get_background_draw_list():
    ...
    """
    cdef ccimgui_db.ImDrawList* res = ccimgui_db.ImGui_GetBackgroundDrawList()
...
def get_clipboard_text():
    ...
    """
    cdef const char* res = ccimgui_db.ImGui_GetClipboardText()
...
def get_color_u32(idx: int):
    ...
    """
    cdef ccimgui_db.ImU32 res = ccimgui_db.ImGui_GetColorU32(
        idx
    )
    return res
# [End Function]
...
def get_color_u32_ex(idx: int, alpha_mul: float=1.0):
    ...
    """
    cdef ccimgui_db.ImU32 res = ccimgui_db.ImGui_GetColorU32Ex(
        idx,
        alpha_mul
    )
    return res
...
def get_color_u32_im_u32(col: int):
    ...
    """
    cdef ccimgui_db.ImU32 res = ccimgui_db.ImGui_GetColorU32ImU32(
        col
    )
    return res
# [End Function]
...
def get_color_u32_im_vec4(col: tuple):
    ...
    Retrieve given color with style alpha applied, packed as a 32-bit value suitable for imdrawlist
    """
    cdef ccimgui_db.ImU32 res = ccimgui_db.ImGui_GetColorU32ImVec4(
        _cast_tuple_ImVec4(col)
    )
    return res
# [End Function]
...
def get_column_index():
    ...
    """
    cdef int res = ccimgui_db.ImGui_GetColumnIndex()
    return res
# [End Function]
...
def get_column_offset(column_index: int=-1):
    ...
    """
    cdef float res = ccimgui_db.ImGui_GetColumnOffset(
        column_index
    )
    return res
# [End Function]
...
def get_column_width(column_index: int=-1):
    ...
    """
    cdef float res = ccimgui_db.ImGui_GetColumnWidth(
        column_index
    )
    return res
# [End Function]
...
def get_columns_count():
    cdef int res = ccimgui_db.ImGui_GetColumnsCount()
    return res
# [End Function]
...
def get_content_region_avail():
    ...
    """
    cdef ccimgui_db.ImVec2 res = ccimgui_db.ImGui_GetContentRegionAvail()
    return _cast_ImVec2_tuple(res)
# [End Function]
...
def get_content_region_max():
    ...
    """
    cdef ccimgui_db.ImVec2 res = ccimgui_db.ImGui_GetContentRegionMax()
    return _cast_ImVec2_tuple(res)
# [End Function]
...
def get_current_context():
    cdef ccimgui_db.ImGuiContext* res = ccimgui_db.ImGui_GetCurrentContext()
    return ImGuiContext.from_ptr(res)
# [End Function]
...
def get_cursor_pos():
    ...
    """
    cdef ccimgui_db.ImVec2 res = ccimgui_db.ImGui_GetCursorPos()
    return _cast_ImVec2_tuple(res)
# [End Function]
...
def get_cursor_pos_x():
    ...
    """
    cdef float res = ccimgui_db.ImGui_GetCursorPosX()
    return res
# [End Function]
...
def get_cursor_pos_y():
    ...
    """
    cdef float res = ccimgui_db.ImGui_GetCursorPosY()
    return res
# [End Function]
...
def get_cursor_screen_pos():
    ...
    """
    cdef ccimgui_db.ImVec2 res = ccimgui_db.ImGui_GetCursorScreenPos()
    return _cast_ImVec2_tuple(res)
# [End Function]
...
def get_cursor_start_pos():
    ...
    """
    cdef ccimgui_db.ImVec2 res = ccimgui_db.ImGui_GetCursorStartPos()
    return _cast_ImVec2_tuple(res)
# [End Function]
...
def get_drag_drop_payload():
    ...
    """
    cdef ccimgui_db.ImGuiPayload* res = ccimgui_db.ImGui_GetDragDropPayload()
    return ImGuiPayload.from_ptr(res)
# [End Function]
...
def get_draw_list_shared_data():
    ...
    """
    cdef ccimgui_db.ImDrawListSharedData* res = ccimgui_db.ImGui_GetDrawListSharedData()
...
def get_font():
    ...
    Get current font
    """
    cdef ccimgui_db.ImFont* res = ccimgui_db.ImGui_GetFont()
...
def get_font_size():
    ...
    """
    cdef float res = ccimgui_db.ImGui_GetFontSize()
    return res
# [End Function]
...
def get_font_tex_uv_white_pixel():
    ...
    """
    cdef ccimgui_db.ImVec2 res = ccimgui_db.ImGui_GetFontTexUvWhitePixel()
    return _cast_ImVec2_tuple(res)
# [End Function]
...
def get_foreground_draw_list():
    ...
    """
    cdef ccimgui_db.ImDrawList* res = ccimgui_db.ImGui_GetForegroundDrawList()
    return ImDrawList.from_ptr(res)
# [End Function]
...
def get_frame_count():
    ...
    """
    cdef int res = ccimgui_db.ImGui_GetFrameCount()
    return res
# [End Function]
...
def get_frame_height():
    ...
    """
    cdef float res = ccimgui_db.ImGui_GetFrameHeight()
    return res
# [End Function]
...
def get_frame_height_with_spacing():
    ...
    """
    cdef float res = ccimgui_db.ImGui_GetFrameHeightWithSpacing()
    return res
# [End Function]
...
def get_id(str_id: str):
    ...
    """
    cdef ccimgui_db.ImGuiID res = ccimgui_db.ImGui_GetID(
        _bytes(str_id)
    )
    return res
# [End Function]
...
def get_idp_tr(ptr_id: Any):
    cdef ccimgui_db.ImGuiID res = ccimgui_db.ImGui_GetIDPtr(
        ptr_id
    )
    return res
# [End Function]
...
def get_ids_tr(str_id_begin: str, str_id_end: str):
    cdef ccimgui_db.ImGuiID res = ccimgui_db.ImGui_GetIDStr(
        _bytes(str_id_begin),
        _bytes(str_id_end)
    )
    return res
...
def get_item_id():
    ...
    """
    cdef ccimgui_db.ImGuiID res = ccimgui_db.ImGui_GetItemID()
    return res
# [End Function]
...
def get_item_rect_max():
    ...
    """
    cdef ccimgui_db.ImVec2 res = ccimgui_db.ImGui_GetItemRectMax()
    return _cast_ImVec2_tuple(res)
# [End Function]
...
def get_item_rect_min():
    ...
    """
    cdef ccimgui_db.ImVec2 res = ccimgui_db.ImGui_GetItemRectMin()
    return _cast_ImVec2_tuple(res)
# [End Function]
...
def get_item_rect_size():
    ...
    """
    cdef ccimgui_db.ImVec2 res = ccimgui_db.ImGui_GetItemRectSize()
    return _cast_ImVec2_tuple(res)
# [End Function]
...
def get_key_index(key: int):
    cdef ccimgui_db.ImGuiKey res = ccimgui_db.GetKeyIndex(
        key
    )
    return res
# [End Function]
...
def get_key_name(key: int):
    ...
    """
    cdef const char* res = ccimgui_db.ImGui_GetKeyName(
        key
    )
    return _from_bytes(res)
# [End Function]
...
def get_key_pressed_amount(key: int, repeat_delay: float, rate: float):
    ...
    """
    cdef int res = ccimgui_db.ImGui_GetKeyPressedAmount(
        key,
        repeat_delay,
        rate
    )
...
def get_main_viewport():
    ...
    """
    cdef ccimgui_db.ImGuiViewport* res = ccimgui_db.ImGui_GetMainViewport()
    return ImGuiViewport.from_ptr(res)
# [End Function]
...
def get_mouse_clicked_count(button: int):
    ...
    """
    cdef int res = ccimgui_db.ImGui_GetMouseClickedCount(
        button
    )
    return res
# [End Function]
...
def get_mouse_cursor():
    ...
    """
    cdef ccimgui_db.ImGuiMouseCursor res = ccimgui_db.ImGui_GetMouseCursor()
    return res
# [End Function]
...
def get_mouse_drag_delta(button: int=0, lock_threshold: float=-1.0):
    ...
    """
    cdef ccimgui_db.ImVec2 res = ccimgui_db.ImGui_GetMouseDragDelta(
        button,
        lock_threshold
    )
    return _cast_ImVec2_tuple(res)
...
def get_mouse_pos():
    ...
    """
    cdef ccimgui_db.ImVec2 res = ccimgui_db.ImGui_GetMousePos()
    return _cast_ImVec2_tuple(res)
# [End Function]
...
def get_mouse_pos_on_opening_current_popup():
    ...
    """
    cdef ccimgui_db.ImVec2 res = ccimgui_db.ImGui_GetMousePosOnOpeningCurrentPopup()
    return _cast_ImVec2_tuple(res)
# [End Function]
...
def get_platform_io():
    ...
    """
    cdef ccimgui_db.ImGuiPlatformIO* res = ccimgui_db.ImGui_GetPlatformIO()
...
def get_scroll_max_x():
    ...
    """
    cdef float res = ccimgui_db.ImGui_GetScrollMaxX()
    return res
# [End Function]
...
def get_scroll_max_y():
    ...
    """
    cdef float res = ccimgui_db.ImGui_GetScrollMaxY()
    return res
# [End Function]
...
def get_scroll_x():
    ...
    """
    cdef float res = ccimgui_db.ImGui_GetScrollX()
    return res
# [End Function]
...
def get_scroll_y():
    ...
    """
    cdef float res = ccimgui_db.ImGui_GetScrollY()
    return res
# [End Function]
...
def get_state_storage():
    cdef ccimgui_db.ImGuiStorage* res = ccimgui_db.ImGui_GetStateStorage()
...
def get_style():
    ...
    """
    cdef ccimgui_db.ImGuiStyle* res = ccimgui_db.ImGui_GetStyle()
...
def get_style_color_name(idx: int):
    ...
    """
    cdef const char* res = ccimgui_db.ImGui_GetStyleColorName(
        idx
    )
    return _from_bytes(res)
# [End Function]
...
def get_style_color_vec4(idx: int):
    ...
    """
    cdef ccimgui_db.ImVec4* res = ccimgui_db.ImGui_GetStyleColorVec4(
        idx
    )
...
def get_text_line_height():
    ...
    ~ fontsize
    """
    cdef float res = ccimgui_db.ImGui_GetTextLineHeight()
    return res
# [End Function]
...
def get_text_line_height_with_spacing():
    ...
    """
    cdef float res = ccimgui_db.ImGui_GetTextLineHeightWithSpacing()
    return res
# [End Function]
...
def get_time():
    ...
    """
    cdef double res = ccimgui_db.ImGui_GetTime()
    return res
# [End Function]
...
def get_tree_node_to_label_spacing():
    ...
    """
    cdef float res = ccimgui_db.ImGui_GetTreeNodeToLabelSpacing()
    return res
# [End Function]
...
def get_window_content_region_max():
    ...
    """
    cdef ccimgui_db.ImVec2 res = ccimgui_db.ImGui_GetWindowContentRegionMax()
    return _cast_ImVec2_tuple(res)
# [End Function]
...
def get_window_content_region_min():
    ...
    """
    cdef ccimgui_db.ImVec2 res = ccimgui_db.ImGui_GetWindowContentRegionMin()
    return _cast_ImVec2_tuple(res)
# [End Function]
...
def get_window_dock_id():
    cdef ccimgui_db.ImGuiID res = ccimgui_db.ImGui_GetWindowDockID()
    return res
# [End Function]
...
def get_window_dpi_scale():
    ...
    """
    cdef float res = ccimgui_db.ImGui_GetWindowDpiScale()
    return res
# [End Function]
...
def get_window_draw_list():
    ...
    """
    cdef ccimgui_db.ImDrawList* res = ccimgui_db.ImGui_GetWindowDrawList()
    return ImDrawList.from_ptr(res)
# [End Function]
...
def get_window_height():
    ...
    """
    cdef float res = ccimgui_db.ImGui_GetWindowHeight()
    return res
# [End Function]
...
def get_window_pos():
    ...
    """
    cdef ccimgui_db.ImVec2 res = ccimgui_db.ImGui_GetWindowPos()
    return _cast_ImVec2_tuple(res)
# [End Function]
...
def get_window_size():
    ...
    """
    cdef ccimgui_db.ImVec2 res = ccimgui_db.ImGui_GetWindowSize()
    return _cast_ImVec2_tuple(res)
# [End Function]
...
def get_window_viewport():
    ...
    """
    cdef ccimgui_db.ImGuiViewport* res = ccimgui_db.ImGui_GetWindowViewport()
    return ImGuiViewport.from_ptr(res)
# [End Function]
...
def get_window_width():
    ...
    """
    cdef float res = ccimgui_db.ImGui_GetWindowWidth()
    return res
# [End Function]
...
def image_button(str_id: str, user_texture_id: Any, size: tuple):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_ImageButton(
        _bytes(str_id),
        user_texture_id,
        _cast_tuple_ImVec2(size)
    )
...
def image_button_ex(str_id: str, user_texture_id: Any, size: tuple, uv0: tuple=(0, 0), uv1: tuple=(1, 1), bg_col: tuple=(0, 0, 0, 0), tint_col: tuple=(1, 1, 1, 1)):
    cdef bool res = ccimgui_db.ImGui_ImageButtonEx(
        _bytes(str_id),
        user_texture_id,
        _cast_tuple_ImVec2(size),
...
def input_double(label: str, v: DoublePtr):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_InputDouble(
        _bytes(label),
        &v.value
    )
    return res
...
def input_double_ex(label: str, v: DoublePtr, step: float=0.0, step_fast: float=0.0, format_: str="%.6f", flags: int=0):
    cdef bool res = ccimgui_db.ImGui_InputDoubleEx(
        _bytes(label),
        &v.value,
        step,
        step_fast,
...
def input_float(label: str, v: FloatPtr):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_InputFloat(
        _bytes(label),
        &v.value
    )
    return res
...
def input_float2(label: str, v: Sequence[FloatPtr]):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_InputFloat2(
        _bytes(label),
        &v.value
    )
    return res
...
def input_float2_ex(label: str, v: Sequence[FloatPtr], format_: str="%.3f", flags: int=0):
    cdef bool res = ccimgui_db.ImGui_InputFloat2Ex(
        _bytes(label),
        &v.value,
        _bytes(format_),
        flags
...
def input_float3(label: str, v: Sequence[FloatPtr]):
    ...
    Implied format = '%.3f', flags = 0
    """
    cdef bool res = ccimgui_db.ImGui_InputFloat3(
        _bytes(label),
        &v.value
    )
    return res
...
def input_float3_ex(label: str, v: Sequence[FloatPtr], format_: str="%.3f", flags: int=0):
    cdef bool res = ccimgui_db.ImGui_InputFloat3Ex(
        _bytes(label),
        &v.value,
        _bytes(format_),
        flags
...
def input_float4(label: str, v: Sequence[FloatPtr]):
    ...
    Implied format = '%.3f', flags = 0
    """
    cdef bool res = ccimgui_db.ImGui_InputFloat4(
        _bytes(label),
        &v.value
    )
    return res
...
def input_float4_ex(label: str, v: Sequence[FloatPtr], format_: str="%.3f", flags: int=0):
    cdef bool res = ccimgui_db.ImGui_InputFloat4Ex(
        _bytes(label),
        &v.value,
        _bytes(format_),
        flags
...
def input_float_ex(label: str, v: FloatPtr, step: float=0.0, step_fast: float=0.0, format_: str="%.3f", flags: int=0):
    cdef bool res = ccimgui_db.ImGui_InputFloatEx(
        _bytes(label),
        &v.value,
        step,
        step_fast,
...
def input_int(label: str, v: IntPtr):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_InputInt(
        _bytes(label),
        &v.value
    )
    return res
...
def input_int2(label: str, v: Sequence[IntPtr], flags: int=0):
    cdef bool res = ccimgui_db.ImGui_InputInt2(
        _bytes(label),
        &v.value,
        flags
    )
...
def input_int3(label: str, v: Sequence[IntPtr], flags: int=0):
    cdef bool res = ccimgui_db.ImGui_InputInt3(
        _bytes(label),
        &v.value,
        flags
    )
...
def input_int4(label: str, v: Sequence[IntPtr], flags: int=0):
    cdef bool res = ccimgui_db.ImGui_InputInt4(
        _bytes(label),
        &v.value,
        flags
    )
...
def input_int_ex(label: str, v: IntPtr, step: int=1, step_fast: int=100, flags: int=0):
    cdef bool res = ccimgui_db.ImGui_InputIntEx(
        _bytes(label),
        &v.value,
        step,
        step_fast,
...
def input_scalar(label: str, data_type: int, p_data: Any):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_InputScalar(
        _bytes(label),
        data_type,
        p_data
    )
...
def input_scalar_ex(label: str, data_type: int, p_data: Any, p_step: Any=None, p_step_fast: Any=None, format_: str=None, flags: int=0):
    cdef bool res = ccimgui_db.ImGui_InputScalarEx(
        _bytes(label),
        data_type,
        p_data,
        p_step,
...
def input_scalar_n(label: str, data_type: int, p_data: Any, components: int):
    ...
    Implied p_step = null, p_step_fast = null, format = null, flags = 0
    """
    cdef bool res = ccimgui_db.ImGui_InputScalarN(
        _bytes(label),
        data_type,
        p_data,
        components
...
def input_scalar_ne_x(label: str, data_type: int, p_data: Any, components: int, p_step: Any=None, p_step_fast: Any=None, format_: str=None, flags: int=0):
    cdef bool res = ccimgui_db.ImGui_InputScalarNEx(
        _bytes(label),
        data_type,
        p_data,
        components,
...
def input_text(label: str, buf: str, buf_size: Any, flags: int=0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_InputText(
        _bytes(label),
        _bytes(buf),
        buf_size,
        flags
...
def input_text_ex(label: str, buf: str, buf_size: Any, flags: int=0, callback: Callable=None, user_data: Any=None):
    cdef bool res = ccimgui_db.ImGui_InputTextEx(
        _bytes(label),
        _bytes(buf),
        buf_size,
        flags,
...
def input_text_multiline(label: str, buf: str, buf_size: Any):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_InputTextMultiline(
        _bytes(label),
        _bytes(buf),
        buf_size
    )
...
def input_text_multiline_ex(label: str, buf: str, buf_size: Any, size: tuple=(0, 0), flags: int=0, callback: Callable=None, user_data: Any=None):
    cdef bool res = ccimgui_db.ImGui_InputTextMultilineEx(
        _bytes(label),
        _bytes(buf),
        buf_size,
        _cast_tuple_ImVec2(size),
...
def input_text_with_hint(label: str, hint: str, buf: str, buf_size: Any, flags: int=0):
    ...
    Implied callback = null, user_data = null
    """
    cdef bool res = ccimgui_db.ImGui_InputTextWithHint(
        _bytes(label),
        _bytes(hint),
        _bytes(buf),
        buf_size,
...
def input_text_with_hint_ex(label: str, hint: str, buf: str, buf_size: Any, flags: int=0, callback: Callable=None, user_data: Any=None):
    cdef bool res = ccimgui_db.ImGui_InputTextWithHintEx(
        _bytes(label),
        _bytes(hint),
        _bytes(buf),
        buf_size,
...
def invisible_button(str_id: str, size: tuple, flags: int=0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_InvisibleButton(
        _bytes(str_id),
        _cast_tuple_ImVec2(size),
        flags
    )
...
def is_any_item_active():
    ...
    Is any item active?
    """
    cdef bool res = ccimgui_db.ImGui_IsAnyItemActive()
    return res
# [End Function]
...
def is_any_item_focused():
    ...
    Is any item focused?
    """
    cdef bool res = ccimgui_db.ImGui_IsAnyItemFocused()
    return res
# [End Function]
...
def is_any_item_hovered():
    ...
    Is any item hovered?
    """
    cdef bool res = ccimgui_db.ImGui_IsAnyItemHovered()
    return res
# [End Function]
...
def is_any_mouse_down():
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsAnyMouseDown()
    return res
# [End Function]
...
def is_item_activated():
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsItemActivated()
    return res
# [End Function]
...
def is_item_active():
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsItemActive()
    return res
# [End Function]
...
def is_item_clicked():
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsItemClicked()
    return res
# [End Function]
...
def is_item_clicked_ex(mouse_button: int=0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsItemClickedEx(
        mouse_button
    )
    return res
# [End Function]
...
def is_item_deactivated():
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsItemDeactivated()
    return res
# [End Function]
...
def is_item_deactivated_after_edit():
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsItemDeactivatedAfterEdit()
    return res
# [End Function]
...
def is_item_edited():
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsItemEdited()
    return res
# [End Function]
...
def is_item_focused():
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsItemFocused()
    return res
# [End Function]
...
def is_item_hovered(flags: int=0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsItemHovered(
        flags
    )
    return res
# [End Function]
...
def is_item_toggled_open():
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsItemToggledOpen()
    return res
# [End Function]
...
def is_item_visible():
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsItemVisible()
    return res
# [End Function]
...
def is_key_down(key: int):
    ...
    Is key being held.
    """
    cdef bool res = ccimgui_db.ImGui_IsKeyDown(
        key
    )
    return res
# [End Function]
...
def is_key_pressed(key: int):
    ...
    Implied repeat = true
    """
    cdef bool res = ccimgui_db.ImGui_IsKeyPressed(
        key
    )
    return res
# [End Function]
...
def is_key_pressed_ex(key: int, repeat: bool=True):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsKeyPressedEx(
        key,
        repeat
    )
    return res
...
def is_key_released(key: int):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsKeyReleased(
        key
    )
    return res
# [End Function]
...
def is_mouse_clicked(button: int):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsMouseClicked(
        button
    )
    return res
# [End Function]
...
def is_mouse_clicked_ex(button: int, repeat: bool=False):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsMouseClickedEx(
        button,
        repeat
    )
    return res
...
def is_mouse_double_clicked(button: int):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsMouseDoubleClicked(
        button
    )
    return res
# [End Function]
...
def is_mouse_down(button: int):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsMouseDown(
        button
    )
    return res
# [End Function]
...
def is_mouse_dragging(button: int, lock_threshold: float=-1.0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsMouseDragging(
        button,
        lock_threshold
    )
    return res
...
def is_mouse_hovering_rect(r_min: tuple, r_max: tuple):
    ...
    Implied clip = true
    """
    cdef bool res = ccimgui_db.ImGui_IsMouseHoveringRect(
...
def is_mouse_hovering_rect_ex(r_min: tuple, r_max: tuple, clip: bool=True):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsMouseHoveringRectEx(
        _cast_tuple_ImVec2(r_min),
        _cast_tuple_ImVec2(r_max),
        clip
    )
...
def is_mouse_released(button: int):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsMouseReleased(
        button
    )
    return res
# [End Function]
...
def is_popup_open(str_id: str, flags: int=0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsPopupOpen(
        _bytes(str_id),
        flags
    )
    return res
...
def is_rect_visible(rect_min: tuple, rect_max: tuple):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsRectVisible(
...
def is_rect_visible_by_size(size: tuple):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsRectVisibleBySize(
        _cast_tuple_ImVec2(size)
    )
    return res
# [End Function]
...
def is_window_appearing():
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsWindowAppearing()
    return res
# [End Function]
...
def is_window_collapsed():
    cdef bool res = ccimgui_db.ImGui_IsWindowCollapsed()
    return res
# [End Function]
...
def is_window_docked():
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsWindowDocked()
    return res
# [End Function]
...
def is_window_focused(flags: int=0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsWindowFocused(
        flags
    )
    return res
# [End Function]
...
def is_window_hovered(flags: int=0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_IsWindowHovered(
        flags
    )
    return res
# [End Function]
...
def list_box(label: str, current_item: IntPtr, items: str, items_count: int, height_in_items: int=-1):
    cdef bool res = ccimgui_db.ImGui_ListBox(
        _bytes(label),
        &current_item.value,
        _bytes(items),
        items_count,
...
def list_box_callback(label: str, current_item: IntPtr, items_getter: Callable, data: Any, items_count: int):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_ListBoxCallback(
        _bytes(label),
        &current_item.value,
        items_getter,
        data,
...
def list_box_callback_ex(label: str, current_item: IntPtr, items_getter: Callable, data: Any, items_count: int, height_in_items: int=-1):
    cdef bool res = ccimgui_db.ImGui_ListBoxCallbackEx(
        _bytes(label),
        &current_item.value,
        items_getter,
        data,
...
def load_ini_settings_from_disk(ini_filename: str):
    ...
    """
    ccimgui_db.ImGui_LoadIniSettingsFromDisk(
        _bytes(ini_filename)
    )
# [End Function]
...
def load_ini_settings_from_memory(ini_data: str, ini_size: Any=0):
    ...
    """
    ccimgui_db.ImGui_LoadIniSettingsFromMemory(
        _bytes(ini_data),
        ini_size
    )
# [End Function]
...
def log_to_clipboard(auto_open_depth: int=-1):
    ...
    """
    ccimgui_db.ImGui_LogToClipboard(
        auto_open_depth
    )
# [End Function]
...
def mem_alloc(size: Any):
    cdef void* res = ccimgui_db.ImGui_MemAlloc(
        size
    )
    return res
# [End Function]
...
def menu_item(label: str):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_MenuItem(
        _bytes(label)
    )
    return res
# [End Function]
...
def menu_item_bool_ptr(label: str, shortcut: str, p_selected: BoolPtr, enabled: bool=True):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_MenuItemBoolPtr(
        _bytes(label),
        _bytes(shortcut),
        &p_selected.value,
        enabled
...
def menu_item_ex(label: str, shortcut: str=None, selected: bool=False, enabled: bool=True):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_MenuItemEx(
        _bytes(label),
        _bytes(shortcut),
        selected,
        enabled
...
def open_popup_on_item_click(str_id: str=None, popup_flags: int=1):
    ...
    """
    ccimgui_db.ImGui_OpenPopupOnItemClick(
        _bytes(str_id),
        popup_flags
    )
# [End Function]
...
def plot_histogram(label: str, values: FloatPtr, values_count: int):
    ...
    """
    ccimgui_db.ImGui_PlotHistogram(
        _bytes(label),
        &values.value,
        values_count
    )
...
def plot_histogram_callback(label: str, values_getter: Callable, data: Any, values_count: int):
    ...
    """
    ccimgui_db.ImGui_PlotHistogramCallback(
        _bytes(label),
        values_getter,
        data,
        values_count
...
def plot_histogram_callback_ex(label: str, values_getter: Callable, data: Any, values_count: int, values_offset: int=0, overlay_text: str=None, scale_min: float=FLT_MAX, scale_max: float=FLT_MAX, graph_size: tuple=(0, 0)):
    ccimgui_db.ImGui_PlotHistogramCallbackEx(
        _bytes(label),
        values_getter,
        data,
        values_count,
...
def plot_histogram_ex(label: str, values: FloatPtr, values_count: int, values_offset: int=0, overlay_text: str=None, scale_min: float=FLT_MAX, scale_max: float=FLT_MAX, graph_size: tuple=(0, 0), stride: int=sizeof(float)):
    ccimgui_db.ImGui_PlotHistogramEx(
        _bytes(label),
        &values.value,
        values_count,
        values_offset,
...
def plot_lines_callback(label: str, values_getter: Callable, data: Any, values_count: int):
    ...
    Implied values_offset = 0, overlay_text = null, scale_min = flt_max, scale_max = flt_max, graph_size = imvec2(0, 0)
    """
    ccimgui_db.ImGui_PlotLinesCallback(
        _bytes(label),
        values_getter,
        data,
        values_count
...
def plot_lines_callback_ex(label: str, values_getter: Callable, data: Any, values_count: int, values_offset: int=0, overlay_text: str=None, scale_min: float=FLT_MAX, scale_max: float=FLT_MAX, graph_size: tuple=(0, 0)):
    ccimgui_db.ImGui_PlotLinesCallbackEx(
        _bytes(label),
        values_getter,
        data,
        values_count,
...
def pop_button_repeat():
    ccimgui_db.ImGui_PopButtonRepeat()
# [End Function]
...
def pop_style_color():
    ...
    Implied count = 1
    """
    ccimgui_db.ImGui_PopStyleColor()
# [End Function]
...
def pop_style_color_ex(count: int=1):
    ccimgui_db.ImGui_PopStyleColorEx(
        count
    )
# [End Function]
...
def pop_style_var_ex(count: int=1):
    ccimgui_db.ImGui_PopStyleVarEx(
        count
    )
# [End Function]
...
def pop_text_wrap_pos():
    ccimgui_db.ImGui_PopTextWrapPos()
# [End Function]
...
def push_button_repeat(repeat: bool):
    ...
    """
    ccimgui_db.ImGui_PushButtonRepeat(
        repeat
    )
# [End Function]
...
def push_item_width(item_width: float):
    ...
    """
    ccimgui_db.ImGui_PushItemWidth(
        item_width
    )
# [End Function]
...
def push_style_color(idx: int, col: int):
    ...
    """
    ccimgui_db.ImGui_PushStyleColor(
        idx,
        col
    )
# [End Function]
...
def push_style_color_im_vec4(idx: int, col: tuple):
    ccimgui_db.ImGui_PushStyleColorImVec4(
        idx,
        _cast_tuple_ImVec4(col)
    )
# [End Function]
...
def push_style_var_im_vec2(idx: int, val: tuple):
    ...
    """
    ccimgui_db.ImGui_PushStyleVarImVec2(
        idx,
...
def push_text_wrap_pos(wrap_local_pos_x: float=0.0):
    ...
    """
    ccimgui_db.ImGui_PushTextWrapPos(
        wrap_local_pos_x
    )
# [End Function]
...
def radio_button(label: str, active: bool):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_RadioButton(
        _bytes(label),
        active
    )
    return res
...
def radio_button_int_ptr(label: str, v: IntPtr, v_button: int):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_RadioButtonIntPtr(
        _bytes(label),
        &v.value,
        v_button
    )
...
def render_platform_windows_default_ex(platform_render_arg: Any=None, renderer_render_arg: Any=None):
    ...
    """
    ccimgui_db.ImGui_RenderPlatformWindowsDefaultEx(
        platform_render_arg,
        renderer_render_arg
    )
# [End Function]
...
def reset_mouse_drag_delta():
    ...
    Implied button = 0
    """
    ccimgui_db.ImGui_ResetMouseDragDelta()
# [End Function]
...
def save_ini_settings_to_disk(ini_filename: str):
    ...
    """
    ccimgui_db.ImGui_SaveIniSettingsToDisk(
        _bytes(ini_filename)
    )
# [End Function]
...
def save_ini_settings_to_memory(out_ini_size: Any=None):
    ...
    """
    cdef const char* res = ccimgui_db.ImGui_SaveIniSettingsToMemory(
        out_ini_size
    )
    return _from_bytes(res)
# [End Function]
...
def selectable(label: str):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_Selectable(
        _bytes(label)
    )
    return res
# [End Function]
...
def selectable_bool_ptr(label: str, p_selected: BoolPtr, flags: int=0):
    ...
    Implied size = imvec2(0, 0)
    """
    cdef bool res = ccimgui_db.ImGui_SelectableBoolPtr(
        _bytes(label),
        &p_selected.value,
        flags
    )
...
def selectable_bool_ptr_ex(label: str, p_selected: BoolPtr, flags: int=0, size: tuple=(0, 0)):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_SelectableBoolPtrEx(
        _bytes(label),
        &p_selected.value,
        flags,
        _cast_tuple_ImVec2(size)
...
def selectable_ex(label: str, selected: bool=False, flags: int=0, size: tuple=(0, 0)):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_SelectableEx(
        _bytes(label),
        selected,
        flags,
        _cast_tuple_ImVec2(size)
...
def separator_text(label: str):
    ...
    """
    ccimgui_db.ImGui_SeparatorText(
        _bytes(label)
    )
# [End Function]
...
def set_allocator_functions(alloc_func: Callable, free_func: Callable, user_data: Any=None):
    ...
    """
    ccimgui_db.ImGui_SetAllocatorFunctions(
        alloc_func,
        free_func,
        user_data
    )
...
def set_clipboard_text(text: str):
    ccimgui_db.ImGui_SetClipboardText(
        _bytes(text)
    )
# [End Function]
...
def set_color_edit_options(flags: int):
    ...
    """
    ccimgui_db.ImGui_SetColorEditOptions(
        flags
    )
# [End Function]
...
def set_column_offset(column_index: int, offset_x: float):
    ...
    """
    ccimgui_db.ImGui_SetColumnOffset(
        column_index,
        offset_x
    )
# [End Function]
...
def set_column_width(column_index: int, width: float):
    ...
    """
    ccimgui_db.ImGui_SetColumnWidth(
        column_index,
        width
    )
# [End Function]
...
def set_cursor_pos_x(local_x: float):
    ...
    """
    ccimgui_db.ImGui_SetCursorPosX(
        local_x
    )
# [End Function]
...
def set_cursor_screen_pos(pos: tuple):
    ...
    """
    ccimgui_db.ImGui_SetCursorScreenPos(
...
def set_drag_drop_payload(type_: str, data: Any, sz: Any, cond: int=0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_SetDragDropPayload(
        _bytes(type_),
        data,
        sz,
        cond
...
def set_item_allow_overlap():
    ...
    """
    ccimgui_db.ImGui_SetItemAllowOverlap()
# [End Function]
...
def set_item_default_focus():
    ...
    """
    ccimgui_db.ImGui_SetItemDefaultFocus()
# [End Function]
...
def set_keyboard_focus_here():
    ...
    Implied offset = 0
    """
    ccimgui_db.ImGui_SetKeyboardFocusHere()
# [End Function]
...
def set_keyboard_focus_here_ex(offset: int=0):
    ...
    """
    ccimgui_db.ImGui_SetKeyboardFocusHereEx(
        offset
    )
# [End Function]
...
def set_mouse_cursor(cursor_type: int):
    ...
    """
    ccimgui_db.ImGui_SetMouseCursor(
        cursor_type
    )
# [End Function]
...
def set_next_frame_want_capture_keyboard(want_capture_keyboard: bool):
    ...
    """
    ccimgui_db.ImGui_SetNextFrameWantCaptureKeyboard(
...
def set_next_frame_want_capture_mouse(want_capture_mouse: bool):
    ...
    """
    ccimgui_db.ImGui_SetNextFrameWantCaptureMouse(
        want_capture_mouse
    )
# [End Function]
...
def set_next_item_open(is_open: bool, cond: int=0):
    ...
    """
    ccimgui_db.ImGui_SetNextItemOpen(
        is_open,
        cond
    )
# [End Function]
...
def set_next_item_width(item_width: float):
    ...
    """
    ccimgui_db.ImGui_SetNextItemWidth(
        item_width
    )
# [End Function]
...
def set_next_window_bg_alpha(alpha: float):
    ...
    """
    ccimgui_db.ImGui_SetNextWindowBgAlpha(
        alpha
    )
# [End Function]
...
def set_next_window_collapsed(collapsed: bool, cond: int=0):
    ...
    """
    ccimgui_db.ImGui_SetNextWindowCollapsed(
        collapsed,
        cond
    )
# [End Function]
...
def set_next_window_content_size(size: tuple):
    ...
    """
    ccimgui_db.ImGui_SetNextWindowContentSize(
        _cast_tuple_ImVec2(size)
    )
# [End Function]
...
def set_next_window_dock_id(dock_id: int, cond: int=0):
    ...
    """
    ccimgui_db.ImGui_SetNextWindowDockID(
        dock_id,
        cond
    )
# [End Function]
...
def set_next_window_focus():
    ...
    """
    ccimgui_db.ImGui_SetNextWindowFocus()
# [End Function]
...
def set_next_window_pos(pos: tuple, cond: int=0):
    ...
    """
    ccimgui_db.ImGui_SetNextWindowPos(
        _cast_tuple_ImVec2(pos),
        cond
    )
# [End Function]
...
def set_next_window_pos_ex(pos: tuple, cond: int=0, pivot: tuple=(0, 0)):
    ...
    """
    ccimgui_db.ImGui_SetNextWindowPosEx(
        _cast_tuple_ImVec2(pos),
        cond,
...
def set_next_window_scroll(scroll: tuple):
    ...
    """
    ccimgui_db.ImGui_SetNextWindowScroll(
...
def set_next_window_size(size: tuple, cond: int=0):
    ...
    """
    ccimgui_db.ImGui_SetNextWindowSize(
        _cast_tuple_ImVec2(size),
        cond
    )
# [End Function]
...
def set_next_window_size_constraints(size_min: tuple, size_max: tuple, custom_callback: Callable=None, custom_callback_data: Any=None):
    ...
    """
    ccimgui_db.ImGui_SetNextWindowSizeConstraints(
...
def set_next_window_viewport(viewport_id: int):
    ...
    """
    ccimgui_db.ImGui_SetNextWindowViewport(
        viewport_id
    )
# [End Function]
...
def set_scroll_from_pos_x(local_x: float, center_x_ratio: float=0.5):
    ...
    """
    ccimgui_db.ImGui_SetScrollFromPosX(
        local_x,
        center_x_ratio
    )
# [End Function]
...
def set_scroll_from_pos_y(local_y: float, center_y_ratio: float=0.5):
    ...
    Adjust scrolling amount to make given position visible. generally getcursorstartpos() + offset to compute a valid position.
    """
    ccimgui_db.ImGui_SetScrollFromPosY(
        local_y,
        center_y_ratio
    )
# [End Function]
...
def set_scroll_here_x(center_x_ratio: float=0.5):
    ...
    """
    ccimgui_db.ImGui_SetScrollHereX(
        center_x_ratio
    )
# [End Function]
...
def set_scroll_here_y(center_y_ratio: float=0.5):
    ...
    """
    ccimgui_db.ImGui_SetScrollHereY(
        center_y_ratio
    )
# [End Function]
...
def set_tab_item_closed(tab_or_docked_window_label: str):
    ...
    """
    ccimgui_db.ImGui_SetTabItemClosed(
...
def set_window_collapsed(collapsed: bool, cond: int=0):
    ...
    """
    ccimgui_db.ImGui_SetWindowCollapsed(
        collapsed,
        cond
    )
# [End Function]
...
def set_window_collapsed_str(name: str, collapsed: bool, cond: int=0):
    ...
    """
    ccimgui_db.ImGui_SetWindowCollapsedStr(
        _bytes(name),
        collapsed,
        cond
    )
...
def set_window_focus():
    ...
    """
    ccimgui_db.ImGui_SetWindowFocus()
# [End Function]
...
def set_window_focus_str(name: str):
    ...
    """
    ccimgui_db.ImGui_SetWindowFocusStr(
        _bytes(name)
    )
# [End Function]
...
def set_window_font_scale(scale: float):
    ...
    """
    ccimgui_db.ImGui_SetWindowFontScale(
        scale
    )
# [End Function]
...
def set_window_pos_str(name: str, pos: tuple, cond: int=0):
    ...
    """
    ccimgui_db.ImGui_SetWindowPosStr(
        _bytes(name),
        _cast_tuple_ImVec2(pos),
        cond
    )
...
def set_window_size(size: tuple, cond: int=0):
    ...
    """
    ccimgui_db.ImGui_SetWindowSize(
        _cast_tuple_ImVec2(size),
        cond
    )
# [End Function]
...
def set_window_size_str(name: str, size: tuple, cond: int=0):
    ...
    """
    ccimgui_db.ImGui_SetWindowSizeStr(
        _bytes(name),
        _cast_tuple_ImVec2(size),
        cond
    )
...
def show_about_window(p_open: BoolPtr=None):
    ...
    """
    ccimgui_db.ImGui_ShowAboutWindow(
        &p_open.value
    )
# [End Function]
...
def show_debug_log_window(p_open: BoolPtr=None):
    ...
    """
    ccimgui_db.ImGui_ShowDebugLogWindow(
        &p_open.value
    )
# [End Function]
...
def show_font_selector(label: str):
    ...
    """
    ccimgui_db.ImGui_ShowFontSelector(
        _bytes(label)
    )
# [End Function]
...
def show_metrics_window(p_open: BoolPtr=None):
    ...
    """
    ccimgui_db.ImGui_ShowMetricsWindow(
        &p_open.value
    )
# [End Function]
...
def show_stack_tool_window(p_open: BoolPtr=None):
    ...
    """
    ccimgui_db.ImGui_ShowStackToolWindow(
        &p_open.value
    )
# [End Function]
...
def show_style_selector(label: str):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_ShowStyleSelector(
        _bytes(label)
    )
    return res
# [End Function]
...
def show_user_guide():
    ...
    """
    ccimgui_db.ImGui_ShowUserGuide()
# [End Function]
...
def slider_angle(label: str, v_rad: FloatPtr):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_SliderAngle(
        _bytes(label),
        &v_rad.value
    )
    return res
...
def slider_angle_ex(label: str, v_rad: FloatPtr, v_degrees_min: float=-360.0, v_degrees_max: float=+360.0, format_: str="%.0f deg", flags: int=0):
    cdef bool res = ccimgui_db.ImGui_SliderAngleEx(
        _bytes(label),
        &v_rad.value,
        v_degrees_min,
        v_degrees_max,
...
def slider_float(label: str, v: FloatPtr, v_min: float, v_max: float):
    ...
    Implied format = '%.3f', flags = 0
    """
    cdef bool res = ccimgui_db.ImGui_SliderFloat(
        _bytes(label),
        &v.value,
        v_min,
        v_max
...
def slider_float2(label: str, v: Sequence[FloatPtr], v_min: float, v_max: float):
    ...
    Implied format = '%.3f', flags = 0
    """
    cdef bool res = ccimgui_db.ImGui_SliderFloat2(
        _bytes(label),
        &v.value,
        v_min,
        v_max
...
def slider_float2_ex(label: str, v: Sequence[FloatPtr], v_min: float, v_max: float, format_: str="%.3f", flags: int=0):
    cdef bool res = ccimgui_db.ImGui_SliderFloat2Ex(
        _bytes(label),
        &v.value,
        v_min,
        v_max,
...
def slider_float3(label: str, v: Sequence[FloatPtr], v_min: float, v_max: float):
    ...
    Implied format = '%.3f', flags = 0
    """
    cdef bool res = ccimgui_db.ImGui_SliderFloat3(
        _bytes(label),
        &v.value,
        v_min,
        v_max
...
def slider_float3_ex(label: str, v: Sequence[FloatPtr], v_min: float, v_max: float, format_: str="%.3f", flags: int=0):
    cdef bool res = ccimgui_db.ImGui_SliderFloat3Ex(
        _bytes(label),
        &v.value,
        v_min,
        v_max,
...
def slider_float4(label: str, v: Sequence[FloatPtr], v_min: float, v_max: float):
    ...
    Implied format = '%.3f', flags = 0
    """
    cdef bool res = ccimgui_db.ImGui_SliderFloat4(
        _bytes(label),
        &v.value,
        v_min,
        v_max
...
def slider_float4_ex(label: str, v: Sequence[FloatPtr], v_min: float, v_max: float, format_: str="%.3f", flags: int=0):
    cdef bool res = ccimgui_db.ImGui_SliderFloat4Ex(
        _bytes(label),
        &v.value,
        v_min,
        v_max,
...
def slider_float_ex(label: str, v: FloatPtr, v_min: float, v_max: float, format_: str="%.3f", flags: int=0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_SliderFloatEx(
        _bytes(label),
        &v.value,
        v_min,
        v_max,
...
def slider_int(label: str, v: IntPtr, v_min: int, v_max: int):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_SliderInt(
        _bytes(label),
        &v.value,
        v_min,
        v_max
...
def slider_int2(label: str, v: Sequence[IntPtr], v_min: int, v_max: int):
    ...
    Implied format = '%d', flags = 0
    """
    cdef bool res = ccimgui_db.ImGui_SliderInt2(
        _bytes(label),
        &v.value,
        v_min,
        v_max
...
def slider_int2_ex(label: str, v: Sequence[IntPtr], v_min: int, v_max: int, format_: str="%d", flags: int=0):
    cdef bool res = ccimgui_db.ImGui_SliderInt2Ex(
        _bytes(label),
        &v.value,
        v_min,
        v_max,
...
def slider_int3(label: str, v: Sequence[IntPtr], v_min: int, v_max: int):
    ...
    Implied format = '%d', flags = 0
    """
    cdef bool res = ccimgui_db.ImGui_SliderInt3(
        _bytes(label),
        &v.value,
        v_min,
        v_max
...
def slider_int3_ex(label: str, v: Sequence[IntPtr], v_min: int, v_max: int, format_: str="%d", flags: int=0):
    cdef bool res = ccimgui_db.ImGui_SliderInt3Ex(
        _bytes(label),
        &v.value,
        v_min,
        v_max,
...
def slider_int4(label: str, v: Sequence[IntPtr], v_min: int, v_max: int):
    ...
    Implied format = '%d', flags = 0
    """
    cdef bool res = ccimgui_db.ImGui_SliderInt4(
        _bytes(label),
        &v.value,
        v_min,
        v_max
...
def slider_int4_ex(label: str, v: Sequence[IntPtr], v_min: int, v_max: int, format_: str="%d", flags: int=0):
    cdef bool res = ccimgui_db.ImGui_SliderInt4Ex(
        _bytes(label),
        &v.value,
        v_min,
        v_max,
...
def slider_int_ex(label: str, v: IntPtr, v_min: int, v_max: int, format_: str="%d", flags: int=0):
    cdef bool res = ccimgui_db.ImGui_SliderIntEx(
        _bytes(label),
        &v.value,
        v_min,
        v_max,
...
def slider_scalar(label: str, data_type: int, p_data: Any, p_min: Any, p_max: Any):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_SliderScalar(
        _bytes(label),
        data_type,
        p_data,
        p_min,
...
def slider_scalar_ex(label: str, data_type: int, p_data: Any, p_min: Any, p_max: Any, format_: str=None, flags: int=0):
    cdef bool res = ccimgui_db.ImGui_SliderScalarEx(
        _bytes(label),
        data_type,
        p_data,
        p_min,
...
def slider_scalar_n(label: str, data_type: int, p_data: Any, components: int, p_min: Any, p_max: Any):
    ...
    Implied format = null, flags = 0
    """
    cdef bool res = ccimgui_db.ImGui_SliderScalarN(
        _bytes(label),
        data_type,
        p_data,
        components,
...
def slider_scalar_ne_x(label: str, data_type: int, p_data: Any, components: int, p_min: Any, p_max: Any, format_: str=None, flags: int=0):
    cdef bool res = ccimgui_db.ImGui_SliderScalarNEx(
        _bytes(label),
        data_type,
        p_data,
        components,
...
def small_button(label: str):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_SmallButton(
        _bytes(label)
    )
    return res
# [End Function]
...
def tab_item_button(label: str, flags: int=0):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_TabItemButton(
        _bytes(label),
        flags
    )
    return res
...
def table_get_column_count():
    ...
    """
    cdef int res = ccimgui_db.ImGui_TableGetColumnCount()
    return res
# [End Function]
...
def table_get_column_flags(column_n: int=-1):
    ...
    """
    cdef ccimgui_db.ImGuiTableColumnFlags res = ccimgui_db.ImGui_TableGetColumnFlags(
        column_n
    )
    return res
# [End Function]
...
def table_get_column_index():
    ...
    """
    cdef int res = ccimgui_db.ImGui_TableGetColumnIndex()
    return res
# [End Function]
...
def table_get_column_name(column_n: int=-1):
    ...
    """
    cdef const char* res = ccimgui_db.ImGui_TableGetColumnName(
        column_n
    )
    return _from_bytes(res)
# [End Function]
...
def table_get_row_index():
    ...
    """
    cdef int res = ccimgui_db.ImGui_TableGetRowIndex()
    return res
# [End Function]
...
def table_get_sort_specs():
    ...
    """
    cdef ccimgui_db.ImGuiTableSortSpecs* res = ccimgui_db.ImGui_TableGetSortSpecs()
...
def table_headers_row():
    ...
    """
    ccimgui_db.ImGui_TableHeadersRow()
# [End Function]
...
def table_next_column():
    ...
    """
    cdef bool res = ccimgui_db.ImGui_TableNextColumn()
    return res
# [End Function]
...
def table_next_row_ex(row_flags: int=0, min_row_height: float=0.0):
    ...
    """
    ccimgui_db.ImGui_TableNextRowEx(
        row_flags,
        min_row_height
    )
# [End Function]
...
def table_set_bg_color(target: int, color: int, column_n: int=-1):
    ...
    """
    ccimgui_db.ImGui_TableSetBgColor(
        target,
        color,
        column_n
    )
...
def table_set_column_enabled(column_n: int, v: bool):
    ...
    """
    ccimgui_db.ImGui_TableSetColumnEnabled(
        column_n,
        v
    )
# [End Function]
...
def table_set_column_index(column_n: int):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_TableSetColumnIndex(
        column_n
    )
    return res
# [End Function]
...
def table_setup_column(label: str, flags: int=0):
    ...
    """
    ccimgui_db.ImGui_TableSetupColumn(
        _bytes(label),
        flags
    )
# [End Function]
...
def table_setup_column_ex(label: str, flags: int=0, init_width_or_weight: float=0.0, user_id: int=0):
    ccimgui_db.ImGui_TableSetupColumnEx(
        _bytes(label),
        flags,
...
def table_setup_scroll_freeze(cols: int, rows: int):
    ...
    """
    ccimgui_db.ImGui_TableSetupScrollFreeze(
        cols,
        rows
    )
# [End Function]
...
def text_disabled_v(fmt: str):
    ccimgui_db.ImGui_TextDisabledV(
        _bytes(fmt)
    )
# [End Function]
...
def text_unformatted(text: str):
    ...
    """
    ccimgui_db.ImGui_TextUnformatted(
        _bytes(text)
    )
# [End Function]
...
def text_unformatted_ex(text: str, text_end: str=None):
    ...
    """
    ccimgui_db.ImGui_TextUnformattedEx(
        _bytes(text),
        _bytes(text_end)
    )
# [End Function]
...
def tree_node(label: str):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_TreeNode(
        _bytes(label)
    )
    return res
# [End Function]
...
def tree_node_ex(label: str, flags: int=0):
    cdef bool res = ccimgui_db.ImGui_TreeNodeEx(
        _bytes(label),
        flags
    )
    return res
...
def tree_node_ex_ptr(ptr_id: Any, flags: int, fmt: str):
    cdef bool res = ccimgui_db.ImGui_TreeNodeExPtr(
        ptr_id,
        flags,
        _bytes(fmt)
    )
...
def tree_node_ex_str(str_id: str, flags: int, fmt: str):
    cdef bool res = ccimgui_db.ImGui_TreeNodeExStr(
        _bytes(str_id),
        flags,
        _bytes(fmt)
    )
...
def tree_node_ex_v(str_id: str, flags: int, fmt: str):
    cdef bool res = ccimgui_db.ImGui_TreeNodeExV(
        _bytes(str_id),
        flags,
        _bytes(fmt)
    )
...
def tree_node_ex_vp_tr(ptr_id: Any, flags: int, fmt: str):
    cdef bool res = ccimgui_db.ImGui_TreeNodeExVPtr(
        ptr_id,
        flags,
        _bytes(fmt)
    )
...
def tree_node_ptr(ptr_id: Any, fmt: str):
    ...
    '
    """
    cdef bool res = ccimgui_db.ImGui_TreeNodePtr(
        ptr_id,
        _bytes(fmt)
    )
    return res
...
def tree_node_str(str_id: str, fmt: str):
    ...
    """
    cdef bool res = ccimgui_db.ImGui_TreeNodeStr(
        _bytes(str_id),
        _bytes(fmt)
    )
    return res
...
def tree_node_v(str_id: str, fmt: str):
    cdef bool res = ccimgui_db.ImGui_TreeNodeV(
        _bytes(str_id),
        _bytes(fmt)
    )
    return res
...
def tree_node_vp_tr(ptr_id: Any, fmt: str):
    cdef bool res = ccimgui_db.ImGui_TreeNodeVPtr(
        ptr_id,
        _bytes(fmt)
    )
    return res
...
def vslider_float(label: str, size: tuple, v: FloatPtr, v_min: float, v_max: float):
    ...
    Implied format = '%.3f', flags = 0
    """
    cdef bool res = ccimgui_db.ImGui_VSliderFloat(
        _bytes(label),
        _cast_tuple_ImVec2(size),
        &v.value,
        v_min,
...
def vslider_float_ex(label: str, size: tuple, v: FloatPtr, v_min: float, v_max: float, format_: str="%.3f", flags: int=0):
    cdef bool res = ccimgui_db.ImGui_VSliderFloatEx(
        _bytes(label),
        _cast_tuple_ImVec2(size),
        &v.value,
        v_min,
...
def vslider_int(label: str, size: tuple, v: IntPtr, v_min: int, v_max: int):
    ...
    Implied format = '%d', flags = 0
    """
    cdef bool res = ccimgui_db.ImGui_VSliderInt(
        _bytes(label),
        _cast_tuple_ImVec2(size),
        &v.value,
        v_min,
...
def vslider_int_ex(label: str, size: tuple, v: IntPtr, v_min: int, v_max: int, format_: str="%d", flags: int=0):
    cdef bool res = ccimgui_db.ImGui_VSliderIntEx(
        _bytes(label),
        _cast_tuple_ImVec2(size),
        &v.value,
        v_min,
...
def vslider_scalar(label: str, size: tuple, data_type: int, p_data: Any, p_min: Any, p_max: Any):
    ...
    Implied format = null, flags = 0
    """
    cdef bool res = ccimgui_db.ImGui_VSliderScalar(
        _bytes(label),
        _cast_tuple_ImVec2(size),
        data_type,
        p_data,
...
def vslider_scalar_ex(label: str, size: tuple, data_type: int, p_data: Any, p_min: Any, p_max: Any, format_: str=None, flags: int=0):
    cdef bool res = ccimgui_db.ImGui_VSliderScalarEx(
        _bytes(label),
        _cast_tuple_ImVec2(size),
        data_type,
        p_data,
...
cdef class ImColor:
    ...
    **None of the ImGui API are using ImColor directly but you can use it as a convenience to pass colors in either ImU32 or ImVec4 formats. Explicitly cast to ImU32 or ImVec4 if needed.
    ...
    @property
    def value(self):
        cdef ccimgui_db.ImVec4 res = dereference(self._ptr).Value
        return _cast_ImVec4_tuple(res)
    @value.setter
    ...
    def hsv(self: ImColor, h: float, s: float, v: float, a: float=1.0):
        cdef ccimgui_db.ImColor res = ccimgui_db.ImColor_HSV(
            self._ptr,
            h,
            s,
            v,
...
cdef class ImDrawChannel:
    ...
    """
    cdef ccimgui_db.ImDrawChannel* _ptr
    ...
    @property
    def cmd_buffer(self):
        cdef ccimgui_db.ImVector_ImDrawCmd res = dereference(self._ptr)._CmdBuffer
    ...
    @property
    def idx_buffer(self):
        cdef ccimgui_db.ImVector_ImDrawIdx res = dereference(self._ptr)._IdxBuffer
...
cdef class ImDrawCmd:
    ...
    """
    cdef ccimgui_db.ImDrawCmd* _ptr
    ...
    def clip_rect(self):
        ...
        """
        cdef ccimgui_db.ImVec4 res = dereference(self._ptr).ClipRect
        return _cast_ImVec4_tuple(res)
    @clip_rect.setter
    ...
    def texture_id(self):
        ...
        """
        cdef ccimgui_db.ImTextureID res = dereference(self._ptr).TextureId
        return res
    @texture_id.setter
    ...
    def user_callback(self):
        ...
        """
        cdef ccimgui_db.ImDrawCallback res = dereference(self._ptr).UserCallback
        return res
    ...
    def get_tex_id(self: ImDrawCmd):
        ...
        """
        cdef ccimgui_db.ImTextureID res = ccimgui_db.ImDrawCmd_GetTexID(
            self._ptr
        )
        return res
    # [End Method]
...
cdef class ImDrawCmdHeader:
    ...
    """
    cdef ccimgui_db.ImDrawCmdHeader* _ptr
...
cdef class ImDrawData:
    ...
    def cmd_lists(self):
        ...
        """
        cdef ccimgui_db.ImDrawList** res = dereference(self._ptr).CmdLists
        return ImDrawList.from_ptr(res)
    @cmd_lists.setter
    ...
    def display_pos(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).DisplayPos
        return _cast_ImVec2_tuple(res)
    @display_pos.setter
    ...
    def framebuffer_scale(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).FramebufferScale
        return _cast_ImVec2_tuple(res)
    ...
    def owner_viewport(self):
        ...
        """
        cdef ccimgui_db.ImGuiViewport* res = dereference(self._ptr).OwnerViewport
        return ImGuiViewport.from_ptr(res)
    ...
    def de_index_all_buffers(self: ImDrawData):
        ...
        """
        ccimgui_db.ImDrawData_DeIndexAllBuffers(
            self._ptr
        )
    # [End Method]
    ...
    def scale_clip_rects(self: ImDrawData, fb_scale: tuple):
        ...
        """
        ccimgui_db.ImDrawData_ScaleClipRects(
            self._ptr,
...
cdef class ImDrawList:
    ...
    """
    cdef ccimgui_db.ImDrawList* _ptr
    ...
    def cmd_buffer(self):
        ...
        """
        cdef ccimgui_db.ImVector_ImDrawCmd res = dereference(self._ptr).CmdBuffer
        return ImVector_ImDrawCmd.from_ptr(res)
    @cmd_buffer.setter
    def cmd_buffer(self, value: ImVector_ImDrawCmd):
    ...
    def flags(self):
        ...
        """
        cdef ccimgui_db.ImDrawListFlags res = dereference(self._ptr).Flags
        return res
    @flags.setter
    ...
    def idx_buffer(self):
        ...
        """
        cdef ccimgui_db.ImVector_ImDrawIdx res = dereference(self._ptr).IdxBuffer
        return ImVector_ImDrawIdx.from_ptr(res)
    @idx_buffer.setter
    def idx_buffer(self, value: ImVector_ImDrawIdx):
    ...
    def vtx_buffer(self):
        ...
        Vertex buffer.
        """
        cdef ccimgui_db.ImVector_ImDrawVert res = dereference(self._ptr).VtxBuffer
    ...
    def clip_rect_stack(self):
        ...
        [internal]
        """
        cdef ccimgui_db.ImVector_ImVec4 res = dereference(self._ptr)._ClipRectStack
    ...
    def cmd_header(self):
        ...
        """
        cdef ccimgui_db.ImDrawCmdHeader res = dereference(self._ptr)._CmdHeader
    ...
    def data(self):
        ...
        """
        cdef ccimgui_db.ImDrawListSharedData* res = dereference(self._ptr)._Data
        return ImDrawListSharedData.from_ptr(res)
    @data.setter
    ...
    def idx_write_ptr(self):
        ...
        """
        cdef ccimgui_db.ImDrawIdx* res = dereference(self._ptr)._IdxWritePtr
        return res
    ...
    def path(self):
        ...
        """
        cdef ccimgui_db.ImVector_ImVec2 res = dereference(self._ptr)._Path
    ...
    def splitter(self):
        ...
        """
        cdef ccimgui_db.ImDrawListSplitter res = dereference(self._ptr)._Splitter
    ...
    def texture_id_stack(self):
        ...
        [internal]
        """
        cdef ccimgui_db.ImVector_ImTextureID res = dereference(self._ptr)._TextureIdStack
    ...
    def vtx_write_ptr(self):
        ...
        """
        cdef ccimgui_db.ImDrawVert* res = dereference(self._ptr)._VtxWritePtr
    ...
    def add_bezier_cubic(self: ImDrawList, p1: tuple, p2: tuple, p3: tuple, p4: tuple, col: int, thickness: float, num_segments: int=0):
        ...
        """
        ccimgui_db.ImDrawList_AddBezierCubic(
            self._ptr,
    ...
    def add_bezier_quadratic(self: ImDrawList, p1: tuple, p2: tuple, p3: tuple, col: int, thickness: float, num_segments: int=0):
        ...
        """
        ccimgui_db.ImDrawList_AddBezierQuadratic(
            self._ptr,
            _cast_tuple_ImVec2(p1),
            _cast_tuple_ImVec2(p2),
            _cast_tuple_ImVec2(p3),
    ...
    def add_callback(self: ImDrawList, callback: Callable, callback_data: Any):
        ...
        """
        ccimgui_db.ImDrawList_AddCallback(
            self._ptr,
            callback,
            callback_data
        )
    ...
    def add_circle(self: ImDrawList, center: tuple, radius: float, col: int):
        ...
        """
        ccimgui_db.ImDrawList_AddCircle(
            self._ptr,
    ...
    def add_circle_ex(self: ImDrawList, center: tuple, radius: float, col: int, num_segments: int=0, thickness: float=1.0):
        ccimgui_db.ImDrawList_AddCircleEx(
            self._ptr,
            _cast_tuple_ImVec2(center),
            radius,
            col,
    ...
    def add_circle_filled(self: ImDrawList, center: tuple, radius: float, col: int, num_segments: int=0):
        ccimgui_db.ImDrawList_AddCircleFilled(
            self._ptr,
            _cast_tuple_ImVec2(center),
            radius,
            col,
    ...
    def add_draw_cmd(self: ImDrawList):
        ...
        """
        ccimgui_db.ImDrawList_AddDrawCmd(
            self._ptr
        )
    # [End Method]
    ...
    def add_image(self: ImDrawList, user_texture_id: Any, p_min: tuple, p_max: tuple):
        ...
        """
        ccimgui_db.ImDrawList_AddImage(
            self._ptr,
            user_texture_id,
    ...
    def add_image_ex(self: ImDrawList, user_texture_id: Any, p_min: tuple, p_max: tuple, uv_min: tuple=(0, 0), uv_max: tuple=(1, 1), col: int=IM_COL32_WHITE):
        ccimgui_db.ImDrawList_AddImageEx(
            self._ptr,
            user_texture_id,
            _cast_tuple_ImVec2(p_min),
            _cast_tuple_ImVec2(p_max),
    ...
    def add_image_quad(self: ImDrawList, user_texture_id: Any, p1: tuple, p2: tuple, p3: tuple, p4: tuple):
        ...
        """
        ccimgui_db.ImDrawList_AddImageQuad(
            self._ptr,
            user_texture_id,
            _cast_tuple_ImVec2(p1),
            _cast_tuple_ImVec2(p2),
    ...
    def add_image_quad_ex(self: ImDrawList, user_texture_id: Any, p1: tuple, p2: tuple, p3: tuple, p4: tuple, uv1: tuple=(0, 0), uv2: tuple=(1, 0), uv3: tuple=(1, 1), uv4: tuple=(0, 1), col: int=IM_COL32_WHITE):
        ccimgui_db.ImDrawList_AddImageQuadEx(
            self._ptr,
            user_texture_id,
            _cast_tuple_ImVec2(p1),
            _cast_tuple_ImVec2(p2),
    ...
    def add_image_rounded(self: ImDrawList, user_texture_id: Any, p_min: tuple, p_max: tuple, uv_min: tuple, uv_max: tuple, col: int, rounding: float, flags: int=0):
        ccimgui_db.ImDrawList_AddImageRounded(
            self._ptr,
            user_texture_id,
            _cast_tuple_ImVec2(p_min),
            _cast_tuple_ImVec2(p_max),
    ...
    def add_line_ex(self: ImDrawList, p1: tuple, p2: tuple, col: int, thickness: float=1.0):
        ccimgui_db.ImDrawList_AddLineEx(
            self._ptr,
            _cast_tuple_ImVec2(p1),
            _cast_tuple_ImVec2(p2),
            col,
    ...
    def add_ngon_ex(self: ImDrawList, center: tuple, radius: float, col: int, num_segments: int, thickness: float=1.0):
        ccimgui_db.ImDrawList_AddNgonEx(
            self._ptr,
            _cast_tuple_ImVec2(center),
            radius,
            col,
    ...
    def add_ngon_filled(self: ImDrawList, center: tuple, radius: float, col: int, num_segments: int):
        ccimgui_db.ImDrawList_AddNgonFilled(
            self._ptr,
            _cast_tuple_ImVec2(center),
            radius,
            col,
    ...
    def add_quad_ex(self: ImDrawList, p1: tuple, p2: tuple, p3: tuple, p4: tuple, col: int, thickness: float=1.0):
        ccimgui_db.ImDrawList_AddQuadEx(
            self._ptr,
            _cast_tuple_ImVec2(p1),
            _cast_tuple_ImVec2(p2),
            _cast_tuple_ImVec2(p3),
    ...
    def add_quad_filled(self: ImDrawList, p1: tuple, p2: tuple, p3: tuple, p4: tuple, col: int):
        ccimgui_db.ImDrawList_AddQuadFilled(
            self._ptr,
            _cast_tuple_ImVec2(p1),
            _cast_tuple_ImVec2(p2),
            _cast_tuple_ImVec2(p3),
    ...
    def add_rect_ex(self: ImDrawList, p_min: tuple, p_max: tuple, col: int, rounding: float=0.0, flags: int=0, thickness: float=1.0):
        ...
        """
        ccimgui_db.ImDrawList_AddRectEx(
            self._ptr,
            _cast_tuple_ImVec2(p_min),
            _cast_tuple_ImVec2(p_max),
            col,
    ...
    def add_rect_filled(self: ImDrawList, p_min: tuple, p_max: tuple, col: int):
        ...
        """
        ccimgui_db.ImDrawList_AddRectFilled(
            self._ptr,
            _cast_tuple_ImVec2(p_min),
            _cast_tuple_ImVec2(p_max),
            col
    ...
    def add_rect_filled_ex(self: ImDrawList, p_min: tuple, p_max: tuple, col: int, rounding: float=0.0, flags: int=0):
        ...
        A: upper-left, b: lower-right (== upper-left + size)
        """
        ccimgui_db.ImDrawList_AddRectFilledEx(
            self._ptr,
            _cast_tuple_ImVec2(p_min),
            _cast_tuple_ImVec2(p_max),
            col,
    ...
    def add_rect_filled_multi_color(self: ImDrawList, p_min: tuple, p_max: tuple, col_upr_left: int, col_upr_right: int, col_bot_right: int, col_bot_left: int):
        ccimgui_db.ImDrawList_AddRectFilledMultiColor(
            self._ptr,
            _cast_tuple_ImVec2(p_min),
            _cast_tuple_ImVec2(p_max),
            col_upr_left,
    ...
    def add_text_ex(self: ImDrawList, pos: tuple, col: int, text_begin: str, text_end: str=None):
        ccimgui_db.ImDrawList_AddTextEx(
            self._ptr,
            _cast_tuple_ImVec2(pos),
            col,
            _bytes(text_begin),
    ...
    def add_triangle(self: ImDrawList, p1: tuple, p2: tuple, p3: tuple, col: int):
        ...
        Implied thickness = 1.0f
        """
        ccimgui_db.ImDrawList_AddTriangle(
            self._ptr,
            _cast_tuple_ImVec2(p1),
            _cast_tuple_ImVec2(p2),
            _cast_tuple_ImVec2(p3),
    ...
    def add_triangle_ex(self: ImDrawList, p1: tuple, p2: tuple, p3: tuple, col: int, thickness: float=1.0):
        ccimgui_db.ImDrawList_AddTriangleEx(
            self._ptr,
            _cast_tuple_ImVec2(p1),
            _cast_tuple_ImVec2(p2),
            _cast_tuple_ImVec2(p3),
    ...
    def add_triangle_filled(self: ImDrawList, p1: tuple, p2: tuple, p3: tuple, col: int):
        ccimgui_db.ImDrawList_AddTriangleFilled(
            self._ptr,
            _cast_tuple_ImVec2(p1),
            _cast_tuple_ImVec2(p2),
            _cast_tuple_ImVec2(p3),
    ...
    def channels_merge(self: ImDrawList):
        ccimgui_db.ImDrawList_ChannelsMerge(
            self._ptr
        )
    # [End Method]
    ...
    def channels_set_current(self: ImDrawList, n: int):
        ccimgui_db.ImDrawList_ChannelsSetCurrent(
            self._ptr,
            n
        )
    # [End Method]
    ...
    def channels_split(self: ImDrawList, count: int):
        ...
        """
        ccimgui_db.ImDrawList_ChannelsSplit(
            self._ptr,
            count
        )
    # [End Method]
    ...
    def clone_output(self: ImDrawList):
        ...
        """
        cdef ccimgui_db.ImDrawList* res = ccimgui_db.ImDrawList_CloneOutput(
            self._ptr
        )
        return ImDrawList.from_ptr(res)
    # [End Method]
    ...
    def get_clip_rect_max(self: ImDrawList):
        cdef ccimgui_db.ImVec2 res = ccimgui_db.ImDrawList_GetClipRectMax(
            self._ptr
        )
        return _cast_ImVec2_tuple(res)
    # [End Method]
    ...
    def get_clip_rect_min(self: ImDrawList):
        cdef ccimgui_db.ImVec2 res = ccimgui_db.ImDrawList_GetClipRectMin(
            self._ptr
        )
        return _cast_ImVec2_tuple(res)
    # [End Method]
    ...
    def path_arc_to(self: ImDrawList, center: tuple, radius: float, a_min: float, a_max: float, num_segments: int=0):
        ccimgui_db.ImDrawList_PathArcTo(
            self._ptr,
            _cast_tuple_ImVec2(center),
            radius,
            a_min,
    ...
    def path_arc_to_fast(self: ImDrawList, center: tuple, radius: float, a_min_of_12: int, a_max_of_12: int):
        ...
        """
        ccimgui_db.ImDrawList_PathArcToFast(
            self._ptr,
            _cast_tuple_ImVec2(center),
            radius,
            a_min_of_12,
    ...
    def path_bezier_cubic_curve_to(self: ImDrawList, p2: tuple, p3: tuple, p4: tuple, num_segments: int=0):
        ...
        Cubic bezier (4 control points)
        """
        ccimgui_db.ImDrawList_PathBezierCubicCurveTo(
            self._ptr,
            _cast_tuple_ImVec2(p2),
            _cast_tuple_ImVec2(p3),
            _cast_tuple_ImVec2(p4),
    ...
    def path_bezier_quadratic_curve_to(self: ImDrawList, p2: tuple, p3: tuple, num_segments: int=0):
        ...
        Quadratic bezier (3 control points)
        """
        ccimgui_db.ImDrawList_PathBezierQuadraticCurveTo(
            self._ptr,
            _cast_tuple_ImVec2(p2),
            _cast_tuple_ImVec2(p3),
            num_segments
    ...
    def path_clear(self: ImDrawList):
        ...
        - Filled shapes must always use clockwise winding order. The anti-aliasing fringe depends on it. Counter-clockwise shapes will have "inward" anti-aliasing.
        """
        ccimgui_db.ImDrawList_PathClear(
            self._ptr
        )
    # [End Method]
    ...
    def path_fill_convex(self: ImDrawList, col: int):
        ccimgui_db.ImDrawList_PathFillConvex(
            self._ptr,
            col
        )
    # [End Method]
    ...
    def path_line_to(self: ImDrawList, pos: tuple):
        ccimgui_db.ImDrawList_PathLineTo(
            self._ptr,
            _cast_tuple_ImVec2(pos)
        )
    # [End Method]
    ...
    def path_line_to_merge_duplicate(self: ImDrawList, pos: tuple):
        ccimgui_db.ImDrawList_PathLineToMergeDuplicate(
            self._ptr,
            _cast_tuple_ImVec2(pos)
        )
    # [End Method]
    ...
    def path_rect(self: ImDrawList, rect_min: tuple, rect_max: tuple, rounding: float=0.0, flags: int=0):
        ccimgui_db.ImDrawList_PathRect(
            self._ptr,
            _cast_tuple_ImVec2(rect_min),
            _cast_tuple_ImVec2(rect_max),
            rounding,
    ...
    def path_stroke(self: ImDrawList, col: int, flags: int=0, thickness: float=1.0):
        ccimgui_db.ImDrawList_PathStroke(
            self._ptr,
            col,
            flags,
            thickness
    ...
    def pop_clip_rect(self: ImDrawList):
        ccimgui_db.ImDrawList_PopClipRect(
            self._ptr
        )
    # [End Method]
    ...
    def pop_texture_id(self: ImDrawList):
        ccimgui_db.ImDrawList_PopTextureID(
            self._ptr
        )
    # [End Method]
    ...
    def prim_quad_uv(self: ImDrawList, a: tuple, b: tuple, c: tuple, d: tuple, uv_a: tuple, uv_b: tuple, uv_c: tuple, uv_d: tuple, col: int):
        ccimgui_db.ImDrawList_PrimQuadUV(
            self._ptr,
    ...
    def prim_rect(self: ImDrawList, a: tuple, b: tuple, col: int):
        ...
        """
        ccimgui_db.ImDrawList_PrimRect(
            self._ptr,
            _cast_tuple_ImVec2(a),
            _cast_tuple_ImVec2(b),
            col
    ...
    def prim_rect_uv(self: ImDrawList, a: tuple, b: tuple, uv_a: tuple, uv_b: tuple, col: int):
        ccimgui_db.ImDrawList_PrimRectUV(
            self._ptr,
            _cast_tuple_ImVec2(a),
            _cast_tuple_ImVec2(b),
            _cast_tuple_ImVec2(uv_a),
    ...
    def prim_reserve(self: ImDrawList, idx_count: int, vtx_count: int):
        ...
        """
        ccimgui_db.ImDrawList_PrimReserve(
            self._ptr,
            idx_count,
            vtx_count
        )
    ...
    def prim_unreserve(self: ImDrawList, idx_count: int, vtx_count: int):
        ccimgui_db.ImDrawList_PrimUnreserve(
            self._ptr,
            idx_count,
            vtx_count
        )
    ...
    def prim_write_idx(self: ImDrawList, idx: int):
        ccimgui_db.ImDrawList_PrimWriteIdx(
            self._ptr,
            idx
        )
    # [End Method]
    ...
    def prim_write_vtx(self: ImDrawList, pos: tuple, uv: tuple, col: int):
        ccimgui_db.ImDrawList_PrimWriteVtx(
            self._ptr,
            _cast_tuple_ImVec2(pos),
            _cast_tuple_ImVec2(uv),
            col
    ...
    def push_clip_rect(self: ImDrawList, clip_rect_min: tuple, clip_rect_max: tuple, intersect_with_current_clip_rect: bool=False):
        ...
        """
        ccimgui_db.ImDrawList_PushClipRect(
            self._ptr,
            _cast_tuple_ImVec2(clip_rect_min),
            _cast_tuple_ImVec2(clip_rect_max),
            intersect_with_current_clip_rect
    ...
    def push_clip_rect_full_screen(self: ImDrawList):
        ccimgui_db.ImDrawList_PushClipRectFullScreen(
            self._ptr
        )
    # [End Method]
    ...
    def push_texture_id(self: ImDrawList, texture_id: Any):
        ccimgui_db.ImDrawList_PushTextureID(
            self._ptr,
            texture_id
        )
    # [End Method]
    ...
    def calc_circle_auto_segment_count(self: ImDrawList, radius: float):
        cdef int res = ccimgui_db.ImDrawList__CalcCircleAutoSegmentCount(
            self._ptr,
            radius
        )
        return res
    ...
    def clear_free_memory(self: ImDrawList):
        ccimgui_db.ImDrawList__ClearFreeMemory(
            self._ptr
        )
    # [End Method]
    ...
    def on_changed_clip_rect(self: ImDrawList):
        ccimgui_db.ImDrawList__OnChangedClipRect(
            self._ptr
        )
    # [End Method]
    ...
    def on_changed_texture_id(self: ImDrawList):
        ccimgui_db.ImDrawList__OnChangedTextureID(
            self._ptr
        )
    # [End Method]
    ...
    def on_changed_vtx_offset(self: ImDrawList):
        ccimgui_db.ImDrawList__OnChangedVtxOffset(
            self._ptr
        )
    # [End Method]
    ...
    def path_arc_to_fast_ex(self: ImDrawList, center: tuple, radius: float, a_min_sample: int, a_max_sample: int, a_step: int):
        ccimgui_db.ImDrawList__PathArcToFastEx(
            self._ptr,
            _cast_tuple_ImVec2(center),
            radius,
            a_min_sample,
    ...
    def path_arc_to_n(self: ImDrawList, center: tuple, radius: float, a_min: float, a_max: float, num_segments: int):
        ccimgui_db.ImDrawList__PathArcToN(
            self._ptr,
            _cast_tuple_ImVec2(center),
            radius,
            a_min,
    ...
    def pop_unused_draw_cmd(self: ImDrawList):
        ccimgui_db.ImDrawList__PopUnusedDrawCmd(
            self._ptr
        )
    # [End Method]
    ...
    def reset_for_new_frame(self: ImDrawList):
        ...
        [Internal helpers]
        """
        ccimgui_db.ImDrawList__ResetForNewFrame(
            self._ptr
        )
    # [End Method]
    ...
    def try_merge_draw_cmds(self: ImDrawList):
        ccimgui_db.ImDrawList__TryMergeDrawCmds(
            self._ptr
        )
    # [End Method]
...
cdef class ImDrawListSharedData:
    ...
    """
    cdef ccimgui_db.ImDrawListSharedData* _ptr
...
cdef class ImDrawListSplitter:
    ...
    """
    cdef ccimgui_db.ImDrawListSplitter* _ptr
    ...
    def channels(self):
        ...
        """
        cdef ccimgui_db.ImVector_ImDrawChannel res = dereference(self._ptr)._Channels
    ...
    def clear(self: ImDrawListSplitter):
        ...
        """
        ccimgui_db.ImDrawListSplitter_Clear(
            self._ptr
        )
    # [End Method]
    ...
    def clear_free_memory(self: ImDrawListSplitter):
        ccimgui_db.ImDrawListSplitter_ClearFreeMemory(
            self._ptr
        )
    # [End Method]
...
cdef class ImDrawVert:
    ...
    @property
    def col(self):
        cdef ccimgui_db.ImU32 res = dereference(self._ptr).col
        return res
    @col.setter
    ...
    @property
    def pos(self):
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).pos
        return _cast_ImVec2_tuple(res)
    @pos.setter
    ...
    @property
    def uv(self):
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).uv
        return _cast_ImVec2_tuple(res)
    @uv.setter
...
cdef class ImFont:
    ...
    def config_data(self):
        ...
        """
        cdef ccimgui_db.ImFontConfig* res = dereference(self._ptr).ConfigData
    ...
    def container_atlas(self):
        ...
        """
        cdef ccimgui_db.ImFontAtlas* res = dereference(self._ptr).ContainerAtlas
    ...
    def ellipsis_char(self):
        ...
        """
        cdef ccimgui_db.ImWchar res = dereference(self._ptr).EllipsisChar
        return res
    ...
    def fallback_char(self):
        ...
        """
        cdef ccimgui_db.ImWchar res = dereference(self._ptr).FallbackChar
        return res
    ...
    def fallback_glyph(self):
        ...
        """
        cdef ccimgui_db.ImFontGlyph* res = dereference(self._ptr).FallbackGlyph
    ...
    def glyphs(self):
        ...
        """
        cdef ccimgui_db.ImVector_ImFontGlyph res = dereference(self._ptr).Glyphs
    ...
    def index_advance_x(self):
        ...
        """
        cdef ccimgui_db.ImVector_float res = dereference(self._ptr).IndexAdvanceX
    ...
    def index_lookup(self):
        ...
        """
        cdef ccimgui_db.ImVector_ImWchar res = dereference(self._ptr).IndexLookup
    ...
    def used4k_pages_map(self):
        ...
        """
        cdef ccimgui_db.ImU8 res = dereference(self._ptr).Used4kPagesMap
        return res
    ...
    def add_remap_char(self: ImFont, dst: int, src: int, overwrite_dst: bool=True):
        ...
        """
        ccimgui_db.ImFont_AddRemapChar(
            self._ptr,
            dst,
            src,
            overwrite_dst
    ...
    def build_lookup_table(self: ImFont):
        ...
        [Internal] Don't use!
        """
        ccimgui_db.ImFont_BuildLookupTable(
            self._ptr
        )
    # [End Method]
    ...
    def calc_text_size_a(self: ImFont, size: float, max_width: float, wrap_width: float, text_begin: str):
        ...
        """
        cdef ccimgui_db.ImVec2 res = ccimgui_db.ImFont_CalcTextSizeA(
            self._ptr,
            size,
            max_width,
            wrap_width,
    ...
    def calc_text_size_ae_x(self: ImFont, size: float, max_width: float, wrap_width: float, text_begin: str, text_end: str=None, remaining: Any=None):
        ...
        Utf8
        """
        cdef ccimgui_db.ImVec2 res = ccimgui_db.ImFont_CalcTextSizeAEx(
            self._ptr,
            size,
            max_width,
            wrap_width,
    ...
    def calc_word_wrap_position_a(self: ImFont, scale: float, text: str, text_end: str, wrap_width: float):
        cdef const char* res = ccimgui_db.ImFont_CalcWordWrapPositionA(
            self._ptr,
            scale,
            _bytes(text),
            _bytes(text_end),
    ...
    def clear_output_data(self: ImFont):
        ccimgui_db.ImFont_ClearOutputData(
            self._ptr
        )
    # [End Method]
    ...
    def find_glyph(self: ImFont, c: int):
        cdef ccimgui_db.ImFontGlyph* res = ccimgui_db.ImFont_FindGlyph(
            self._ptr,
            c
        )
        return ImFontGlyph.from_ptr(res)
    ...
    def find_glyph_no_fallback(self: ImFont, c: int):
        cdef ccimgui_db.ImFontGlyph* res = ccimgui_db.ImFont_FindGlyphNoFallback(
            self._ptr,
            c
        )
        return ImFontGlyph.from_ptr(res)
    ...
    def get_char_advance(self: ImFont, c: int):
        cdef float res = ccimgui_db.ImFont_GetCharAdvance(
            self._ptr,
            c
        )
        return res
    ...
    def get_debug_name(self: ImFont):
        cdef const char* res = ccimgui_db.ImFont_GetDebugName(
            self._ptr
        )
        return _from_bytes(res)
    # [End Method]
    ...
    def is_glyph_range_unused(self: ImFont, c_begin: int, c_last: int):
        cdef bool res = ccimgui_db.ImFont_IsGlyphRangeUnused(
            self._ptr,
            c_begin,
            c_last
        )
    ...
    def is_loaded(self: ImFont):
        cdef bool res = ccimgui_db.ImFont_IsLoaded(
            self._ptr
        )
        return res
    # [End Method]
    ...
    def set_glyph_visible(self: ImFont, c: int, visible: bool):
        ccimgui_db.ImFont_SetGlyphVisible(
            self._ptr,
            c,
            visible
        )
...
cdef class ImFontAtlas:
    ...
    """
    cdef ccimgui_db.ImFontAtlas* _ptr
    ...
    def config_data(self):
        ...
        Configuration data
        """
        cdef ccimgui_db.ImVector_ImFontConfig res = dereference(self._ptr).ConfigData
    ...
    def custom_rects(self):
        ...
        """
        cdef ccimgui_db.ImVector_ImFontAtlasCustomRect res = dereference(self._ptr).CustomRects
    ...
    def flags(self):
        ...
        """
        cdef ccimgui_db.ImFontAtlasFlags res = dereference(self._ptr).Flags
        return res
    @flags.setter
    def flags(self, value: int):
        dereference(self._ptr).Flags = value
    ...
    def font_builder_io(self):
        ...
        """
        cdef ccimgui_db.ImFontBuilderIO* res = dereference(self._ptr).FontBuilderIO
    ...
    def fonts(self):
        ...
        """
        cdef ccimgui_db.ImVector_ImFontPtr res = dereference(self._ptr).Fonts
    ...
    def tex_id(self):
        ...
        """
        cdef ccimgui_db.ImTextureID res = dereference(self._ptr).TexID
        return res
    @tex_id.setter
    ...
    def tex_uv_lines(self):
        ...
        """
        cdef ccimgui_db.ImVec4 res = dereference(self._ptr).TexUvLines
        return _cast_ImVec4_tuple(res)
    @tex_uv_lines.setter
    ...
    def tex_uv_scale(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).TexUvScale
        return _cast_ImVec2_tuple(res)
    @tex_uv_scale.setter
    ...
    def tex_uv_white_pixel(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).TexUvWhitePixel
        return _cast_ImVec2_tuple(res)
    ...
    def add_custom_rect_regular(self: ImFontAtlas, width: int, height: int):
        ...
        """
        cdef int res = ccimgui_db.ImFontAtlas_AddCustomRectRegular(
            self._ptr,
            width,
            height
        )
    ...
    def add_font_from_file_ttf(self: ImFontAtlas, filename: str, size_pixels: float, font_cfg: ImFontConfig=None, glyph_ranges: int=None):
        cdef ccimgui_db.ImFont* res = ccimgui_db.ImFontAtlas_AddFontFromFileTTF(
            self._ptr,
            _bytes(filename),
            size_pixels,
            font_cfg._ptr,
    ...
    def add_font_from_memory_compressed_base85_ttf(self: ImFontAtlas, compressed_font_data_base85: str, size_pixels: float, font_cfg: ImFontConfig=None, glyph_ranges: int=None):
        ...
        """
        cdef ccimgui_db.ImFont* res = ccimgui_db.ImFontAtlas_AddFontFromMemoryCompressedBase85TTF(
            self._ptr,
    ...
    def add_font_from_memory_compressed_ttf(self: ImFontAtlas, compressed_font_data: Any, compressed_font_size: int, size_pixels: float, font_cfg: ImFontConfig=None, glyph_ranges: int=None):
        ...
        """
        cdef ccimgui_db.ImFont* res = ccimgui_db.ImFontAtlas_AddFontFromMemoryCompressedTTF(
            self._ptr,
    ...
    def add_font_from_memory_ttf(self: ImFontAtlas, font_data: Any, font_size: int, size_pixels: float, font_cfg: ImFontConfig=None, glyph_ranges: int=None):
        ...
        """
        cdef ccimgui_db.ImFont* res = ccimgui_db.ImFontAtlas_AddFontFromMemoryTTF(
            self._ptr,
            font_data,
            font_size,
            size_pixels,
    ...
    def build(self: ImFontAtlas):
        ...
        """
        cdef bool res = ccimgui_db.ImFontAtlas_Build(
            self._ptr
        )
        return res
    # [End Method]
    ...
    def clear_fonts(self: ImFontAtlas):
        ...
        """
        ccimgui_db.ImFontAtlas_ClearFonts(
            self._ptr
        )
    # [End Method]
    ...
    def clear_input_data(self: ImFontAtlas):
        ...
        """
        ccimgui_db.ImFontAtlas_ClearInputData(
            self._ptr
        )
    # [End Method]
    ...
    def clear_tex_data(self: ImFontAtlas):
        ...
        """
        ccimgui_db.ImFontAtlas_ClearTexData(
            self._ptr
        )
    # [End Method]
    ...
    def get_custom_rect_by_index(self: ImFontAtlas, index: int):
        cdef ccimgui_db.ImFontAtlasCustomRect* res = ccimgui_db.ImFontAtlas_GetCustomRectByIndex(
            self._ptr,
            index
        )
    ...
    def get_glyph_ranges_chinese_full(self: ImFontAtlas):
        ...
        """
        cdef ccimgui_db.ImWchar* res = ccimgui_db.ImFontAtlas_GetGlyphRangesChineseFull(
            self._ptr
        )
        return res
    # [End Method]
    ...
    def get_glyph_ranges_chinese_simplified_common(self: ImFontAtlas):
        ...
        """
        cdef ccimgui_db.ImWchar* res = ccimgui_db.ImFontAtlas_GetGlyphRangesChineseSimplifiedCommon(
            self._ptr
        )
        return res
    # [End Method]
    ...
    def get_glyph_ranges_cyrillic(self: ImFontAtlas):
        ...
        """
        cdef ccimgui_db.ImWchar* res = ccimgui_db.ImFontAtlas_GetGlyphRangesCyrillic(
            self._ptr
        )
        return res
    # [End Method]
    ...
    def get_glyph_ranges_default(self: ImFontAtlas):
        ...
        """
        cdef ccimgui_db.ImWchar* res = ccimgui_db.ImFontAtlas_GetGlyphRangesDefault(
            self._ptr
        )
        return res
    # [End Method]
    ...
    def get_glyph_ranges_greek(self: ImFontAtlas):
        ...
        """
        cdef ccimgui_db.ImWchar* res = ccimgui_db.ImFontAtlas_GetGlyphRangesGreek(
            self._ptr
        )
        return res
    # [End Method]
    ...
    def get_glyph_ranges_japanese(self: ImFontAtlas):
        ...
        """
        cdef ccimgui_db.ImWchar* res = ccimgui_db.ImFontAtlas_GetGlyphRangesJapanese(
            self._ptr
        )
        return res
    # [End Method]
    ...
    def get_glyph_ranges_korean(self: ImFontAtlas):
        ...
        """
        cdef ccimgui_db.ImWchar* res = ccimgui_db.ImFontAtlas_GetGlyphRangesKorean(
            self._ptr
        )
        return res
    # [End Method]
    ...
    def get_glyph_ranges_thai(self: ImFontAtlas):
        ...
        """
        cdef ccimgui_db.ImWchar* res = ccimgui_db.ImFontAtlas_GetGlyphRangesThai(
            self._ptr
        )
        return res
    # [End Method]
    ...
    def get_glyph_ranges_vietnamese(self: ImFontAtlas):
        ...
        """
        cdef ccimgui_db.ImWchar* res = ccimgui_db.ImFontAtlas_GetGlyphRangesVietnamese(
            self._ptr
        )
        return res
    # [End Method]
    ...
    def get_tex_data_as_alpha8(self: ImFontAtlas, out_pixels: Any, out_width: IntPtr, out_height: IntPtr, out_bytes_per_pixel: IntPtr=None):
        ...
        1 byte per-pixel
        """
        ccimgui_db.ImFontAtlas_GetTexDataAsAlpha8(
            self._ptr,
            out_pixels,
            &out_width.value,
            &out_height.value,
    ...
    def get_tex_data_as_rgba_32(self: ImFontAtlas, out_pixels: Any, out_width: IntPtr, out_height: IntPtr, out_bytes_per_pixel: IntPtr=None):
        ...
        4 bytes-per-pixel
        """
        ccimgui_db.ImFontAtlas_GetTexDataAsRGBA32(
            self._ptr,
            out_pixels,
            &out_width.value,
            &out_height.value,
    ...
    def is_built(self: ImFontAtlas):
        ...
        """
        cdef bool res = ccimgui_db.ImFontAtlas_IsBuilt(
            self._ptr
        )
        return res
    # [End Method]
    ...
    def set_tex_id(self: ImFontAtlas, id_: Any):
        ccimgui_db.ImFontAtlas_SetTexID(
            self._ptr,
            id_
        )
    # [End Method]
...
cdef class ImFontAtlasCustomRect:
    ...
    """
    cdef ccimgui_db.ImFontAtlasCustomRect* _ptr
    ...
    def font(self):
        ...
        """
        cdef ccimgui_db.ImFont* res = dereference(self._ptr).Font
        return ImFont.from_ptr(res)
    @font.setter
    ...
    def glyph_offset(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).GlyphOffset
        return _cast_ImVec2_tuple(res)
    @glyph_offset.setter
    ...
    def is_packed(self: ImFontAtlasCustomRect):
        cdef bool res = ccimgui_db.ImFontAtlasCustomRect_IsPacked(
            self._ptr
        )
        return res
    # [End Method]
...
cdef class ImFontBuilderIO:
    ...
    """
    cdef ccimgui_db.ImFontBuilderIO* _ptr
...
cdef class ImFontConfig:
    ...
    @property
    def dst_font(self):
        cdef ccimgui_db.ImFont* res = dereference(self._ptr).DstFont
        return ImFont.from_ptr(res)
    @dst_font.setter
    ...
    def glyph_extra_spacing(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).GlyphExtraSpacing
        return _cast_ImVec2_tuple(res)
    ...
    def glyph_ranges(self):
        ...
        """
        cdef ccimgui_db.ImWchar* res = dereference(self._ptr).GlyphRanges
        return res
    @glyph_ranges.setter
...
cdef class ImFontGlyph:
    ...
    """
    cdef ccimgui_db.ImFontGlyph* _ptr
...
cdef class ImFontGlyphRangesBuilder:
    ...
    """
    cdef ccimgui_db.ImFontGlyphRangesBuilder* _ptr
    ...
    def used_chars(self):
        ...
        """
        cdef ccimgui_db.ImVector_ImU32 res = dereference(self._ptr).UsedChars
    ...
    def add_char(self: ImFontGlyphRangesBuilder, c: int):
        ...
        Add character
        """
        ccimgui_db.ImFontGlyphRangesBuilder_AddChar(
            self._ptr,
            c
        )
    # [End Method]
    ...
    def add_ranges(self: ImFontGlyphRangesBuilder, ranges: int):
        ...
        """
        ccimgui_db.ImFontGlyphRangesBuilder_AddRanges(
            self._ptr,
            ranges
        )
    # [End Method]
    ...
    def add_text(self: ImFontGlyphRangesBuilder, text: str, text_end: str=None):
        ...
        """
        ccimgui_db.ImFontGlyphRangesBuilder_AddText(
            self._ptr,
            _bytes(text),
            _bytes(text_end)
        )
    ...
    def clear(self: ImFontGlyphRangesBuilder):
        ccimgui_db.ImFontGlyphRangesBuilder_Clear(
            self._ptr
        )
    # [End Method]
    ...
    def get_bit(self: ImFontGlyphRangesBuilder, n: Any):
        ...
        """
        cdef bool res = ccimgui_db.ImFontGlyphRangesBuilder_GetBit(
            self._ptr,
            n
        )
        return res
    ...
    def set_bit(self: ImFontGlyphRangesBuilder, n: Any):
        ...
        """
        ccimgui_db.ImFontGlyphRangesBuilder_SetBit(
            self._ptr,
            n
        )
    # [End Method]
...
cdef class ImGuiContext:
    ...
    """
    cdef ccimgui_db.ImGuiContext* _ptr
...
cdef class ImGuiIO:
    ...
    def backend_flags(self):
        ...
        """
        cdef ccimgui_db.ImGuiBackendFlags res = dereference(self._ptr).BackendFlags
        return res
    ...
    def backend_using_legacy_key_arrays(self):
        ...
        """
        cdef ccimgui_db.ImS8 res = dereference(self._ptr).BackendUsingLegacyKeyArrays
        return res
    ...
    def ctx(self):
        ...
        """
        cdef ccimgui_db.ImGuiContext* res = dereference(self._ptr).Ctx
        return ImGuiContext.from_ptr(res)
    @ctx.setter
    ...
    def display_framebuffer_scale(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).DisplayFramebufferScale
        return _cast_ImVec2_tuple(res)
    ...
    def font_default(self):
        ...
        """
        cdef ccimgui_db.ImFont* res = dereference(self._ptr).FontDefault
        return ImFont.from_ptr(res)
    @font_default.setter
    ...
    def fonts(self):
        ...
        """
        cdef ccimgui_db.ImFontAtlas* res = dereference(self._ptr).Fonts
        return ImFontAtlas.from_ptr(res)
    @fonts.setter
    ...
    def input_queue_characters(self):
        ...
        """
        cdef ccimgui_db.ImVector_ImWchar res = dereference(self._ptr).InputQueueCharacters
        return ImVector_ImWchar.from_ptr(res)
    ...
    def input_queue_surrogate(self):
        ...
        """
        cdef ccimgui_db.ImWchar16 res = dereference(self._ptr).InputQueueSurrogate
        return res
    ...
    def key_mods(self):
        ...
        """
        cdef ccimgui_db.ImGuiKeyChord res = dereference(self._ptr).KeyMods
        return res
    @key_mods.setter
    ...
    def keys_data(self):
        ...
        """
        cdef ccimgui_db.ImGuiKeyData res = dereference(self._ptr).KeysData
    ...
    def mouse_clicked_count(self):
        ...
        """
        cdef ccimgui_db.ImU16 res = dereference(self._ptr).MouseClickedCount
        return res
    ...
    def mouse_clicked_last_count(self):
        ...
        """
        cdef ccimgui_db.ImU16 res = dereference(self._ptr).MouseClickedLastCount
        return res
    ...
    def mouse_clicked_pos(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).MouseClickedPos
        return _cast_ImVec2_tuple(res)
    ...
    def mouse_delta(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).MouseDelta
        return _cast_ImVec2_tuple(res)
    @mouse_delta.setter
    ...
    def mouse_drag_max_distance_abs(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).MouseDragMaxDistanceAbs
        return _cast_ImVec2_tuple(res)
    ...
    def mouse_hovered_viewport(self):
        ...
        """
        cdef ccimgui_db.ImGuiID res = dereference(self._ptr).MouseHoveredViewport
        return res
    ...
    def mouse_pos(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).MousePos
        return _cast_ImVec2_tuple(res)
    @mouse_pos.setter
    ...
    def mouse_pos_prev(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).MousePosPrev
        return _cast_ImVec2_tuple(res)
    ...
    def add_focus_event(self: ImGuiIO, focused: bool):
        ...
        """
        ccimgui_db.ImGuiIO_AddFocusEvent(
            self._ptr,
            focused
        )
    # [End Method]
    ...
    def add_input_character(self: ImGuiIO, c: int):
        ...
        """
        ccimgui_db.ImGuiIO_AddInputCharacter(
            self._ptr,
            c
        )
    # [End Method]
    ...
    def add_input_character_utf_16(self: ImGuiIO, c: int):
        ...
        """
        ccimgui_db.ImGuiIO_AddInputCharacterUTF16(
            self._ptr,
            c
        )
    # [End Method]
    ...
    def add_input_characters_utf_8(self: ImGuiIO, str_: str):
        ...
        """
        ccimgui_db.ImGuiIO_AddInputCharactersUTF8(
            self._ptr,
            _bytes(str_)
        )
    # [End Method]
    ...
    def add_key_analog_event(self: ImGuiIO, key: int, down: bool, v: float):
        ...
        """
        ccimgui_db.ImGuiIO_AddKeyAnalogEvent(
            self._ptr,
            key,
            down,
            v
    ...
    def add_key_event(self: ImGuiIO, key: int, down: bool):
        ...
        """
        ccimgui_db.ImGuiIO_AddKeyEvent(
            self._ptr,
            key,
            down
        )
    ...
    def add_mouse_button_event(self: ImGuiIO, button: int, down: bool):
        ...
        """
        ccimgui_db.ImGuiIO_AddMouseButtonEvent(
            self._ptr,
            button,
            down
        )
    ...
    def add_mouse_pos_event(self: ImGuiIO, x: float, y: float):
        ...
        """
        ccimgui_db.ImGuiIO_AddMousePosEvent(
            self._ptr,
            x,
            y
        )
    ...
    def add_mouse_viewport_event(self: ImGuiIO, id_: int):
        ...
        """
        ccimgui_db.ImGuiIO_AddMouseViewportEvent(
            self._ptr,
            id_
        )
    # [End Method]
    ...
    def add_mouse_wheel_event(self: ImGuiIO, wheel_x: float, wheel_y: float):
        ...
        """
        ccimgui_db.ImGuiIO_AddMouseWheelEvent(
            self._ptr,
            wheel_x,
            wheel_y
        )
    ...
    def clear_input_characters(self: ImGuiIO):
        ...
        """
        ccimgui_db.ImGuiIO_ClearInputCharacters(
            self._ptr
        )
    # [End Method]
    ...
    def clear_input_keys(self: ImGuiIO):
        ...
        """
        ccimgui_db.ImGuiIO_ClearInputKeys(
            self._ptr
        )
    # [End Method]
    ...
    def set_app_accepting_events(self: ImGuiIO, accepting_events: bool):
        ...
        """
        ccimgui_db.ImGuiIO_SetAppAcceptingEvents(
            self._ptr,
            accepting_events
        )
    # [End Method]
    ...
    def set_key_event_native_data(self: ImGuiIO, key: int, native_keycode: int, native_scancode: int):
        ...
        """
        ccimgui_db.ImGuiIO_SetKeyEventNativeData(
            self._ptr,
            key,
            native_keycode,
            native_scancode
    ...
    def set_key_event_native_data_ex(self: ImGuiIO, key: int, native_keycode: int, native_scancode: int, native_legacy_index: int=-1):
        ...
        """
        ccimgui_db.ImGuiIO_SetKeyEventNativeDataEx(
            self._ptr,
            key,
            native_keycode,
            native_scancode,
...
cdef class ImGuiInputTextCallbackData:
    ...
    """
    cdef ccimgui_db.ImGuiInputTextCallbackData* _ptr
    ...
    def event_char(self):
        ...
        """
        cdef ccimgui_db.ImWchar res = dereference(self._ptr).EventChar
        return res
    @event_char.setter
    ...
    def event_flag(self):
        ...
        """
        cdef ccimgui_db.ImGuiInputTextFlags res = dereference(self._ptr).EventFlag
        return res
    @event_flag.setter
    ...
    def event_key(self):
        ...
        """
        cdef ccimgui_db.ImGuiKey res = dereference(self._ptr).EventKey
        return res
    @event_key.setter
    ...
    def flags(self):
        ...
        """
        cdef ccimgui_db.ImGuiInputTextFlags res = dereference(self._ptr).Flags
        return res
    @flags.setter
    def flags(self, value: int):
        dereference(self._ptr).Flags = value
    ...
    def clear_selection(self: ImGuiInputTextCallbackData):
        ccimgui_db.ImGuiInputTextCallbackData_ClearSelection(
            self._ptr
        )
    # [End Method]
    ...
    def delete_chars(self: ImGuiInputTextCallbackData, pos: int, bytes_count: int):
        ccimgui_db.ImGuiInputTextCallbackData_DeleteChars(
            self._ptr,
            pos,
            bytes_count
        )
    ...
    def has_selection(self: ImGuiInputTextCallbackData):
        cdef bool res = ccimgui_db.ImGuiInputTextCallbackData_HasSelection(
            self._ptr
        )
        return res
    # [End Method]
    ...
    def insert_chars(self: ImGuiInputTextCallbackData, pos: int, text: str, text_end: str=None):
        ccimgui_db.ImGuiInputTextCallbackData_InsertChars(
            self._ptr,
            pos,
            _bytes(text),
            _bytes(text_end)
    ...
    def select_all(self: ImGuiInputTextCallbackData):
        ccimgui_db.ImGuiInputTextCallbackData_SelectAll(
            self._ptr
        )
    # [End Method]
...
cdef class ImGuiKeyData:
    ...
    """
    cdef ccimgui_db.ImGuiKeyData* _ptr
...
cdef class ImGuiListClipper:
    ...
    """
    cdef ccimgui_db.ImGuiListClipper* _ptr
    ...
    def begin(self: ImGuiListClipper, items_count: int, items_height: float=-1.0):
        ccimgui_db.ImGuiListClipper_Begin(
            self._ptr,
            items_count,
            items_height
        )
    ...
    def end(self: ImGuiListClipper):
        ...
        """
        ccimgui_db.ImGuiListClipper_End(
            self._ptr
        )
    # [End Method]
    ...
    def force_display_range_by_indices(self: ImGuiListClipper, item_min: int, item_max: int):
        ...
        """
        ccimgui_db.ImGuiListClipper_ForceDisplayRangeByIndices(
            self._ptr,
            item_min,
            item_max
        )
    ...
    def step(self: ImGuiListClipper):
        ...
        """
        cdef bool res = ccimgui_db.ImGuiListClipper_Step(
            self._ptr
        )
        return res
    # [End Method]
...
cdef class ImGuiPayload:
    ...
    """
    cdef ccimgui_db.ImGuiPayload* _ptr
    ...
    def source_id(self):
        ...
        Source item id
        """
        cdef ccimgui_db.ImGuiID res = dereference(self._ptr).SourceId
        return res
    @source_id.setter
    ...
    def source_parent_id(self):
        ...
        """
        cdef ccimgui_db.ImGuiID res = dereference(self._ptr).SourceParentId
        return res
    ...
    def is_data_type(self: ImGuiPayload, type_: str):
        cdef bool res = ccimgui_db.ImGuiPayload_IsDataType(
            self._ptr,
            _bytes(type_)
        )
        return res
    ...
    def is_delivery(self: ImGuiPayload):
        cdef bool res = ccimgui_db.ImGuiPayload_IsDelivery(
            self._ptr
        )
        return res
    # [End Method]
    ...
    def is_preview(self: ImGuiPayload):
        cdef bool res = ccimgui_db.ImGuiPayload_IsPreview(
            self._ptr
        )
        return res
    # [End Method]
...
cdef class ImGuiPlatformIO:
    ...
    """
    cdef ccimgui_db.ImGuiPlatformIO* _ptr
    ...
    def monitors(self):
        ...
        """
        cdef ccimgui_db.ImVector_ImGuiPlatformMonitor res = dereference(self._ptr).Monitors
    ...
    def viewports(self):
        ...
        """
        cdef ccimgui_db.ImVector_ImGuiViewportPtr res = dereference(self._ptr).Viewports
...
cdef class ImGuiPlatformImeData:
    ...
    """
    cdef ccimgui_db.ImGuiPlatformImeData* _ptr
    ...
    def input_pos(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).InputPos
        return _cast_ImVec2_tuple(res)
    @input_pos.setter
...
cdef class ImGuiPlatformMonitor:
    ...
    """
    cdef ccimgui_db.ImGuiPlatformMonitor* _ptr
    ...
    def main_pos(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).MainPos
        return _cast_ImVec2_tuple(res)
    @main_pos.setter
    ...
    def main_size(self):
        ...
        Coordinates of the area displayed on this monitor (min = upper left, max = bottom right)
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).MainSize
        return _cast_ImVec2_tuple(res)
    @main_size.setter
    ...
    def work_pos(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).WorkPos
        return _cast_ImVec2_tuple(res)
    @work_pos.setter
    ...
    def work_size(self):
        ...
        Coordinates without task bars / side bars / menu bars. used to avoid positioning popups/tooltips inside this region. if you don't have this info, please copy the value for mainpos/mainsize.
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).WorkSize
        return _cast_ImVec2_tuple(res)
    @work_size.setter
...
cdef class ImGuiSizeCallbackData:
    ...
    """
    cdef ccimgui_db.ImGuiSizeCallbackData* _ptr
    ...
    def current_size(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).CurrentSize
        return _cast_ImVec2_tuple(res)
    @current_size.setter
    ...
    def desired_size(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).DesiredSize
        return _cast_ImVec2_tuple(res)
    @desired_size.setter
...
cdef class ImGuiStorage:
    ...
    """
    cdef ccimgui_db.ImGuiStorage* _ptr
    ...
    @property
    def data(self):
        cdef ccimgui_db.ImVector_ImGuiStorage_ImGuiStoragePair res = dereference(self._ptr).Data
    ...
    def build_sort_by_key(self: ImGuiStorage):
        ...
        """
        ccimgui_db.ImGuiStorage_BuildSortByKey(
            self._ptr
        )
    # [End Method]
    ...
    def get_bool(self: ImGuiStorage, key: int, default_val: bool=False):
        cdef bool res = ccimgui_db.ImGuiStorage_GetBool(
            self._ptr,
            key,
            default_val
        )
    ...
    def get_bool_ref(self: ImGuiStorage, key: int, default_val: bool=False):
        cdef bool* res = ccimgui_db.ImGuiStorage_GetBoolRef(
            self._ptr,
            key,
            default_val
        )
    ...
    def get_float(self: ImGuiStorage, key: int, default_val: float=0.0):
        cdef float res = ccimgui_db.ImGuiStorage_GetFloat(
            self._ptr,
            key,
            default_val
        )
    ...
    def get_float_ref(self: ImGuiStorage, key: int, default_val: float=0.0):
        cdef float* res = ccimgui_db.ImGuiStorage_GetFloatRef(
            self._ptr,
            key,
            default_val
        )
    ...
    def get_int(self: ImGuiStorage, key: int, default_val: int=0):
        cdef int res = ccimgui_db.ImGuiStorage_GetInt(
            self._ptr,
            key,
            default_val
        )
    ...
    def get_int_ref(self: ImGuiStorage, key: int, default_val: int=0):
        ...
        """
        cdef int* res = ccimgui_db.ImGuiStorage_GetIntRef(
            self._ptr,
            key,
            default_val
        )
    ...
    def get_void_ptr(self: ImGuiStorage, key: int):
        ...
        Default_val is null
        """
        cdef void* res = ccimgui_db.ImGuiStorage_GetVoidPtr(
            self._ptr,
            key
        )
        return res
    ...
    def get_void_ptr_ref(self: ImGuiStorage, key: int, default_val: Any=None):
        cdef void** res = ccimgui_db.ImGuiStorage_GetVoidPtrRef(
            self._ptr,
            key,
            default_val
        )
    ...
    def set_all_int(self: ImGuiStorage, val: int):
        ...
        """
        ccimgui_db.ImGuiStorage_SetAllInt(
            self._ptr,
            val
        )
    # [End Method]
    ...
    def set_bool(self: ImGuiStorage, key: int, val: bool):
        ccimgui_db.ImGuiStorage_SetBool(
            self._ptr,
            key,
            val
        )
    ...
    def set_float(self: ImGuiStorage, key: int, val: float):
        ccimgui_db.ImGuiStorage_SetFloat(
            self._ptr,
            key,
            val
        )
    ...
    def set_int(self: ImGuiStorage, key: int, val: int):
        ccimgui_db.ImGuiStorage_SetInt(
            self._ptr,
            key,
            val
        )
    ...
    def set_void_ptr(self: ImGuiStorage, key: int, val: Any):
        ccimgui_db.ImGuiStorage_SetVoidPtr(
            self._ptr,
            key,
            val
        )
...
cdef class ImGuiStorage_ImGuiStoragePair:
    ...
    [Internal]
    """
    cdef ccimgui_db.ImGuiStorage_ImGuiStoragePair* _ptr
    ...
    @property
    def key(self):
        cdef ccimgui_db.ImGuiID res = dereference(self._ptr).key
        return res
    @key.setter
...
cdef class ImGuiStyle:
    ...
    def button_text_align(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).ButtonTextAlign
        return _cast_ImVec2_tuple(res)
    ...
    def cell_padding(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).CellPadding
        return _cast_ImVec2_tuple(res)
    @cell_padding.setter
    ...
    def color_button_position(self):
        ...
        """
        cdef ccimgui_db.ImGuiDir res = dereference(self._ptr).ColorButtonPosition
        return res
    ...
    @property
    def colors(self):
        cdef ccimgui_db.ImVec4 res = dereference(self._ptr).Colors
        return _cast_ImVec4_tuple(res)
    @colors.setter
    ...
    def display_safe_area_padding(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).DisplaySafeAreaPadding
        return _cast_ImVec2_tuple(res)
    ...
    def display_window_padding(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).DisplayWindowPadding
        return _cast_ImVec2_tuple(res)
    ...
    def frame_padding(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).FramePadding
        return _cast_ImVec2_tuple(res)
    ...
    def item_inner_spacing(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).ItemInnerSpacing
        return _cast_ImVec2_tuple(res)
    ...
    def item_spacing(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).ItemSpacing
        return _cast_ImVec2_tuple(res)
    @item_spacing.setter
    ...
    def selectable_text_align(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).SelectableTextAlign
        return _cast_ImVec2_tuple(res)
    ...
    def separator_text_align(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).SeparatorTextAlign
        return _cast_ImVec2_tuple(res)
    ...
    def separator_text_padding(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).SeparatorTextPadding
        return _cast_ImVec2_tuple(res)
    ...
    def touch_extra_padding(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).TouchExtraPadding
        return _cast_ImVec2_tuple(res)
    ...
    def window_menu_button_position(self):
        ...
        """
        cdef ccimgui_db.ImGuiDir res = dereference(self._ptr).WindowMenuButtonPosition
        return res
    ...
    def window_min_size(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).WindowMinSize
        return _cast_ImVec2_tuple(res)
    ...
    def window_padding(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).WindowPadding
        return _cast_ImVec2_tuple(res)
    ...
    def window_title_align(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).WindowTitleAlign
        return _cast_ImVec2_tuple(res)
    ...
    def scale_all_sizes(self: ImGuiStyle, scale_factor: float):
        ccimgui_db.ImGuiStyle_ScaleAllSizes(
            self._ptr,
            scale_factor
        )
    # [End Method]
...
cdef class ImGuiTableColumnSortSpecs:
    ...
    """
    cdef ccimgui_db.ImGuiTableColumnSortSpecs* _ptr
    ...
    def column_index(self):
        ...
        Index of the column
        """
        cdef ccimgui_db.ImS16 res = dereference(self._ptr).ColumnIndex
        return res
    @column_index.setter
    ...
    def column_user_id(self):
        ...
        """
        cdef ccimgui_db.ImGuiID res = dereference(self._ptr).ColumnUserID
        return res
    ...
    def sort_direction(self):
        ...
        """
        cdef ccimgui_db.ImGuiSortDirection res = dereference(self._ptr).SortDirection
        return res
    ...
    def sort_order(self):
        ...
        """
        cdef ccimgui_db.ImS16 res = dereference(self._ptr).SortOrder
        return res
    @sort_order.setter
...
cdef class ImGuiTableSortSpecs:
    ...
    """
    cdef ccimgui_db.ImGuiTableSortSpecs* _ptr
    ...
    def specs(self):
        ...
        """
        cdef ccimgui_db.ImGuiTableColumnSortSpecs* res = dereference(self._ptr).Specs
...
cdef class ImGuiTextBuffer:
    ...
    """
    cdef ccimgui_db.ImGuiTextBuffer* _ptr
    ...
    @property
    def buf(self):
        cdef ccimgui_db.ImVector_char res = dereference(self._ptr).Buf
    ...
    def append(self: ImGuiTextBuffer, str_: str, str_end: str=None):
        ccimgui_db.ImGuiTextBuffer_append(
            self._ptr,
            _bytes(str_),
            _bytes(str_end)
        )
    ...
    def appendf(self: ImGuiTextBuffer, fmt: str):
        ccimgui_db.ImGuiTextBuffer_appendf(
            self._ptr,
            _bytes(fmt)
        )
    # [End Method]
    ...
    def appendfv(self: ImGuiTextBuffer, fmt: str):
        ccimgui_db.ImGuiTextBuffer_appendfv(
            self._ptr,
            _bytes(fmt)
        )
    # [End Method]
    ...
    def begin(self: ImGuiTextBuffer):
        cdef const char* res = ccimgui_db.ImGuiTextBuffer_begin(
            self._ptr
        )
        return _from_bytes(res)
    # [End Method]
    ...
    def cstr(self: ImGuiTextBuffer):
        cdef const char* res = ccimgui_db.ImGuiTextBuffer_c_str(
            self._ptr
        )
        return _from_bytes(res)
    # [End Method]
    ...
    def clear(self: ImGuiTextBuffer):
        ccimgui_db.ImGuiTextBuffer_clear(
            self._ptr
        )
    # [End Method]
    ...
    def empty(self: ImGuiTextBuffer):
        cdef bool res = ccimgui_db.ImGuiTextBuffer_empty(
            self._ptr
        )
        return res
    # [End Method]
    ...
    def end(self: ImGuiTextBuffer):
        ...
        """
        cdef const char* res = ccimgui_db.ImGuiTextBuffer_end(
            self._ptr
        )
        return _from_bytes(res)
    # [End Method]
    ...
    def reserve(self: ImGuiTextBuffer, capacity: int):
        ccimgui_db.ImGuiTextBuffer_reserve(
            self._ptr,
            capacity
        )
    # [End Method]
    ...
    def size(self: ImGuiTextBuffer):
        cdef int res = ccimgui_db.ImGuiTextBuffer_size(
            self._ptr
        )
        return res
    # [End Method]
...
cdef class ImGuiTextFilter:
    ...
    """
    cdef ccimgui_db.ImGuiTextFilter* _ptr
    ...
    @property
    def filters(self):
        cdef ccimgui_db.ImVector_ImGuiTextFilter_ImGuiTextRange res = dereference(self._ptr).Filters
    ...
    def build(self: ImGuiTextFilter):
        ccimgui_db.ImGuiTextFilter_Build(
            self._ptr
        )
    # [End Method]
    ...
    def clear(self: ImGuiTextFilter):
        ccimgui_db.ImGuiTextFilter_Clear(
            self._ptr
        )
    # [End Method]
    ...
    def draw(self: ImGuiTextFilter, label: str="Filter (inc,-exc)", width: float=0.0):
        ...
        """
        cdef bool res = ccimgui_db.ImGuiTextFilter_Draw(
            self._ptr,
            _bytes(label),
            width
        )
    ...
    def is_active(self: ImGuiTextFilter):
        cdef bool res = ccimgui_db.ImGuiTextFilter_IsActive(
            self._ptr
        )
        return res
    # [End Method]
    ...
    def pass_filter(self: ImGuiTextFilter, text: str, text_end: str=None):
        cdef bool res = ccimgui_db.ImGuiTextFilter_PassFilter(
            self._ptr,
            _bytes(text),
            _bytes(text_end)
        )
...
cdef class ImGuiTextFilter_ImGuiTextRange:
    ...
    [Internal]
    """
    cdef ccimgui_db.ImGuiTextFilter_ImGuiTextRange* _ptr
    ...
    def empty(self: ImGuiTextFilter_ImGuiTextRange):
        cdef bool res = ccimgui_db.ImGuiTextFilter_ImGuiTextRange_empty(
            self._ptr
        )
        return res
    # [End Method]
...
cdef class ImGuiViewport:
    ...
    """
    cdef ccimgui_db.ImGuiViewport* _ptr
    ...
    def draw_data(self):
        ...
        """
        cdef ccimgui_db.ImDrawData* res = dereference(self._ptr).DrawData
        return ImDrawData.from_ptr(res)
    @draw_data.setter
    ...
    def flags(self):
        ...
        """
        cdef ccimgui_db.ImGuiViewportFlags res = dereference(self._ptr).Flags
        return res
    @flags.setter
    def flags(self, value: int):
        dereference(self._ptr).Flags = value
    ...
    def id(self):
        ...
        """
        cdef ccimgui_db.ImGuiID res = dereference(self._ptr).ID
        return res
    @id.setter
    ...
    def parent_viewport_id(self):
        ...
        """
        cdef ccimgui_db.ImGuiID res = dereference(self._ptr).ParentViewportId
        return res
    ...
    def size(self):
        ...
        """
        cdef ccimgui_db.ImVec2 res = dereference(self._ptr).Size
        return _cast_ImVec2_tuple(res)
    @size.setter
    ...
    def get_center(self: ImGuiViewport):
        ...
        Helpers
        """
        cdef ccimgui_db.ImVec2 res = ccimgui_db.ImGuiViewport_GetCenter(
            self._ptr
        )
        return _cast_ImVec2_tuple(res)
    # [End Method]
    ...
    def get_work_center(self: ImGuiViewport):
        cdef ccimgui_db.ImVec2 res = ccimgui_db.ImGuiViewport_GetWorkCenter(
            self._ptr
        )
        return _cast_ImVec2_tuple(res)
    # [End Method]
...
cdef class ImGuiWindowClass:
    ...
    """
    cdef ccimgui_db.ImGuiWindowClass* _ptr
    ...
    def class_id(self):
        ...
        """
        cdef ccimgui_db.ImGuiID res = dereference(self._ptr).ClassId
        return res
    @class_id.setter
    ...
    def dock_node_flags_override_set(self):
        ...
        """
        cdef ccimgui_db.ImGuiDockNodeFlags res = dereference(self._ptr).DockNodeFlagsOverrideSet
        return res
    ...
    def tab_item_flags_override_set(self):
        ...
        """
        cdef ccimgui_db.ImGuiTabItemFlags res = dereference(self._ptr).TabItemFlagsOverrideSet
        return res
    ...
    def viewport_flags_override_clear(self):
        ...
        """
        cdef ccimgui_db.ImGuiViewportFlags res = dereference(self._ptr).ViewportFlagsOverrideClear
        return res
    ...
    def viewport_flags_override_set(self):
        ...
        """
        cdef ccimgui_db.ImGuiViewportFlags res = dereference(self._ptr).ViewportFlagsOverrideSet
        return res
...
cdef class ImVector_ImDrawChannel:
    ...
    @property
    def data(self):
        cdef ccimgui_db.ImDrawChannel* res = dereference(self._ptr).Data
...
cdef class ImVector_ImDrawCmd:
    ...
    @property
    def data(self):
        cdef ccimgui_db.ImDrawCmd* res = dereference(self._ptr).Data
...
cdef class ImVector_ImDrawIdx:
    ...
    @property
    def data(self):
        cdef ccimgui_db.ImDrawIdx* res = dereference(self._ptr).Data
        return res
    @data.setter
...
cdef class ImVector_ImDrawVert:
    ...
    @property
    def data(self):
        cdef ccimgui_db.ImDrawVert* res = dereference(self._ptr).Data
        return ImDrawVert.from_ptr(res)
    @data.setter
...
cdef class ImVector_ImFontAtlasCustomRect:
    ...
    @property
    def data(self):
        cdef ccimgui_db.ImFontAtlasCustomRect* res = dereference(self._ptr).Data
        return ImFontAtlasCustomRect.from_ptr(res)
    @data.setter
...
cdef class ImVector_ImFontConfig:
    ...
    @property
    def data(self):
        cdef ccimgui_db.ImFontConfig* res = dereference(self._ptr).Data
        return ImFontConfig.from_ptr(res)
    @data.setter
...
cdef class ImVector_ImFontGlyph:
    ...
    @property
    def data(self):
        cdef ccimgui_db.ImFontGlyph* res = dereference(self._ptr).Data
        return ImFontGlyph.from_ptr(res)
    @data.setter
...
cdef class ImVector_ImFontPtr:
    ...
    @property
    def data(self):
        cdef ccimgui_db.ImFont** res = dereference(self._ptr).Data
        return ImFont.from_ptr(res)
    @data.setter
...
cdef class ImVector_ImGuiPlatformMonitor:
    ...
    @property
    def data(self):
        cdef ccimgui_db.ImGuiPlatformMonitor* res = dereference(self._ptr).Data
...
cdef class ImVector_ImGuiStorage_ImGuiStoragePair:
    ...
    @property
    def data(self):
        cdef ccimgui_db.ImGuiStorage_ImGuiStoragePair* res = dereference(self._ptr).Data
...
cdef class ImVector_ImGuiTextFilter_ImGuiTextRange:
    ...
    @property
    def data(self):
        cdef ccimgui_db.ImGuiTextFilter_ImGuiTextRange* res = dereference(self._ptr).Data
...
cdef class ImVector_ImGuiViewportPtr:
    ...
    @property
    def data(self):
        cdef ccimgui_db.ImGuiViewport** res = dereference(self._ptr).Data
        return ImGuiViewport.from_ptr(res)
    @data.setter
...
cdef class ImVector_ImTextureID:
    ...
    @property
    def data(self):
        cdef ccimgui_db.ImTextureID* res = dereference(self._ptr).Data
        return res
    @data.setter
    def data(self, value: Any):
        dereference(self._ptr).Data = value
...
cdef class ImVector_ImU32:
    ...
    @property
    def data(self):
        cdef ccimgui_db.ImU32* res = dereference(self._ptr).Data
        return res
    @data.setter
    def data(self, value: int):
        dereference(self._ptr).Data = value
...
cdef class ImVector_ImVec2:
    ...
    @property
    def data(self):
        cdef ccimgui_db.ImVec2* res = dereference(self._ptr).Data
...
cdef class ImVector_ImVec4:
    ...
    @property
    def data(self):
        cdef ccimgui_db.ImVec4* res = dereference(self._ptr).Data
        return ImVec4.from_ptr(res)
    @data.setter
...
cdef class ImVector_ImWchar:
    ...
    @property
    def data(self):
        cdef ccimgui_db.ImWchar* res = dereference(self._ptr).Data
        return res
    @data.setter
    def data(self, value: int):
        dereference(self._ptr).Data = value
