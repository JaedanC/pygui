...
# def impl_glfw_char_callback(window: GLFWwindow=None, c: int=None) -> None: ...
# def impl_glfw_cursor_enter_callback(window: GLFWwindow=None, entered: int=None) -> None: ...
# def impl_glfw_cursor_pos_callback(window: GLFWwindow=None, x: float=None, y: float=None) -> None: ...
def impl_glfw_init_for_open_gl(window, install_callbacks: bool) -> bool: ...
# def impl_glfw_init_for_other(window: GLFWwindow=None, install_callbacks: bool=None) -> bool: ...
# def impl_glfw_init_for_vulkan(window: GLFWwindow=None, install_callbacks: bool=None) -> bool: ...
# def impl_glfw_install_callbacks(window: GLFWwindow=None) -> None: ...
# def impl_glfw_key_callback(window: GLFWwindow=None, key: int=None, scancode: int=None, action: int=None, mods: int=None) -> None: ...
# def impl_glfw_monitor_callback(monitor: GLFWmonitor=None, event: int=None) -> None: ...
# def impl_glfw_mouse_button_callback(window: GLFWwindow=None, button: int=None, action: int=None, mods: int=None) -> None: ...
def impl_glfw_new_frame() -> None: ...
# def impl_glfw_restore_callbacks(window: GLFWwindow=None) -> None: ...
# def impl_glfw_scroll_callback(window: GLFWwindow=None, xoffset: float=None, yoffset: float=None) -> None: ...
# def impl_glfw_set_callbacks_chain_for_all_windows(chain_for_all_windows: bool=None) -> None: ...
def impl_glfw_shutdown() -> None: ...
# def impl_glfw_window_focus_callback(window: GLFWwindow=None, focused: int=None) -> None: ...
...
def impl_open_gl_3_render_draw_data(draw_data) -> None: ...
def impl_open_gl_3_shutdown() -> None: ...
# def impl_open_gl_3_shutdown_hello() -> None: ...
