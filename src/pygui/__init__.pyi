...
# def impl_glfw_char_callback(window: Any, c: int) -> None: ...
# def impl_glfw_cursor_enter_callback(window: Any, entered: int) -> None: ...
# def impl_glfw_cursor_pos_callback(window: Any, x: float, y: float) -> None: ...
# def impl_glfw_init_for_open_gl(window: Any, install_callbacks: Any) -> Any: ...
# def impl_glfw_init_for_other(window: Any, install_callbacks: Any) -> Any: ...
# def impl_glfw_init_for_vulkan(window: Any, install_callbacks: Any) -> Any: ...
# def impl_glfw_install_callbacks(window: Any) -> None: ...
# def impl_glfw_key_callback(window: Any, key: int, scancode: int, action: int, mods: int) -> None: ...
# def impl_glfw_monitor_callback(monitor: Any, event: int) -> None: ...
# def impl_glfw_mouse_button_callback(window: Any, button: int, action: int, mods: int) -> None: ...
# def impl_glfw_new_frame() -> None: ...
# def impl_glfw_restore_callbacks(window: Any) -> None: ...
# def impl_glfw_scroll_callback(window: Any, xoffset: float, yoffset: float) -> None: ...
# def impl_glfw_set_callbacks_chain_for_all_windows(chain_for_all_windows: Any) -> None: ...
# def impl_glfw_shutdown() -> None: ...
# def impl_glfw_window_focus_callback(window: Any, focused: int) -> None: ...
# def impl_open_gl2_create_device_objects() -> Any: ...
# def impl_open_gl2_create_fonts_texture() -> Any: ...
# def impl_open_gl2_destroy_device_objects() -> None: ...
# def impl_open_gl2_destroy_fonts_texture() -> None: ...
# def impl_open_gl2_init() -> Any: ...
# def impl_open_gl2_new_frame() -> None: ...
# def impl_open_gl2_render_draw_data(draw_data: ImDrawData) -> None: ...
# def impl_open_gl2_shutdown() -> None: ...
...
# def impl_open_gl3_init(glsl_version: str=nullptr) -> Any: ...
...
# def impl_sdl2_init_for_d3d(window: Any) -> Any: ...
# def impl_sdl2_init_for_metal(window: Any) -> Any: ...
# def impl_sdl2_init_for_open_gl(window: Any, sdl_gl_context: Any) -> Any: ...
# def impl_sdl2_init_for_sdl_renderer(window: Any, renderer: Any) -> Any: ...
# def impl_sdl2_init_for_vulkan(window: Any) -> Any: ...
# def impl_sdl2_new_frame() -> None: ...
# def impl_sdl2_process_event(event: Any) -> Any: ...
# def impl_sdl2_shutdown() -> None: ...
