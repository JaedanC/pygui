...
def input_double(label: str, value: DoublePtr, step: double=0.0, step_fast: double=0.0, format_: str="%.6", flags: int=0) -> Any: ...
def input_float(label: str, value: FloatPtr, step: float=0.0, step_fast: float=0.0, format_: str="%.3", flags: int=0) -> Any: ...
# def input_float2(label: str, value0: float, value1: float, format_: str="%.3", flags: int=0) -> Any: ...
# def input_float3(label: str, values: List[FloatPtr], format_: str="%.3", flags: int=0) -> Any: ...
