...
def color_convert_hsv_to_rgb(h: float, s: float, value: float, out_r: FloatPtr, out_g: FloatPtr, out_b: FloatPtr) -> None: ...
...
def color_edit3(label: str, colours: List[FloatPtr], flags: int=0) -> bool: ...
def color_edit4(label: str, colours: List[FloatPtr], flags: int=0) -> bool: ...
# def color_picker3(label: str, col0: float, col1: float, col2: float, flags: int=0) -> Any: ...
def color_picker4(label: str, color: List[FloatPtr], flags: int=0, ref_col: List[FloatPtr]=None) -> bool: ...
# def columns(count: int=1, id_: str=None, border: Any=True) -> None: ...
def combo(label: str, current_item: IntPtr, items: List[str], popup_max_height_in_items: int=-1) -> bool: ...
...
def image_button(str_id: str, user_texture_id: int, size: tuple, uv0: tuple=(0, 0), uv1: tuple=(1, 1), bg_col: tuple=(0, 0, 0, 0), tint_col: tuple=(1, 1, 1, 1)) -> Any: ...
...
# def impl_glfw_init_for_other(window: GLFWwindow, install_callbacks: Any) -> Any: ...
# def impl_glfw_init_for_vulkan(window: GLFWwindow, install_callbacks: Any) -> Any: ...
...
# def impl_glfw_set_callbacks_chain_for_all_windows(chain_for_all_windows: Any) -> None: ...
def impl_glfw_shutdown() -> None: ...
# def impl_glfw_window_focus_callback(window: GLFWwindow, focused: int) -> None: ...
# def impl_open_gl3_create_device_objects() -> Any: ...
# def impl_open_gl3_create_fonts_texture() -> Any: ...
...
def input_float2(label: str, float_ptrs: List[FloatPtr], format_: str="%.3f", flags: int=0) -> bool: ...
def input_float3(label: str, float_ptrs: List[FloatPtr], format_: str="%.3f", flags: int=0) -> bool: ...
def input_float4(label: str, float_ptrs: List[FloatPtr], format_: str="%.3f", flags: int=0) -> bool: ...
...
# def input_text_multiline(label: str, buf: str, buf_size: Any, size: tuple=(0, 0), flags: int=0, callback: Callable=None, user_data: Any=None) -> Any: ...
def input_text_with_hint(label: str, hint: str, str_ptr: StrPtr, flags: int=0, callback: Callable=None, user_data: Any=None) -> Any: ...
...
def list_box(label: str, current_item: IntPtr, items: List[str], height_in_items: int=-1) -> bool: ...
...
def plot_histogram(label: str, values: List[float], values_offset: int=0, overlay_text: str=None, scale_min: float=FLT_MAX, scale_max: float=FLT_MAX, graph_size: tuple=(0, 0), stride: int=sizeof(float)) -> None: ...
...
def plot_lines(label: str, values: List[float], values_offset: int=0, overlay_text: str=None, scale_min: float=FLT_MAX, scale_max: float=FLT_MAX, graph_size: tuple=(0, 0), stride: int=sizeof(float)) -> None: ...
...
# def push_tab_stop(tab_stop: Any) -> None: ...
...
class ImGuiIO:
    ...
    # config_debug_begin_return_value_loop: Any
    # config_debug_begin_return_value_once: Any
