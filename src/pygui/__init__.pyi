...
def plot_lines(label: str, values: List[float], values_offset: int=0, overlay_text: str="", scale_min: float=FLT_MAX, scale_max: float=FLT_MAX, graph_size: tuple=(0, 0), stride: int=sizeof(float)) -> None: ...
...
class ImGuiIO:
    ...
    # mouse_source: Any
    mouse_wheel: float
    # mouse_wheel_request_axis_swap: Any
    mouse_wheelh: float
    # nav_active: Any
    # nav_inputs: float
    # nav_visible: Any
