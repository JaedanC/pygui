...
IMGUI_MOUSE_SOURCE_MOUSE: int
IMGUI_MOUSE_SOURCE_TOUCH_SCREEN: int
IMGUI_MOUSE_SOURCE_PEN: int
IMGUI_MOUSE_SOURCE_COUNT: int
...
IMGUI_VIEWPORT_FLAGS_IS_MINIMIZED: int
IMGUI_VIEWPORT_FLAGS_IS_FOCUSED: int
...
# def begin_child_str(str_id: str, size: tuple=(0, 0), border: bool=False, flags: int=0) -> bool: ...
...
# def calc_text_size(pOut: ImVec2, text: str, text_end: str=None, hide_text_after_double_hash: bool=False, wrap_width: float=-1.0) -> None: ...
def checkbox(label: str, value: BoolPtr) -> bool: ...
def checkbox_flags(label: str, flags: IntPtr, flags_value: int) -> bool: ...
# def checkbox_flags_int_ptr(label: str, flags: int, flags_value: int) -> bool: ...
# def checkbox_flags_uint_ptr(label: str, flags: int, flags_value: int) -> bool: ...
# def close_current_popup() -> None: ...
def collapsing_header(label: str, p_visible: BoolPtr=None, flags: int=0) -> Any: ...
# def collapsing_header_bool_ptr(label: str, p_visible: BoolPtr, flags: int=0) -> bool: ...
# def collapsing_header_tree_node_flags(label: str, flags: int=0) -> bool: ...
...
def color_convert_hsv_to_rgb(h: float, s: float, value: float, colour: Vec4Ptr) -> None: ...
...
# def combo_fn_bool_ptr(label: str, current_item: int, items_getter: Callable, data: Any, items_count: int, popup_max_height_in_items: int=-1) -> bool: ...
# def combo_func_deprecated(label: str, current_item: int, items_getter: Callable[[int, Any], str], data: Any, items_count: int, popup_max_height_in_items: int=-1) -> bool: ...
# def combo_str(label: str, current_item: int, items_separated_by_zeros: str, popup_max_height_in_items: int=-1) -> bool: ...
# def combo_str_arr(label: str, current_item: int, items: Any, items_count: int, popup_max_height_in_items: int=-1) -> bool: ...
...
def drag_float(label: str, value: FloatPtr, v_speed: float=1.0, v_min: float=0.0, v_max: float=0.0, format_: str="%.3f", flags: int=0) -> bool: ...
...
# def drag_float_range2(label: str, v_current_min: float, v_current_max: float, v_speed: float=1.0, v_min: float=0.0, v_max: float=0.0, format_: str="%.3", format_max: str=None, flags: int=0) -> bool: ...
...
# def drag_scalar(label: str, data_type: int, p_data: Any, v_speed: float=1.0, p_min: Any=None, p_max: Any=None, format_: str=None, flags: int=0) -> bool: ...
# def drag_scalarn(label: str, data_type: int, p_data: Any, components: int, v_speed: float=1.0, p_min: Any=None, p_max: Any=None, format_: str=None, flags: int=0) -> bool: ...
...
def input_double(label: str, value: DoublePtr, step: float=0.0, step_fast: float=0.0, format_: str="%.6f", flags: int=0) -> bool: ...
def input_float(label: str, value: FloatPtr, step: float=0.0, step_fast: float=0.0, format_: str="%.3f", flags: int=0) -> bool: ...
...
def input_int(label: str, value: IntPtr, step: int=1, step_fast: int=100, flags: int=0) -> bool: ...
...
# def input_scalar(label: str, data_type: int, p_data: Any, p_step: Any=None, p_step_fast: Any=None, format_: str=None, flags: int=0) -> bool: ...
# def input_scalarn(label: str, data_type: int, p_data: Any, components: int, p_step: Any=None, p_step_fast: Any=None, format_: str=None, flags: int=0) -> bool: ...
def input_text(label: str, str_ptr: StrPtr, flags: int=0, callback: Callable=None, user_data: Any=None) -> bool: ...
# def input_text_multiline(label: str, buf: str, buf_size: Any, size: tuple=(0, 0), flags: int=0, callback: Callable=None, user_data: Any=None) -> bool: ...
def input_text_with_hint(label: str, hint: str, str_ptr: StrPtr, flags: int=0, callback: Callable=None, user_data: Any=None) -> bool: ...
...
# def is_key_down(key: Any) -> bool: ...
# def is_key_pressed(key: Any, repeat: bool=True) -> bool: ...
# def is_key_released(key: Any) -> bool: ...
...
# def is_rect_visible_nil(size: tuple) -> bool: ...
# def is_rect_visible_vec2(rect_min: tuple, rect_max: tuple) -> bool: ...
...
# def list_box_fn_bool_ptr(label: str, current_item: int, items_getter: Callable, data: Any, items_count: int, height_in_items: int=-1) -> bool: ...
# def list_box_str_arr(label: str, current_item: int, items: Any, items_count: int, height_in_items: int=-1) -> bool: ...
...
# def menu_item_bool(label: str, shortcut: str=None, selected: bool=False, enabled: bool=True) -> bool: ...
...
def push_style_color_vec4(idx: int, col) -> None: ...
...
def radio_button(label: str, value: IntPtr, v_button: int) -> bool: ...
# def radio_button_bool(label: str, active: bool) -> bool: ...
# def radio_button_int_ptr(label: str, value: int, v_button: int) -> bool: ...
def render() -> None: ...
...
# def selectable_bool(label: str, selected: bool=False, flags: int=0, size: tuple=(0, 0)) -> bool: ...
...
# def set_window_collapsed_bool(collapsed: bool, cond: int=0) -> None: ...
...
# def slider_scalar(label: str, data_type: int, p_data: Any, p_min: Any, p_max: Any, format_: str=None, flags: int=0) -> bool: ...
# def slider_scalarn(label: str, data_type: int, p_data: Any, components: int, p_min: Any, p_max: Any, format_: str=None, flags: int=0) -> bool: ...
...
# def tree_node_ex_str(label: str, flags: int=0) -> bool: ...
...
# def v_slider_float(label: str, size: tuple, value: float, v_min: float, v_max: float, format_: str="%.3", flags: int=0) -> bool: ...
# def v_slider_int(label: str, size: tuple, value: int, v_min: int, v_max: int, format_: str="%d", flags: int=0) -> bool: ...
# def v_slider_scalar(label: str, size: tuple, data_type: int, p_data: Any, p_min: Any, p_max: Any, format_: str=None, flags: int=0) -> bool: ...
...
class ImColor:
    # value: tuple
    # def destroy(self: ImColor) -> None: ...
    # def float_(r: float, g: float, b: float, a: float=1.0) -> ImColor: ...
    def hsv(h: float, s: float, value: float, a: float=1.0) -> tuple: ...
    # def int_(r: int, g: int, b: int, a: int=255) -> ImColor: ...
    def nil() -> ImColor: ...
    # def set_hsv(self: ImColor, h: float, s: float, value: float, a: float=1.0) -> None: ...
    # def u32(rgba: int) -> ImColor: ...
    def vec4(col: tuple) -> ImColor: ...
...
class ImDrawList:
    ...
    def add_rect(self: ImDrawList, p_min, p_max, col: int, rounding: float=0.0, flags: int=0, thickness: float=1.0) -> None: ...
    def add_rect_filled(self: ImDrawList, p_min, p_max, col: int, rounding: float=0.0, flags: int=0) -> None: ...
...
class ImFontAtlas:
    ...
    # def get_mouse_cursor_tex_data(self: ImFontAtlas, cursor: int, out_offset: ImVec2, out_size: ImVec2, out_uv_border0: tuple, out_uv_border1: tuple, out_uv_fill0: tuple, out_uv_fill1: tuple) -> bool: ...
...
class ImGuiIO:
    ...
    # def add_key_analog_event(self: ImGuiIO, key: Any, down: bool, value: float) -> None: ...
    ...
    # def add_mouse_source_event(self: ImGuiIO, source: Any) -> None: ...
