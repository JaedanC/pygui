...
class ImGuiListClipper:
    ...
    def list_clipper() -> ImGuiListClipper: ...
...
class ImGuiTableColumnSortSpecs:
    ...
    sort_direction: int
    # sort_order: int
    # def destroy(self: ImGuiTableColumnSortSpecs) -> None: ...
    # def table_column_sort_specs() -> ImGuiTableColumnSortSpecs: ...

class ImGuiTableSortSpecs:
    specs: List[ImGuiTableColumnSortSpecs]
    specs_count: int
    specs_dirty: bool
    # def destroy(self: ImGuiTableSortSpecs) -> None: ...
    # def table_sort_specs() -> ImGuiTableSortSpecs: ...
