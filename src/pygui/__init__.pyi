...
def input_double(label: str, value: DoublePtr, step: float=0.0, step_fast: float=0.0, format_: str="%.6f", flags: int=0) -> Any: ...
def input_float(label: str, value: FloatPtr, step: float=0.0, step_fast: float=0.0, format_: str="%.3f", flags: int=0) -> Any: ...
def input_float2(label: str, float_ptrs: List[FloatPtr], format_: str="%.3f", flags: int=0) -> Any: ...
def input_float3(label: str, float_ptrs: List[FloatPtr], format_: str="%.3f", flags: int=0) -> Any: ...
def input_float4(label: str, float_ptrs: List[FloatPtr], format_: str="%.3f", flags: int=0) -> Any: ...
def input_int(label: str, value: IntPtr, step: int=1, step_fast: int=100, flags: int=0) -> Any: ...
...
def input_text(label: str, str_ptr: StrPtr, flags: int=0, callback: Callable=None, user_data: Any=None) -> Any: ...
